...
public:
    ...
    FDOKGORA_API virtual void InitFromXml(GisXmlSaxContext* pContext, GisXmlAttributeCollection* attrs);
...
typedef GisPtr<FdoKgOraPropertyDefinition> FdoKgOraPropertyDefinitionP;
