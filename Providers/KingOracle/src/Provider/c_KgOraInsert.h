...
#ifndef _c_KgOraInsert_h
#define _c_KgOraInsert_h

class c_KgOraInsert : public c_KgOraFdoCommand<FdoIInsert>
{
public:
  c_KgOraInsert(c_KgOraConnection *Conn);
public:
  ~c_KgOraInsert(void);
...
public:  
  /// \brief
    ...
    /// 
    FDOKGORA_API virtual FdoIdentifier* GetFeatureClassName();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetFeatureClassName(FdoIdentifier* ClassId);
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetFeatureClassName(FdoString* ClassName);
    ...
    /// 
    FDOKGORA_API virtual FdoBatchParameterValueCollection* GetBatchParameterValues();
    ...
    /// 
    FDOKGORA_API virtual FdoIFeatureReader* Execute();
};
