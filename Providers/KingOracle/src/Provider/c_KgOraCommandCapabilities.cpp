...
c_KgOraCommandCapabilities::c_KgOraCommandCapabilities ()
{
}
...
void c_KgOraCommandCapabilities::Dispose()
{
    delete this;
}
...
/// 
FdoInt32* c_KgOraCommandCapabilities::GetCommands (FdoInt32& Size)
{
...
}//end of c_KgOraCommandCapabilities::GetCommands 
...
///
bool c_KgOraCommandCapabilities::SupportsParameters ()
{
    return (true);
}
...
/// 
bool c_KgOraCommandCapabilities::SupportsTimeout ()
{
    return (false);
}
...
///
bool c_KgOraCommandCapabilities::SupportsSelectExpressions()
{
    return (true);
}
...
/// 
bool c_KgOraCommandCapabilities::SupportsSelectFunctions()
{
    return (true);
}
...
/// 
bool c_KgOraCommandCapabilities::SupportsSelectDistinct()
{
    return (true);
}
...
/// (but not vice versa).
bool c_KgOraCommandCapabilities::SupportsSelectGrouping()
{
    return (false);
}
