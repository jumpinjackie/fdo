...
#ifndef _c_KgOraCreateSpatialContext_h
#define _c_KgOraCreateSpatialContext_h

class c_KgOraCreateSpatialContext : public c_KgOraFdoCommand<FdoICreateSpatialContext>
{
public:
  c_KgOraCreateSpatialContext(c_KgOraConnection *Conn);
public:
  ~c_KgOraCreateSpatialContext(void);
...
public:  
    ...
    /// 
    FDOKGORA_API virtual FdoString* GetName();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetName(FdoString* value);
    ...
    /// 
    FDOKGORA_API virtual FdoString* GetDescription();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetDescription(FdoString* value);
    ...
    /// 
    FDOKGORA_API virtual FdoString* GetCoordinateSystem();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetCoordinateSystem(FdoString* value);
    ...
    /// 
    FDOKGORA_API virtual FdoString* GetCoordinateSystemWkt();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetCoordinateSystemWkt(FdoString* value);
    ...
    /// 
    FDOKGORA_API virtual FdoSpatialContextExtentType GetExtentType();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetExtentType(FdoSpatialContextExtentType value);
    ...
    /// 
    FDOKGORA_API virtual FdoByteArray* GetExtent();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetExtent(FdoByteArray* value);
    ...
    /// 
    FDOKGORA_API virtual const double GetXYTolerance();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetXYTolerance(const double value);
    ...
    /// Returns the tolerance
    /// 
    FDOKGORA_API virtual const double GetZTolerance();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetZTolerance(const double value);
    ...
    /// 
    FDOKGORA_API virtual const bool GetUpdateExisting();
    ...
    /// Returns nothing
    /// 
    FDOKGORA_API virtual void SetUpdateExisting(const bool value);
