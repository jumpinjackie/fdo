...
//#include "ShpDataReader.h"
#include <FdoCommonReader.h>


class ShpSpatialExtentsAggregateReader : public FdoCommonReader<FdoIDataReader>
{
public:

    ShpSpatialExtentsAggregateReader(ShpConnection* con, FdoFeatureClass* originalClass, FdoString* aliasName);
    ~ShpSpatialExtentsAggregateReader();
