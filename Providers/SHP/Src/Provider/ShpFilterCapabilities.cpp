...
ShpFilterCapabilities::ShpFilterCapabilities ()
{
}
...
void ShpFilterCapabilities::Dispose ()
{
    delete this;
}
...
FdoConditionType* ShpFilterCapabilities::GetConditionTypes (FdoInt32& length)
{
...
FdoSpatialOperations* ShpFilterCapabilities::GetSpatialOperations (FdoInt32& length)
{
...
FdoDistanceOperations* ShpFilterCapabilities::GetDistanceOperations (FdoInt32& length)
{
    length = 0;
...
bool ShpFilterCapabilities::SupportsGeodesicDistance ()
{
    return (false);
}
...
bool ShpFilterCapabilities::SupportsNonLiteralGeometricOperations ()
{
    return (false);
}
