#ifndef SDFDATASTOREPROPERTYDICTIONARY_H
#define SDFDATASTOREPROPERTYDICTIONARY_H
// 
//  
...
class SdfDataStorePropertyDictionary : public SdfPropertyDictionary
{
    //-------------------------------------------------------
...
public:
    ...
    SdfDataStorePropertyDictionary(SdfConnection* connection);
