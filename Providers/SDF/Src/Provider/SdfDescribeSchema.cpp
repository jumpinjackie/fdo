...
FdoFeatureSchemaCollection* SdfDescribeSchema::Execute()
{
    ...
    FdoFeatureSchemaCollection* schemaCollection = FdoFeatureSchemaCollection::Create(NULL);

    //get a copy of the schema -- using ReadSchema
    //gives us a clone generated by reading it all up from the
    //schema database
    FdoPtr<FdoFeatureSchema> schema = m_connection->GetSchemaDb()->ReadSchema(GetSchemaName());
