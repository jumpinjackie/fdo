...
void ApplySchemaTest::TestSpecificGeometryTypes( void )
{
	...
	FdoPtr<FdoFeatureClass> pEntClass = FdoFeatureClass::Create( L"SpecificGeomTest", L"test class" );
	pEntClass->SetIsAbstract(false);
    ...
    FdoGeometryType geomTypes[] = {FdoGeometryType_MultiCurveString, FdoGeometryType_Polygon};
    pGeomProp->SetSpecificGeometryTypes(geomTypes, 2);
    ...
    pEntClass = (FdoFeatureClass*)classes->GetItem(L"SpecificGeomTest");
