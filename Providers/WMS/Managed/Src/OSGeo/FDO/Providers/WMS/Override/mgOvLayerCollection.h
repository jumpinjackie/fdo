...
public __sealed __gc class OvLayerCollection : public NAMESPACE_OSGEO_RUNTIME::Disposable, public System::Collections::IList
{
private:
	/// <summary>
	...
	{
	private:
		OvLayerCollection* m_pCol;
		System::Int32 m_nIdx;

	public:
		Enumerator(OvLayerCollection* elements) : m_pCol(elements), m_nIdx(-1) 
		{
