...
#ifndef FDOWMSDESCRIBESCHEMACOMMAND_H
#define FDOWMSDESCRIBESCHEMACOMMAND_H
...
class FdoWmsDescribeSchemaCommand : public FdoWmsCommand<FdoIDescribeSchema>
{
...
protected:
    ...
    // DO NOT IMPLEMENT
    FdoWmsDescribeSchemaCommand (const FdoWmsDescribeSchemaCommand &right);

    // <summary>Constructs an instance of a command for the given connection. </summary>
    // <returns>Returns nothing</returns> 
    FdoWmsDescribeSchemaCommand (FdoIConnection* connection);

    // <summary>Virtual Destructor.</summary>
    // <returns>Returns nothing</returns> 
    virtual ~FdoWmsDescribeSchemaCommand (void);
...
public:
    ...
    // DO NOT IMPLEMENT
    FdoWmsDescribeSchemaCommand & operator= (const FdoWmsDescribeSchemaCommand &right);
...
#endif // FDOWMSDESCRIBESCHEMACOMMAND_H
