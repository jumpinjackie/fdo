...
void ConvertFDOToSDFX(const wchar_t* src, const wchar_t* dst, bool optimize)
{
    ...
    for (int q=0; q<classes->GetCount(); q++)
    {
        ...
        //create the feature table corresponding to the class
        //we will generate this property list with properties ordered
        //in the way they are in the sqlite table
...
*/
    ...
    for (int i=0; i<1; i++)
    {
        FdoPtr<FdoIFeatureReader> rdr = dynamic_cast<FdoIFeatureReader*>(select->Execute());
