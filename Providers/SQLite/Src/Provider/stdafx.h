...
#include "../Message/Inc/SQLiteMessage.h"

// the default message catalog filename
extern char *fdosqlite_cat;

inline FdoString* NlsMsgGetMain(int msg_num, char* default_msg, ...)
{
    va_list varargs;
    va_start(varargs, default_msg);
    FdoString* ret = FdoException::NLSGetMessage (msg_num, default_msg, fdosqlite_cat, varargs);
    va_end(varargs);
...
inline FdoString* NlsMsgGetMain(int msg_num, char* default_msg, char* file, int line, ...)
{
    ...
    FdoString* ret = FdoException::NLSGetMessage (msg_num, default_msg, file, line, fdosqlite_cat, varargs);
    va_end(varargs);
