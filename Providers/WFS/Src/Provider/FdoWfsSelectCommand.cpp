...
static bool CancelSelectCommandHander(void* data)
{
    FdoWfsSelectCommand* command = static_cast<FdoWfsSelectCommand*>(data);
...
void FdoWfsSelectCommand::Cancel()
{
    mCancelCommand = true;
}

bool FdoWfsSelectCommand::IsCanceled()
{
