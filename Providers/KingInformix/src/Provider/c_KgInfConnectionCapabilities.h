...
class c_KgInfConnectionCapabilities : public FdoIConnectionCapabilities
{
public:
    c_KgInfConnectionCapabilities ();

protected:
    virtual ~c_KgInfConnectionCapabilities ();
...
public:
    ...
    /// 
    FDOKGINF_API virtual FdoThreadCapability GetThreadCapability();
    ...
    /// 
    FDOKGINF_API virtual FdoSpatialContextExtentType* GetSpatialContextTypes(FdoInt32& Length);
    ...
    /// 
    FDOKGINF_API virtual bool SupportsLocking();
    ...
    /// 
    FDOKGINF_API virtual FdoLockType* GetLockTypes(FdoInt32& Size);
    ...
    /// 
    FDOKGINF_API virtual bool SupportsTimeout();
    ...
    /// 
    FDOKGINF_API virtual bool SupportsLongTransactions();
    ...
    /// 
    FDOKGINF_API virtual bool SupportsSQL();
    ...
    /// 
    FDOKGINF_API virtual bool SupportsConfiguration();
    ...
    /// 
    FDOKGINF_API virtual bool SupportsMultipleSpatialContexts();
    ...
    /// when creating a new spatial context.
    /// 
    FDOKGINF_API virtual bool SupportsCSysWKTFromCSysName();
    ...
    /// the provider or datastore level.
    FDOKGINF_API virtual bool SupportsWrite();
    ...
    /// one time.
    FDOKGINF_API virtual bool SupportsMultiUserWrite();
    ...
    ///
    FDOKGINF_API virtual bool SupportsFlush();
    #endif
};
