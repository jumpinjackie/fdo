...
#ifndef _c_KgInfSelectCommand_h
#define _c_KgInfSelectCommand_h

#include "c_KgInfFilterProcessor.h"

class c_KgInfSelectCommand :
    public c_KgInfFdoFeatureCommand<FdoISelect>
{
...
protected:
    c_KgInfSelectCommand (c_KgInfConnection* Connection);
    virtual ~c_KgInfSelectCommand (void);

public:
    //
    // Prevent the use of the Assignment Operation by defining it and not implementing it.
    // DO NOT IMPLEMENT
    c_KgInfSelectCommand & operator= (const c_KgInfSelectCommand &right);
