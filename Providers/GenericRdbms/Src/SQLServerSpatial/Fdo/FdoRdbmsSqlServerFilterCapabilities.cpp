...
FdoRdbmsSqlServerFilterCapabilities::FdoRdbmsSqlServerFilterCapabilities()
{
...
FdoSpatialOperations *FdoRdbmsSqlServerFilterCapabilities::GetSpatialOperations(int& length)
{
...
FdoDistanceOperations* FdoRdbmsSqlServerFilterCapabilities::GetDistanceOperations(int& length)
{
    length = 0;
    return NULL;
}