#ifndef FDOSMLPSQSSCHEMACOLLECTION_H
#define FDOSMLPSQSSCHEMACOLLECTION_H        1
...
// SqlServer Provider's LogicalPhysical schema collection definition
class FdoSmLpSqsSchemaCollection : public FdoSmLpSchemaCollection
{
public:
    ...
    FdoSmLpSqsSchemaCollection( FdoSmPhMgrP physicalSchema, FdoSmLpSpatialContextMgrP scMgr );
...
typedef FdoPtr<FdoSmLpSqsSchemaCollection> FdoSmLpSqsSchemasP;
