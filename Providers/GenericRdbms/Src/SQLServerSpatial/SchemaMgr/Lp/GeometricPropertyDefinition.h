#ifndef FDOSMLPSQSGEOMETRICPROPERTYDEFINITION_H
#define FDOSMLPSQSGEOMETRICPROPERTYDEFINITION_H     1
...
// SqlServer Provider's LogicalPhysical GeometricPropertyDefinition
class FdoSmLpSqsGeometricPropertyDefinition : public FdoSmLpGrdGeometricPropertyDefinition
{
public:

    // Construct from a property reader
    FdoSmLpSqsGeometricPropertyDefinition(FdoSmPhClassPropertyReaderP propReader, FdoSmLpClassDefinition* parent);

	// Construct from an FDO property definition
    FdoSmLpSqsGeometricPropertyDefinition(
    ...
    virtual FdoSqlServerOvGeometricColumnP GetColumnMapping( bool bIncludeDefaults ) const;
...
typedef FdoPtr<FdoSmLpSqsGeometricPropertyDefinition> FdoSmLpSqsGeometricPropertyP;
