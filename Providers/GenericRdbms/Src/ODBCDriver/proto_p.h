...
int odbcdr_connect( odbcdr_context_def *context, char *connect_string, char *user, char *pswd, char **vendor_data, int *connect_id );
...
int odbcdr_run_sql( odbcdr_context_def *context, char *sql, int isddl, int *rows_processed);
int odbcdr_run_sqlW( odbcdr_context_def *context, wchar_t *sql, int isddl, int *rows_processed);
...
int odbcdr_sql( odbcdr_context_def *context, char *cursor, char *sql, int defer, char *verb, void *ptree, char *cursor_coc );
int odbcdr_sqlW( odbcdr_context_def *context, char *cursor, wchar_t *sql, int defer, char *verb, void *ptree, char *cursor_coc );
...
int odbcdr_get_gen_id( odbcdr_context_def  *context, char *table_name, int  *id );
...
int odbcdr_set_sess_envW( odbcdr_context_def *context );
