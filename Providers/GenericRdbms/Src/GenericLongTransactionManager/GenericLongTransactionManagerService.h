...
// | tionManagerService. The class defines the interfaces for provider specific
// | services for the Long Transaction Manager.
// =============================================================================


#ifndef FdoRdbmsGenericLongTransactionManagerService_h
#define FdoRdbmsGenericLongTransactionManagerService_h
...
class FdoRdbmsGenericLongTransactionManagerService : 
                                public FdoRdbmsLongTransactionManagerService
{
    ...
    //      The interface creates a SQL statement with which it can be veri-
    //      fied whether or not a data store is accessible. Because the struc-
    //      ture of the statement depends on the current environment, the pro-
    //      cedure is implemented by the corresponding Long Transaction Manager
    //      Service.
