#ifndef FDORDBMSFEATURESUBSETREADER_H
#define FDORDBMSFEATURESUBSETREADER_H       1
/*
...
class FdoRdbmsFeatureSubsetReader : public FdoRdbmsFeatureReader
{
...
protected:
    virtual ~FdoRdbmsFeatureSubsetReader();
