...
private:
    ...
    void AppendProperties( const wchar_t* scope, const FdoSmLpClassDefinition* currentClass, bool bAddPrimaryKeys, bool bGetAutoGen, FdoPropertyValueCollection* propertyValues );
...
public:
    ...
    const char *MakeDBValidName(const wchar_t *name);
    ...
    void AssociatedSpatialContextCheck( const FdoSmLpClassDefinition *classDefinition,
                                        const wchar_t *geomPropName );

    // Sets the active spatial context as the Geometry propertry associated spatial context
    void SetActiveSpatialContext( const FdoSmLpClassDefinition *pClassDefinition,
                                  const wchar_t *geomPropName );
    ...
    void SanitizePropertyValues( const FdoSmLpClassDefinition *classDefinition,
