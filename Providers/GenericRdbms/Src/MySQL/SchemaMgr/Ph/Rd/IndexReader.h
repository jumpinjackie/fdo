#ifndef FDORDBMSPHRDMYSQLINDEXREADER_H
#define FDORDBMSPHRDMYSQLINDEXREADER_H        1
/*
...
// MySql index reader implementation

class FdoSmPhRdMySqlIndexReader : public FdoSmPhRdIndexReader
{
public:
