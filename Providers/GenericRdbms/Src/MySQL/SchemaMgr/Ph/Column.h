#ifndef FDOSMPHMYSQLDBCOLUMN_H
#define FDOSMPHMYSQLDBCOLUMN_H        1
/*
...
// MySQL Provider implementation of a Column object.
class FdoSmPhMySqlColumn : virtual public FdoSmPhColumn
{
public:
