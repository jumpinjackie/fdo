#ifndef _FDORDBMSMYSQLCONNECTIONINFO_H_
#define _FDORDBMSMYSQLCONNECTIONINFO_H_
#ifdef _WIN32
#pragma once
#endif
/*
...
class FdoRdbmsMySqlConnectionInfo :  public FdoIConnectionInfo
{
public:
    FdoRdbmsMySqlConnectionInfo(FdoRdbmsConnection *connection);
...
protected:
    ~FdoRdbmsMySqlConnectionInfo(void);
