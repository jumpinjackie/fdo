#ifndef _FDORDBMSMYSQLDATASTOREPROPERTYDICTIONARY_H_
#define _FDORDBMSMYSQLDATASTOREPROPERTYDICTIONARY_H_
/*
...
class FdoRdbmsMySqlDataStorePropertyDictionary : public FdoRdbmsDataStorePropertyDictionary
{
public:

	FdoRdbmsMySqlDataStorePropertyDictionary( FdoRdbmsConnection *connection, int action ) :
