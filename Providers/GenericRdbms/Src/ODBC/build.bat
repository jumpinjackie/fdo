...
msbuild Odbc%VCBEXTENSION%_temp.sln /t:%MSACTION% /p:Configuration=%TYPEBUILD% /p:Platform=%TYPEPLATFORM% /nologo /consoleloggerparameters:NoSummary
...
copy /y "..\..\Bin\%INTERMEDIATEDIR%\%TYPEBUILD%\ODBCProvider.dll" "%FDOBINPATH%"
copy /y "..\..\Bin\%INTERMEDIATEDIR%\%TYPEBUILD%\ODBCProvider.pdb" "%FDOBINPATH%"
copy /y "..\..\Bin\%INTERMEDIATEDIR%\%TYPEBUILD%\ODBCOverrides.dll" "%FDOBINPATH%"
copy /y "..\..\Bin\%INTERMEDIATEDIR%\%TYPEBUILD%\ODBCOverrides.pdb" "%FDOBINPATH%"
...
pushd ..\..\
if exist "%FDODOCPATH%\HTML\Providers\ODBC" rmdir /S /Q "%FDODOCPATH%\HTML\Providers\ODBC"
if exist Docs\HTML\ODBC xcopy/CQEYI Docs\HTML\ODBC\* "%FDODOCPATH%\HTML\Providers\ODBC"
if exist "Docs\ODBC_Provider_API.chm" copy /y "Docs\ODBC_Provider_API.chm" "%FDODOCPATH%"
if exist "%FDODOCPATH%\HTML\Providers\ODBC_managed" rmdir /S /Q "%FDODOCPATH%\HTML\Providers\ODBC_managed"
if exist Docs\HTML\ODBC_managed xcopy/CQEYI Docs\HTML\ODBC_managed\* "%FDODOCPATH%\HTML\Providers\ODBC_managed"
if exist "Docs\ODBC_Provider_API_managed.chm" copy /y "Docs\ODBC_Provider_API_managed.chm" "%FDODOCPATH%"
popd

:end
echo End ODBC %MSACTION%
exit /B 0
