...
FdoFunctionDefinitionCollection* FdoRdbmsOdbcExpressionCapabilities::GetFunctions()
{
    ...
    // NOTE: The function capabilities list, like other capabilities, is static. That is to
    //       say, we don't return different function capabilities depending on which driver
    //       we are connected to. This is consistent with other providers.
