...
protected:
    ...
    FdoRdbmsOdbcCreateDataStore (FdoRdbmsOdbcConnection* connection)
    {
		...
		mDataStorePropertyDictionary = new FdoRdbmsOdbcDataStorePropertyDictionary(NULL, FDO_RDBMS_DATASTORE_FOR_CREATE);
    }
...
public:
	...
	virtual	void Execute() 
	{
		...
		mConnection->CreateDb( 	
						 ...
						 L"",	// service 
						 p->GetProperty(FDO_RDBMS_DATASTORE_LTMODE),
						 p->GetProperty(FDO_RDBMS_DATASTORE_LOCKMODE)
						 );
	} 
};
#endif
