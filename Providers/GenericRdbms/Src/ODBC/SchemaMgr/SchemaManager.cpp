...
FdoOdbcSchemaManager::FdoOdbcSchemaManager(GdbiConnection* connection, FdoStringP OdbcSchemaName) :
    FdoGrdSchemaManager( connection ),
    mOdbcSchemaName(OdbcSchemaName)
{
}

FdoOdbcSchemaManager::~FdoOdbcSchemaManager(void)
{
}
...
{
    return new FdoSmPhOdbcMgr(GetGdbiConnection(), mOdbcSchemaName);
}

FdoStringP FdoOdbcSchemaManager::GetSchemaLockStmt()
{
