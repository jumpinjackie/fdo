#ifndef FDOSMLPODBCSCHEMACOLLECTION_H
#define FDOSMLPODBCSCHEMACOLLECTION_H        1
/*
...
// Odbc Provider's LogicalPhysical schema collection definition
class FdoSmLpOdbcSchemaCollection : public FdoSmLpSchemaCollection
{
public:
...
typedef FdoPtr<FdoSmLpOdbcSchemaCollection> FdoSmLpOdbcSchemasP;
