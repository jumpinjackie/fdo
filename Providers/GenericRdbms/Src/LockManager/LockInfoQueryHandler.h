...
#ifndef FdoRdbmsLockInfoQueryHandler_h
#define FdoRdbmsLockInfoQueryHandler_h
...
class FdoRdbmsLockInfoQueryHandler : public FdoLkDisposable
{
    ...
    virtual FdoInt64                GetClassId     () = 0;

    virtual FdoString               *GetLockOwner  ()  =0;
    virtual FdoString               *GetLtName     () =0;
    virtual FdoString               *GetTableName  () = 0;

    virtual FdoRdbmsPrimaryKey      *GetPrimaryKey () =0;

    virtual FdoString			    *GetLockType    () =0;

};  //  class FdoRdbmsLockInfoQueryHandler
