...
(tablename, classid, columnname, attributename, columntype, columnsize, columnscale, attributetype, isnullable, 
isfeatid, issystem, isreadonly, isautogenerated, isrevisionnumber, owner, description, iscolumncreator, isfixedcolumn) values
('n/a', F_ClassSeq.currval, 'n/a', 'Bounds', 'GEOMETRY', 0, 0, '4', 1, 0, 1, 1, 0, 0,
...
(tablename, classid, columnname, attributename, columntype, columnsize, columnscale, attributetype, isnullable, 
isfeatid, issystem, isreadonly, isautogenerated, isrevisionnumber, owner, description, iscolumncreator, isfixedcolumn) values
('n/a', LAST_INSERT_ID(), 'n/a', 'Bounds', 'GEOMETRY', 0, 0, '4', 1, 0, 1, 1, 0, 0, substring_index(current_user(), _utf8'@', 1), 'Bounding box for the feature', 0, 0);
...
(tablename, classid, columnname, attributename, columntype, columnsize, columnscale, attributetype, isnullable, 
isfeatid, issystem, isreadonly, isautogenerated, isrevisionnumber, owner, description, iscolumncreator, isfixedcolumn) values
('n/a', IDENT_CURRENT('f_classdefinition'), 'n/a', 'Bounds', 'GEOMETRY', 0, 0, '4', 1, 0, 1, 1, 0, 0,
