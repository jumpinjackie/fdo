...
#ifndef ARCSDECONNECTIONINFO_H
#define ARCSDECONNECTIONINFO_H
#ifdef _WIN32
#pragma once
#endif // _WIN32
...
public:
    ...
    ArcSDEConnectionInfo (ArcSDEConnection* connection);

protected:
    virtual ~ArcSDEConnectionInfo (void);
