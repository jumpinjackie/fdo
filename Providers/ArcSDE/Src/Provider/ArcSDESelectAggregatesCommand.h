...
#ifndef ARCSDESELECTAGGREGATESCOMMAND_H
#define ARCSDESELECTAGGREGATESCOMMAND_H
...
class ArcSDESelectAggregatesCommand :
    public ArcSDEFeatureCommand<FdoISelectAggregates>
{
...
private:
    ArcSDESelectAggregatesCommand (FdoIConnection *connection);

protected:
    virtual ~ArcSDESelectAggregatesCommand (void);

public:
    //
    // Prevent the use of the Assignment Operation by defining it and not implemeting it.
    // DO NOT IMPLEMENT
    ArcSDESelectAggregatesCommand & operator= (const ArcSDESelectAggregatesCommand &right);
...
#endif // ARCSDESELECTAGGREGATESCOMMAND_H
