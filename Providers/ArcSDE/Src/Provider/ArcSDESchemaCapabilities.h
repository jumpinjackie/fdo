...
#ifndef ARCSDESCHEMACAPABILITIES_H
#define ARCSDESCHEMACAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class ArcSDESchemaCapabilities : public FdoISchemaCapabilities
{
public:
    ArcSDESchemaCapabilities ();

protected:
    virtual ~ArcSDESchemaCapabilities ();
...
#endif // ARCSDESCHEMACAPABILITIES_H
