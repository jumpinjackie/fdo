...
#ifndef _c_KgKmlRasterCapabilities_h
#define _c_KgKmlRasterCapabilities_h


class c_KgKmlRasterCapabilities : public FdoIRasterCapabilities
{
public:
    c_KgKmlRasterCapabilities ();

protected:
    virtual ~c_KgKmlRasterCapabilities ();
...
public:
   /// \brief
    ...
    /// 
    FDOKGKML_API virtual bool SupportsRaster ();
    ...
    /// 
    FDOKGKML_API virtual bool SupportsStitching ();
    ...
    /// 
    FDOKGKML_API virtual bool SupportsSubsampling ();
    ...
    /// 
    FDOKGKML_API virtual bool SupportsDataModel (FdoRasterDataModel* Model);
};
