...
c_KgKmlCommandCapabilities::c_KgKmlCommandCapabilities ()
{
}
...
void c_KgKmlCommandCapabilities::Dispose()
{
    delete this;
}
...
/// 
FdoInt32* c_KgKmlCommandCapabilities::GetCommands (FdoInt32& Size)
{
...
}//end of c_KgKmlCommandCapabilities::GetCommands 
...
///
bool c_KgKmlCommandCapabilities::SupportsParameters ()
{
    return (true);
}
...
/// 
bool c_KgKmlCommandCapabilities::SupportsTimeout ()
{
    return (false);
}
...
///
bool c_KgKmlCommandCapabilities::SupportsSelectExpressions()
{
    return (true);
}
...
/// 
bool c_KgKmlCommandCapabilities::SupportsSelectFunctions()
{
    return (true);
}
...
/// 
bool c_KgKmlCommandCapabilities::SupportsSelectDistinct()
{
    return (true);
}
...
/// 
bool c_KgKmlCommandCapabilities::SupportsSelectOrdering()
{
    return (true);
}
...
/// (but not vice versa).
bool c_KgKmlCommandCapabilities::SupportsSelectGrouping()
{
    return (true);
}
