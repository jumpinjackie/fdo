...
#ifndef _c_KgKmlApplySchema_h
#define _c_KgKmlApplySchema_h

class c_KgKmlApplySchema : public c_KgKmlFdoCommand<FdoIApplySchema>
{
public:
  c_KgKmlApplySchema(c_KgKmlConnection *Conn);
public:
  ~c_KgKmlApplySchema(void);
...
public:  
    ...
    /// 
    FDOKGKML_API virtual FdoFeatureSchema* GetFeatureSchema();
    ...
    /// Returns nothing
    /// 
    FDOKGKML_API virtual void SetFeatureSchema(FdoFeatureSchema* value);
    ...
    /// 
    FDOKGKML_API virtual FdoPhysicalSchemaMapping* GetPhysicalMapping();
    ...
    /// Returns nothing
    /// 
    FDOKGKML_API virtual void SetPhysicalMapping(FdoPhysicalSchemaMapping* value);
    ...
    /// 
    ///  
    FDOKGKML_API virtual FdoBoolean GetIgnoreStates();
    ...
    /// Returns nothing
    /// 
    FDOKGKML_API virtual void SetIgnoreStates( FdoBoolean ignoreStates );
