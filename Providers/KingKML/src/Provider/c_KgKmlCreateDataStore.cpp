...
c_KgKmlCreateDataStore::c_KgKmlCreateDataStore(c_KgKmlConnection *Conn)
  : c_KgKmlFdoCommand(Conn)
{
}

c_KgKmlCreateDataStore::~c_KgKmlCreateDataStore(void)
{
}
 ...
 /// \brief
  ...
  /// 
FdoIDataStorePropertyDictionary* c_KgKmlCreateDataStore::GetDataStoreProperties()
{
  return NULL;
}
  ...
  /// Returns nothing
  /// 
void c_KgKmlCreateDataStore::Execute()
{
}