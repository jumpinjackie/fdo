...
#ifndef _c_KGKMLTOPOLOGYCAPABILITIES_H
#define _c_KGKMLTOPOLOGYCAPABILITIES_H
...
class c_KgKmlTopologyCapabilities : public FdoITopologyCapabilities
{
public:
    c_KgKmlTopologyCapabilities ();

protected:
    virtual ~c_KgKmlTopologyCapabilities ();
...
public:
    ...
    FDOKGKML_API virtual bool SupportsTopology();
    ...
    /// property will fail.
    FDOKGKML_API virtual bool SupportsTopologicalHierarchy();
    ...
    FDOKGKML_API virtual bool BreaksCurveCrossingsAutomatically();
    ...
    FDOKGKML_API virtual bool ActivatesTopologyByArea();
    ...
    FDOKGKML_API virtual bool ConstrainsFeatureMovements();
};
