...
c_KgKmlExpressionCapabilities::c_KgKmlExpressionCapabilities ()
{
}
...
void c_KgKmlExpressionCapabilities::Dispose ()
{
    delete this;
}
...
FdoExpressionType* c_KgKmlExpressionCapabilities::GetExpressionTypes (FdoInt32& Length)
{
    ...
    return (types);
}//end of c_KgKmlExpressionCapabilities::GetExpressionTypes 
...
FdoFunctionDefinitionCollection* c_KgKmlExpressionCapabilities::GetFunctions()
{
...
}//end of c_KgKmlExpressionCapabilities::GetFunctions
