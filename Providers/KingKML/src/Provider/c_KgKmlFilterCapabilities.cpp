...
c_KgKmlFilterCapabilities::c_KgKmlFilterCapabilities ()
{
}
...
void c_KgKmlFilterCapabilities::Dispose ()
{
    delete this;
}
...
FdoConditionType* c_KgKmlFilterCapabilities::GetConditionTypes (FdoInt32& Length)
{
    ...
    return (types);
}//end of c_KgKmlFilterCapabilities::GetConditionTypes
...
FdoSpatialOperations* c_KgKmlFilterCapabilities::GetSpatialOperations (FdoInt32& Length)
{
    ...
    return (operations);
}//end of c_KgKmlFilterCapabilities::GetSpatialOperations
...
FdoDistanceOperations* c_KgKmlFilterCapabilities::GetDistanceOperations (FdoInt32& Length)
{
    Length = 0;
...
bool c_KgKmlFilterCapabilities::SupportsGeodesicDistance ()
{
    return false;
}
...
bool c_KgKmlFilterCapabilities::SupportsNonLiteralGeometricOperations ()
{
    return false;
}
