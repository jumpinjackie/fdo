...
c_KgKmlRasterCapabilities::c_KgKmlRasterCapabilities ()
{
}
...
void c_KgKmlRasterCapabilities::Dispose()
{
    delete this;
}
...
bool c_KgKmlRasterCapabilities::SupportsRaster ()
{
    return (false);
}
...
bool c_KgKmlRasterCapabilities::SupportsStitching ()
{
    return (false);
}
...
bool c_KgKmlRasterCapabilities::SupportsSubsampling ()
{
    return (false);
}
...
bool c_KgKmlRasterCapabilities::SupportsDataModel (FdoRasterDataModel* Model)
{
    return (false);
}
