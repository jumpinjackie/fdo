...
c_KgKmlGeometryCapabilities::c_KgKmlGeometryCapabilities ()
{
}
...
void c_KgKmlGeometryCapabilities::Dispose()
{
    delete this;
}
...
FdoGeometryType* c_KgKmlGeometryCapabilities::GetGeometryTypes (FdoInt32& Length)
{
...
}//end of c_KgKmlGeometryCapabilities::GetGeometryTypes 
...
FdoGeometryComponentType* c_KgKmlGeometryCapabilities::GetGeometryComponentTypes (FdoInt32& Length)
{
...
FdoInt32 c_KgKmlGeometryCapabilities::GetDimensionalities ()
{
