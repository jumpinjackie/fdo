...
c_KgKmlConnectionInfo::c_KgKmlConnectionInfo () : m_Connection(NULL)    
{
  
}

c_KgKmlConnectionInfo::c_KgKmlConnectionInfo (c_KgKmlConnection* Conn) : m_Connection(Conn)    
{
  
}

void c_KgKmlConnectionInfo::Dispose()
{
    delete this;
}
...
FdoString* c_KgKmlConnectionInfo::GetProviderName ()
{
...
FdoString* c_KgKmlConnectionInfo::GetProviderDisplayName()
{
    
    return D_KGORA_PROVIDER_DEFAULT_DISPLAY_NAME;
}

/// <summary>Gets the description of the feature provider.</summary>
/// <returns>Returns the provider description</returns>
FdoString* c_KgKmlConnectionInfo::GetProviderDescription ()
{
    
    return D_KGORA_PROVIDER_DEFAULT_DESCRIPTION;
}

/// <summary>Gets the version of the feature provider.</summary>
/// <returns>Returns provider version</returns>
FdoString* c_KgKmlConnectionInfo::GetProviderVersion ()
{
...
FdoString* c_KgKmlConnectionInfo::GetFeatureDataObjectsVersion ()
{
...
/// 
FdoIConnectionPropertyDictionary* c_KgKmlConnectionInfo::GetConnectionProperties ()
{
...
}//end of c_KgKmlConnectionInfo::GetConnectionProperties 
...
FdoIConnectionPropertyDictionary* c_KgKmlConnectionInfo::GetConnectionProperties ()
{
  ...
  if (m_PropertyDictionary == NULL)
  {
    ...
    char* propname;
		...
		wide_to_multibyte (propname, D_CONN_PROPERTY_KML_FILE);
    FdoPtr<ConnectionProperty>  newproperty = new ConnectionProperty (D_CONN_PROPERTY_KML_FILE
                                                                    ,D_CONN_PROPERTY_KML_FILE
                                                                    ,L"", false, false, false, false, false, false,false, 0, NULL);
    m_PropertyDictionary->AddProperty(newproperty);
        
/*        
    wide_to_multibyte (propname, D_CONN_PROPERTY_PASSWORD);
    newproperty = new ConnectionProperty (D_CONN_PROPERTY_PASSWORD,D_CONN_PROPERTY_PASSWORD,
                L"", false, false, false, false, false, false,false, 0, NULL);
    m_PropertyDictionary->AddProperty(newproperty);
                
		wide_to_multibyte (propname, D_CONN_PROPERTY_SERVICE_NAME);
    newproperty = new ConnectionProperty (D_CONN_PROPERTY_SERVICE_NAME,D_CONN_PROPERTY_SERVICE_NAME,
                                            L"", false, false, false, false, false, false,false, 0, NULL);
    m_PropertyDictionary->AddProperty(newproperty);
    
    wide_to_multibyte (propname, D_CONN_PROPERTY_ORACLE_SCHEMA);
    newproperty = new ConnectionProperty (D_CONN_PROPERTY_ORACLE_SCHEMA,D_CONN_PROPERTY_ORACLE_SCHEMA,
                                            L"", false, false, false, false, false, false,false, 0, NULL);
    m_PropertyDictionary->AddProperty(newproperty);
    
    wide_to_multibyte (propname, D_CONN_PROPERTY_KING_FDO_CLASS);
    newproperty = new ConnectionProperty (D_CONN_PROPERTY_KING_FDO_CLASS,D_CONN_PROPERTY_KING_FDO_CLASS,
                                            L"", false, false, false, false, false, false,false, 0, NULL);
    m_PropertyDictionary->AddProperty(newproperty);
*/    
  }
...
/// 
FdoProviderDatastoreType c_KgKmlConnectionInfo::GetProviderDatastoreType()
{
...
/// 
FdoStringCollection* c_KgKmlConnectionInfo::GetDependentFileNames()
{
  return NULL;
}
