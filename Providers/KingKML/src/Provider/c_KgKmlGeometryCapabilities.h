...
#ifndef _c_KGKMLGEOMETRYCAPABILITIES_H
#define _c_KGKMLGEOMETRYCAPABILITIES_H


class c_KgKmlGeometryCapabilities : public FdoIGeometryCapabilities
{
public:
    c_KgKmlGeometryCapabilities ();

protected:
    virtual ~c_KgKmlGeometryCapabilities ();
...
public:
    ...
    /// 
    FDOKGKML_API virtual FdoGeometryType* GetGeometryTypes( FdoInt32& Length);
    ...
    /// 
    FDOKGKML_API virtual FdoGeometryComponentType* GetGeometryComponentTypes( FdoInt32& Length );
    ...
    /// 
    FDOKGKML_API virtual FdoInt32 GetDimensionalities();
};
