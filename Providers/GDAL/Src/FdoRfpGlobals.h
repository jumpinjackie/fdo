...
namespace FdoGrfpGlobals
{
    ...
    static FdoString* GRFPProviderName				    = L"OSGeo.Gdal.3.9";
    ...
    static FdoString* GRFPProviderVersion			    = L"3.9.0.0";
    static FdoString* GRFPFeatureDataObjectsVersion		= L"3.9.0.0";
