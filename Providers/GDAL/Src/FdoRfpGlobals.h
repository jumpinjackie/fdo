...
namespace FdoGrfpGlobals
{
    ...
    static FdoString* GRFPProviderName				    = L"OSGeo.Gdal.4.2";
    ...
    static FdoString* GRFPProviderVersion			    = L"4.2.0.0";
    static FdoString* GRFPFeatureDataObjectsVersion		= L"4.2.0.0";
