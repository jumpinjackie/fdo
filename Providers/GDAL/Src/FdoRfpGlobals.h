...
namespace FdoGrfpGlobals
{
    ...
    static FdoString* GRFPProviderName				    = L"OSGeo.Gdal.3.6";
    ...
    static FdoString* GRFPProviderVersion			    = L"3.6.0.0";
    static FdoString* GRFPFeatureDataObjectsVersion		= L"3.6.0.0";
