...
//
#ifndef FDOPOSTGIS_CREATESPATIALCONTEXTCOMMAND_H_INCLUDED
#define FDOPOSTGIS_CREATESPATIALCONTEXTCOMMAND_H_INCLUDED
...
/// spatial contexts.
///
class CreateSpatialContextCommand : public Command<FdoICreateSpatialContext>
{
public:
  CreateSpatialContextCommand(Connection *Conn);
public:
  ~CreateSpatialContextCommand(void);
...
#endif // FDOPOSTGIS_CREATESPATIALCONTEXTCOMMAND_H_INCLUDED
