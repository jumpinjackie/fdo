...
#ifndef _c_KgMssSelectCommand_h
#define _c_KgMssSelectCommand_h

#include "c_KgMssFilterProcessor.h"

class c_KgMssSelectCommand :
    public c_KgMssFdoFeatureCommand<FdoISelect>
{
...
protected:
    c_KgMssSelectCommand (c_KgMssConnection* Connection);
    virtual ~c_KgMssSelectCommand (void);

public:
    //
    // Prevent the use of the Assignment Operation by defining it and not implementing it.
    // DO NOT IMPLEMENT
    c_KgMssSelectCommand & operator= (const c_KgMssSelectCommand &right);
