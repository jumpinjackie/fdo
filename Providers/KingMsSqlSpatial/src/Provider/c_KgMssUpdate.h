...
#ifndef _c_KgMssUpdate_h
#define _c_KgMssUpdate_h
...
class c_KgMssUpdate : public c_KgMssFdoFeatureCommand<FdoIUpdate>
{
public:
  c_KgMssUpdate(c_KgMssConnection *Conn);
public:
  ~c_KgMssUpdate(void);
...
public:  
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual FdoInt32 Execute();
    ...
    /// 
    FDOKGMSS_API virtual FdoILockConflictReader* GetLockConflicts();
};
