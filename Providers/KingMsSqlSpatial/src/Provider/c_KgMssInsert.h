...
#ifndef _c_KgMssInsert_h
#define _c_KgMssInsert_h

class c_KgMssInsert : public c_KgMssFdoCommand<FdoIInsert>
{
public:
  c_KgMssInsert(c_KgMssConnection *Conn);
public:
  ~c_KgMssInsert(void);
...
public:  
  /// \brief
    ...
    /// 
    FDOKGMSS_API virtual FdoIdentifier* GetFeatureClassName();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetFeatureClassName(FdoIdentifier* ClassId);
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetFeatureClassName(FdoString* ClassName);
    ...
    /// 
    FDOKGMSS_API virtual FdoPropertyValueCollection* GetPropertyValues();
    ...
    /// 
    FDOKGMSS_API virtual FdoBatchParameterValueCollection* GetBatchParameterValues();
    ...
    /// 
    FDOKGMSS_API virtual FdoIFeatureReader* Execute();
};
