...
$providerName = "OSGeo.PostgreSQL.$fdoVer"
$providerDispName = "OSGeo FDO Provider for PostgreSQL/PostGIS"
$providerDesc = "Read/write access to PostgreSQL/PostGIS-based data store. Supports spatial data types and spatial query operations."
$providerLibPath = ".\PostgreSQLProvider.dll"
