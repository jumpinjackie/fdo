...
# of FDO
$fileList = @(
    "KingOracleMessage.dll",
    "KingOracleOverrides.dll",
...
$providerName = "King.Oracle.$fdoVer"
$providerDispName = "OSGeo FDO Provider for Oracle"
$providerDesc = "Read/write access to spatial and attribute data in an Oracle Spatial."
$providerLibPath = ".\KingOracleProvider.dll"
