...
PLATFORM=VC-CE
CC=$(CC)
CFLAG= /W3 /WX /Ox /O2 /Ob2 /Gs0 /GF /Gy /nologo $(WCETARGETDEFS) -DUNICODE -D_UNICODE -DWIN32 -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 -DNO_CHMOD -I$(WCECOMPAT)/include /Fdout32_$(TARGETCPU) -DOPENSSL_NO_KRB5    
APP_CFLAG=
LIB_CFLAG=
SHLIB_CFLAG=
APP_EX_OBJ=
...
$(OBJ_D)\fips.obj: $(SRC_D)\fips\fips.c
	$(CC) /Fo$(OBJ_D)\fips.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\fips.c

$(OBJ_D)\fips_err_wrapper.obj: $(SRC_D)\fips\fips_err_wrapper.c
	$(CC) /Fo$(OBJ_D)\fips_err_wrapper.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\fips_err_wrapper.c

$(OBJ_D)\fips_aes_core.obj: $(SRC_D)\fips\aes\fips_aes_core.c
	$(CC) /Fo$(OBJ_D)\fips_aes_core.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\aes\fips_aes_core.c

$(OBJ_D)\fips_aes_selftest.obj: $(SRC_D)\fips\aes\fips_aes_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_aes_selftest.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\aes\fips_aes_selftest.c

$(OBJ_D)\fips_des_enc.obj: $(SRC_D)\fips\des\fips_des_enc.c
	$(CC) /Fo$(OBJ_D)\fips_des_enc.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\des\fips_des_enc.c

$(OBJ_D)\fips_des_selftest.obj: $(SRC_D)\fips\des\fips_des_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_des_selftest.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\des\fips_des_selftest.c

$(OBJ_D)\fips_set_key.obj: $(SRC_D)\fips\des\fips_set_key.c
	$(CC) /Fo$(OBJ_D)\fips_set_key.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\des\fips_set_key.c

$(OBJ_D)\fips_dsa_ossl.obj: $(SRC_D)\fips\dsa\fips_dsa_ossl.c
	$(CC) /Fo$(OBJ_D)\fips_dsa_ossl.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\dsa\fips_dsa_ossl.c

$(OBJ_D)\fips_dsa_gen.obj: $(SRC_D)\fips\dsa\fips_dsa_gen.c
	$(CC) /Fo$(OBJ_D)\fips_dsa_gen.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\dsa\fips_dsa_gen.c

$(OBJ_D)\fips_dsa_selftest.obj: $(SRC_D)\fips\dsa\fips_dsa_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_dsa_selftest.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\dsa\fips_dsa_selftest.c

$(OBJ_D)\fips_dh_check.obj: $(SRC_D)\fips\dh\fips_dh_check.c
	$(CC) /Fo$(OBJ_D)\fips_dh_check.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\dh\fips_dh_check.c

$(OBJ_D)\fips_dh_gen.obj: $(SRC_D)\fips\dh\fips_dh_gen.c
	$(CC) /Fo$(OBJ_D)\fips_dh_gen.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\dh\fips_dh_gen.c

$(OBJ_D)\fips_dh_key.obj: $(SRC_D)\fips\dh\fips_dh_key.c
	$(CC) /Fo$(OBJ_D)\fips_dh_key.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\dh\fips_dh_key.c

$(OBJ_D)\fips_hmac.obj: $(SRC_D)\fips\hmac\fips_hmac.c
	$(CC) /Fo$(OBJ_D)\fips_hmac.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\hmac\fips_hmac.c

$(OBJ_D)\fips_hmac_selftest.obj: $(SRC_D)\fips\hmac\fips_hmac_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_hmac_selftest.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\hmac\fips_hmac_selftest.c

$(OBJ_D)\fips_rand.obj: $(SRC_D)\fips\rand\fips_rand.c
	$(CC) /Fo$(OBJ_D)\fips_rand.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\rand\fips_rand.c

$(OBJ_D)\fips_rand_selftest.obj: $(SRC_D)\fips\rand\fips_rand_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_rand_selftest.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\rand\fips_rand_selftest.c

$(OBJ_D)\fips_rsa_eay.obj: $(SRC_D)\fips\rsa\fips_rsa_eay.c
	$(CC) /Fo$(OBJ_D)\fips_rsa_eay.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\rsa\fips_rsa_eay.c

$(OBJ_D)\fips_rsa_gen.obj: $(SRC_D)\fips\rsa\fips_rsa_gen.c
	$(CC) /Fo$(OBJ_D)\fips_rsa_gen.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\rsa\fips_rsa_gen.c

$(OBJ_D)\fips_rsa_selftest.obj: $(SRC_D)\fips\rsa\fips_rsa_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_rsa_selftest.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\rsa\fips_rsa_selftest.c

$(OBJ_D)\fips_rsa_x931g.obj: $(SRC_D)\fips\rsa\fips_rsa_x931g.c
	$(CC) /Fo$(OBJ_D)\fips_rsa_x931g.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\rsa\fips_rsa_x931g.c

$(OBJ_D)\fips_sha1dgst.obj: $(SRC_D)\fips\sha\fips_sha1dgst.c
	$(CC) /Fo$(OBJ_D)\fips_sha1dgst.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\sha\fips_sha1dgst.c

$(OBJ_D)\fips_sha1_selftest.obj: $(SRC_D)\fips\sha\fips_sha1_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_sha1_selftest.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\sha\fips_sha1_selftest.c

$(OBJ_D)\fips_sha256.obj: $(SRC_D)\fips\sha\fips_sha256.c
	$(CC) /Fo$(OBJ_D)\fips_sha256.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\sha\fips_sha256.c

$(OBJ_D)\fips_sha512.obj: $(SRC_D)\fips\sha\fips_sha512.c
	$(CC) /Fo$(OBJ_D)\fips_sha512.obj  $(LIB_CFLAGS) -c $(SRC_D)\fips\sha\fips_sha512.c
