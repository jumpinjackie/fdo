...
PLATFORM=VC-CE
CC=$(CC)
CFLAG= /W3 /WX /Ox /O2 /Ob2 /Gs0 /GF /Gy /nologo $(WCETARGETDEFS) -DUNICODE -D_UNICODE -DWIN32 -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 -DNO_CHMOD -I$(WCECOMPAT)/include /Fdout32dll_$(TARGETCPU) -DOPENSSL_NO_KRB5    
APP_CFLAG=
...
# be added
EX_LIBS=winsock.lib $(WCECOMPAT)/lib/wcecompatex.lib $(WCELDFLAGS)   
...
MKDIR=-mkdir
MKLIB=lib
MLFLAGS= /nologo /subsystem:windowsce,$(WCELDVERSION) /machine:$(WCELDMACHINE) /opt:ref /dll
ASM=
...
$(O_SSL): $(SSLOBJ)
  ...
  $(SHLIB_EX_OBJ) $(SSLOBJ)  $(L_CRYPTO) winsock.lib $(WCECOMPAT)/lib/wcecompatex.lib
<<

$(O_CRYPTO): $(CRYPTOOBJ)
	$(LINK) $(MLFLAGS) /out:$(O_CRYPTO) /def:ms/LIBEAY32.def @<<
  $(SHLIB_EX_OBJ) $(CRYPTOOBJ)  winsock.lib $(WCECOMPAT)/lib/wcecompatex.lib
<<
