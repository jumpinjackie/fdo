...
copy /y "boost\stage\%INTERMEDIATEDIR%\%TYPEBUILDTHR%\lib\boost_thread-vc100-mt%TYPEBUILDTHRPATH%-1_42.dll" "%FDOBINPATHTHR%"
copy /y "boost\stage\%INTERMEDIATEDIR%\%TYPEBUILDTHR%\lib\boost_date_time-vc100-mt%TYPEBUILDTHRPATH%-1_42.dll" "%FDOBINPATHTHR%"
...
copy /y "boost\stage\%PLATFORMTHR%\%TYPEBUILDTHR%\lib\boost_thread-vc100-mt%TYPEBUILDTHRPATH%-1_42.dll" "%FDOBINPATHTHR%"
rem # End WFS part #
...
copy /y "boost\stage\%PLATFORMTHR%\%TYPEBUILDTHR%\lib\boost_thread-vc100-mt%TYPEBUILDTHRPATH%-1_42.dll" "%FDOBINPATHTHR%"
copy /y "boost\stage\%PLATFORMTHR%\%TYPEBUILDTHR%\lib\boost_date_time-vc100-mt%TYPEBUILDTHRPATH%-1_42.dll" "%FDOBINPATHTHR%"
