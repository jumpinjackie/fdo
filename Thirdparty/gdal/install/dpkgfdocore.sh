...
#     usr/local/fdo-3.7.0/ - copied tree for core fdo libs
#     DEBIAN/
...
wget http://svn.osgeo.org/fdo/branches/3.7/License_README.txt -O tmp/copyright
...
dpkg-gensymbols -p"fdo-core" -P"debian/fdocore"
