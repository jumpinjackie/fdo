...
{
    return static_cast<FdoPhysicalElementMapping*>(UnmanagedObject.ToPointer());
}

IntPtr NAMESPACE_OSGEO_FDO_COMMANDS_SCHEMA::PhysicalElementMapping::GetDisposableObject()
{
