...
{
    return static_cast<FdoICreateMeasureUnit*>(UnmanagedObject.ToPointer());
}

IntPtr NAMESPACE_OSGEO_FDO_COMMANDS_UNITOFMEASURE::ICreateMeasureUnitImp::GetDisposableObject()
{
