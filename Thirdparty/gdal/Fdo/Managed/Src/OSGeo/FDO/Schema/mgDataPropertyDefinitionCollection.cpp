...
{
	return static_cast<FdoDataPropertyDefinitionCollection*>(UnmanagedObject.ToPointer());
}

IntPtr NAMESPACE_OSGEO_FDO_SCHEMA::DataPropertyDefinitionCollection::GetDisposableObject()
{
