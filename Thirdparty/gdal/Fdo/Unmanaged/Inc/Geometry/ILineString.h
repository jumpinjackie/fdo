#ifndef _ILINESTRING_H_
#define _ILINESTRING_H_
...
/// \brief
/// The FdoILineString class is a LineString Geometry type.  
/// The shape of FdoILineString is the set of positions defined by the contained collection, 
/// plus linear interpolation between consecutive points.
class FdoILineString : public FdoICurveAbstract
{
public:
...
protected:
    ...
    /// Returns nothing
    /// 
    FDO_GEOM_API virtual ~FdoILineString() {};
};


/// \brief
///  The FdoLineStringCollection class is a collection of CurvePolygon objects.
class FdoLineStringCollection : public FdoCollection<FdoILineString, FdoException>
{
public:
    /// \brief
    ///  Creates an instance of FdoLineStringCollection with no contained elements.
    /// 
    /// \return
    /// Returns an empty collection
    /// 
    static FdoLineStringCollection* Create()
    {
        FdoLineStringCollection* value = new FdoLineStringCollection();
        if (NULL == value)
