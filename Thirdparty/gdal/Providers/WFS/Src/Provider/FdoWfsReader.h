...
#ifndef FDOWFSREADER_H
#define FDOWFSREADER_H

#ifdef _WIN32
#pragma once
#endif // _WIN32

template <class FDO_READER> class FdoWfsReader :
    public FDO_READER
{
protected:
    virtual ~FdoWfsReader (void)
    {
    }
...
public:
    ...
    // DO NOT IMPLEMENT
    FdoWfsReader & operator= (const FdoWfsReader &right);
