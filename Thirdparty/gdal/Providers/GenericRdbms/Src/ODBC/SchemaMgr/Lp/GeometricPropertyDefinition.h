#ifndef FDOSMLPODBCGEOMETRICPROPERTYDEFINITION_H
#define FDOSMLPODBCGEOMETRICPROPERTYDEFINITION_H     1
/*
...
// Odbc Provider's LogicalPhysical GeometricPropertyDefinition
class FdoSmLpOdbcGeometricPropertyDefinition : public FdoSmLpGrdGeometricPropertyDefinition
{
public:

    // Construct from a property reader
    FdoSmLpOdbcGeometricPropertyDefinition(FdoSmPhClassPropertyReaderP propReader, FdoSmLpClassDefinition* parent);

	// Construct from an FDO property definition
    FdoSmLpOdbcGeometricPropertyDefinition(
        FdoGeometricPropertyDefinition* pFdoProp, 
        bool bIgnoreStates,
        FdoSmLpClassDefinition* parent
    );

	// Construct from ordinate columns
    FdoSmLpOdbcGeometricPropertyDefinition(
        FdoGeometricPropertyDefinition* pFdoProp, 
...
typedef FdoPtr<FdoSmLpOdbcGeometricPropertyDefinition> FdoSmLpOdbcGeometricPropertyP;
