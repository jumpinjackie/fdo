#ifndef FDOSMLPODBCDATAPROPERTYDEFINITION_H
#define FDOSMLPODBCDATAPROPERTYDEFINITION_H      1
/*
...
// Odbc Provider's LogicalPhysical DataPropertyDefinition
class FdoSmLpOdbcDataPropertyDefinition : public FdoSmLpGrdDataPropertyDefinition
{
public:

    // Construct from a property reader
    FdoSmLpOdbcDataPropertyDefinition(FdoSmPhClassPropertyReaderP propReader, FdoSmLpClassDefinition* parent);

	// Construct from an FDO property definition
    FdoSmLpOdbcDataPropertyDefinition(
...
typedef FdoPtr<FdoSmLpOdbcDataPropertyDefinition> FdoSmLpOdbcDataPropertyP;
