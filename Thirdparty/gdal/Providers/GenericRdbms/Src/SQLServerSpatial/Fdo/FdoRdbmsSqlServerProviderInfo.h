...
#define RDBMS_SQLSERVER_PROVIDER_NAME L"OSGeo.SQLServerSpatial.3.7"
...
#define RDBMS_SQLSERVER_PROVIDER_VERSION L"3.7.0.0"
#define RDBMS_SQLSERVER_FDO_VERSION L"3.7.0.0"
