...
c_KgInfExpressionCapabilities::c_KgInfExpressionCapabilities ()
{
}
...
void c_KgInfExpressionCapabilities::Dispose ()
{
    delete this;
}
...
FdoExpressionType* c_KgInfExpressionCapabilities::GetExpressionTypes (FdoInt32& Length)
{
    ...
    return (types);
}//end of c_KgInfExpressionCapabilities::GetExpressionTypes 
...
FdoFunctionDefinitionCollection* c_KgInfExpressionCapabilities::GetFunctions()
{
...
}//end of c_KgInfExpressionCapabilities::GetFunctions
