...
class c_KgInfGeometryCapabilities : public FdoIGeometryCapabilities
{
public:
    c_KgInfGeometryCapabilities ();

protected:
    virtual ~c_KgInfGeometryCapabilities ();
...
public:
    ...
    /// 
    FDOKGINF_API virtual FdoGeometryType* GetGeometryTypes( FdoInt32& Length);
    ...
    /// 
    FDOKGINF_API virtual FdoGeometryComponentType* GetGeometryComponentTypes( FdoInt32& Length );
    ...
    /// 
    FDOKGINF_API virtual FdoInt32 GetDimensionalities();
};
