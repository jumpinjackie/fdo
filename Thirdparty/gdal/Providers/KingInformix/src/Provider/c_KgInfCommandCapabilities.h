...
class c_KgInfCommandCapabilities : public FdoICommandCapabilities
{
public:
    c_KgInfCommandCapabilities ();

protected:
    virtual ~c_KgInfCommandCapabilities ();
...
public:
    ...
    /// 
    FDOKGINF_API virtual FdoInt32* GetCommands(FdoInt32& Size);
    ...
    /// 
    FDOKGINF_API virtual bool SupportsParameters();
    ...
    /// 
    FDOKGINF_API virtual bool SupportsSelectExpressions();
    ...
    /// 
    FDOKGINF_API virtual bool SupportsSelectFunctions();
    ...
    /// 
    FDOKGINF_API virtual bool SupportsSelectDistinct();
    ...
    /// 
    FDOKGINF_API virtual bool SupportsSelectOrdering();
    ...
    /// (but not vice versa).
    FDOKGINF_API virtual bool SupportsSelectGrouping();
};
