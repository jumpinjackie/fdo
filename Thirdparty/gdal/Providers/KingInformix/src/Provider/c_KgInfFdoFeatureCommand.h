...
#ifndef _c_KgInfFdoFeatureCommand_h
#define _c_KgInfFdoFeatureCommand_h


#include "c_KgInfFdoCommand.h"

template <class FDO_COMMAND> class c_KgInfFdoFeatureCommand : public c_KgInfFdoCommand<FDO_COMMAND>
{
...
protected:
    ...
    c_KgInfFdoFeatureCommand (c_KgInfConnection* Connection) :
        c_KgInfFdoCommand<FDO_COMMAND>(Connection)  
    {
    }

    /// Default destructor for a command.
    virtual ~c_KgInfFdoFeatureCommand() 
    { 
    }
...
FdoFilter* c_KgInfFdoFeatureCommand<FDO_COMMAND>::GetFilter ()
{
...
/// Returns nothing
template <class FDO_COMMAND> 
void c_KgInfFdoFeatureCommand<FDO_COMMAND>::SetFilter (FdoFilter* Filter)
{
...
/// Returns nothing
template <class FDO_COMMAND> 
void c_KgInfFdoFeatureCommand<FDO_COMMAND>::SetFilter (FdoString* value)
{
...
/// Returns the class identifier.
template <class FDO_COMMAND> 
FdoIdentifier* c_KgInfFdoFeatureCommand<FDO_COMMAND>::GetFeatureClassName ()
{
...
/// Returns nothing.
template <class FDO_COMMAND> 
void c_KgInfFdoFeatureCommand<FDO_COMMAND>::SetFeatureClassName (FdoIdentifier* ClassName)
{
...
/// Returns nothing
template <class FDO_COMMAND> 
void c_KgInfFdoFeatureCommand<FDO_COMMAND>::SetFeatureClassName (FdoString* ClassName)
{
