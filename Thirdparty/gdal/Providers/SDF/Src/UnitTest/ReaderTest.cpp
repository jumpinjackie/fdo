...
#include <unistd.h>
#endif
#define SDF_FILE_READER_TEST  L"../../TestData/ReaderTest.sdf"
#define SDF_FILE_READER_TEST2  L"../../TestData/bayarea_cities.sdf"
...
void ReaderTest::TestFeatureReaderWithIndex ()
{
    ...
    // Test 1 - select base class
    {
        ...
        while( reader1->ReadNext() )
        {
            ...
            // NOTE: SDF Provider puts the default geometry property at the end.
            CPPUNIT_ASSERT(reader1->GetPropertyIndex(L"geometry") == 10);
    ...
    // Test 3 - select derived class
    {
        ...
        CPPUNIT_ASSERT( reader3->ReadNext() );
        {
            ...
            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"boolean") == 1);
            CPPUNIT_ASSERT(reader3->IsNull(L"boolean") == reader3->IsNull(1));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"byte") == 2);
            CPPUNIT_ASSERT(reader3->IsNull(L"byte")    == reader3->IsNull(2));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"datetime") == 3);
            CPPUNIT_ASSERT(reader3->IsNull(L"datetime") == reader3->IsNull(3));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"single") == 8);
            CPPUNIT_ASSERT(reader3->IsNull(L"single") == reader3->IsNull(8));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"string") == 9);
            CPPUNIT_ASSERT(reader3->IsNull(L"string") == reader3->IsNull(9));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"double") == 4);
            CPPUNIT_ASSERT(reader3->IsNull(L"double") == reader3->IsNull(4));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"int16") == 5);
            CPPUNIT_ASSERT(reader3->IsNull(L"int16") == reader3->IsNull(5));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"int32") == 6);
            CPPUNIT_ASSERT(reader3->IsNull(L"int32") == reader3->IsNull(6));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"int64") == 7);
            CPPUNIT_ASSERT(reader3->IsNull(L"int64") == reader3->IsNull(7));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"geometry") == 10);
            ...
            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"number") == 11);
            CPPUNIT_ASSERT(reader3->GetInt32(L"number") == reader3->GetInt32(11));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"datetime2") == 12);
            ...
            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"double2") == 13);
            CPPUNIT_ASSERT(reader3->GetDouble(L"double2") == reader3->GetDouble(13));

            CPPUNIT_ASSERT(reader3->GetPropertyIndex(L"geometry2") == 14);
    ...
    // Test 4 - select derived class with selected properties
    {
        ...
        {
            CPPUNIT_ASSERT(reader4->GetPropertyIndex(L"byte")    == 0);
            CPPUNIT_ASSERT(reader4->GetPropertyIndex(L"number")  == 1);
...
{
    FdoPtr<FdoIConnection> connection = (FdoIConnection *) UnitTestUtil::OpenConnection(SDF_FILE_READER_TEST2, false);
...
void ReaderTest::PrepareConnection()
{
    try
    {
        m_connection = (FdoIConnection *) UnitTestUtil::OpenConnection(SDF_FILE_READER_TEST, true);
    }
