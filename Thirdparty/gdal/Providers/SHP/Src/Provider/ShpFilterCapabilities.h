...
#ifndef SHPFILTERCAPABILITIES_H
#define SHPFILTERCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class ShpFilterCapabilities : public FdoIFilterCapabilities
{
public:
    ShpFilterCapabilities ();

protected:
    virtual ~ShpFilterCapabilities ();
