...
FdoFunctionM *FdoFunctionM::Create ()
...

{
    ...
    return new FdoFunctionM();

}  //  Create ()

FdoFunctionM *FdoFunctionM::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionM::GetFunctionDefinition ()
...
FdoLiteralValue *FdoFunctionM::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function M().
// +---------------------------------------------------------------------------

{
	...
	// Check dimensionality if M exists
	if (  ! (geom->GetDimensionality() & FdoDimensionality_M ) )
    {
        return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
    }
    ...
    if ( FdoExpressionEngineGeometryUtil::IsOrdinateNull(pos->GetM()) )
        return_double_value->SetNull();
    else
...
void FdoFunctionM::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function M. The
...

{
    ...
    desc = FdoException::NLSGetMessage(
                                FUNCTION_X,
                                "Determines the M coordinate of a point geometry");
    function_definition =
...
void FdoFunctionM::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. M() accepts one parameter only. If the
