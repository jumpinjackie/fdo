...
FdoSmPhRdSpatialContextGroupReader::FdoSmPhRdSpatialContextGroupReader(
    FdoSmPhRowsP froms, 
    FdoSmPhMgrP mgr
...
FdoSmPhRdSpatialContextGroupReader::~FdoSmPhRdSpatialContextGroupReader(void)
{
}

bool FdoSmPhRdSpatialContextGroupReader::ReadNext()
{
