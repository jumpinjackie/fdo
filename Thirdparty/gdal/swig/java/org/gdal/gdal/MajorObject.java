...
public class MajorObject {
  ...
  public java.util.Hashtable GetMetadata_Dict(String pszDomain) {
    return gdalJNI.MajorObject_GetMetadata_Dict(swigCPtr, this, pszDomain);
  }

  public java.util.Vector GetMetadata_List(String pszDomain) {
    return gdalJNI.MajorObject_GetMetadata_List(swigCPtr, this, pszDomain);
  }
  ...
  public int SetMetadata(String pszMetadataString, String pszDomain) {
    return gdalJNI.MajorObject_SetMetadata__SWIG_1(swigCPtr, this, pszMetadataString, pszDomain);
  }
