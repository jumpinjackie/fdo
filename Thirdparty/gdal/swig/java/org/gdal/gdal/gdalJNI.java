...
class gdalJNI {
  ...
  public final static native java.util.Hashtable MajorObject_GetMetadata_Dict(long jarg1, MajorObject jarg1_, String jarg2);
  public final static native java.util.Vector MajorObject_GetMetadata_List(long jarg1, MajorObject jarg1_, String jarg2);
  public final static native int MajorObject_SetMetadata__SWIG_0(long jarg1, MajorObject jarg1_, java.util.Hashtable jarg2, String jarg3);
  public final static native int MajorObject_SetMetadata__SWIG_1(long jarg1, MajorObject jarg1_, String jarg2, String jarg3);
  ...
  public final static native long Driver_Create(long jarg1, Driver jarg1_, String jarg2, int jarg3, int jarg4, int jarg5, int jarg6, java.util.Vector jarg7);
  public final static native long Driver_CreateCopy(long jarg1, Driver jarg1_, String jarg2, long jarg3, Dataset jarg3_, int jarg4, java.util.Vector jarg5);
  ...
  public final static native long GCPsToGeoTransform(int jarg1, long jarg2, GCP jarg2_, double[] jarg3, int jarg4);
  ...
  public final static native int Dataset_BuildOverviews(long jarg1, Dataset jarg1_, String jarg2, int[] jarg3);
  ...
  public final static native int Dataset_SetGCPs(long jarg1, Dataset jarg1_, int jarg2, long jarg3, GCP jarg3_, String jarg4);
  public final static native void Dataset_FlushCache(long jarg1, Dataset jarg1_);
  public final static native int Dataset_AddBand(long jarg1, Dataset jarg1_, int jarg2, java.util.Vector jarg3);
  public final static native int Dataset_WriteRaster(long jarg1, Dataset jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, char[] jarg6, int[] jarg8, int[] jarg9, int[] jarg10, int[] jarg11);
  public final static native int Dataset_ReadRaster(long jarg1, Dataset jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, char[][] jarg6, int[] jarg8, int[] jarg9, int[] jarg10, int[] jarg11);
  ...
  public final static native void Band_ComputeRasterMinMax(long jarg1, Band jarg1_, double[] jarg2, int jarg3);
  public final static native void Band_ComputeBandStats(long jarg1, Band jarg1_, double[] jarg2, int jarg3);
  public final static native int Band_Fill(long jarg1, Band jarg1_, double jarg2, double jarg3);
  public final static native int Band_ReadRaster(long jarg1, Band jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, char[][] jarg6, int[] jarg8, int[] jarg9, int[] jarg10);
  public final static native int Band_WriteRaster(long jarg1, Band jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, char[] jarg6, int[] jarg8, int[] jarg9, int[] jarg10);
  ...
  public final static native int Band_ReadRaster_Direct(long jarg1, Band jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, int jarg6, int jarg7, int jarg8, java.nio.ByteBuffer jarg9);
  public final static native int Band_WriteRaster_Direct(long jarg1, Band jarg1_, int jarg2, int jarg3, int jarg4, int jarg5, int jarg6, int jarg7, int jarg8, java.nio.ByteBuffer jarg9);
  ...
  public final static native int ColorTable_GetColorEntryAsRGB(long jarg1, ColorTable jarg1_, int jarg2, java.awt.Color jarg3);
  ...
  public final static native long AutoCreateWarpedVRT(long jarg1, Dataset jarg1_, String jarg2, String jarg3, int jarg4, double jarg5);
