...
class gdalPINVOKE {
  ...
  public static extern string CPLBinaryToHex(int jarg1, HandleRef jarg2);

  [DllImport("gdal_wrap", EntryPoint="CSharp_CPLHexToBinary")]
  public static extern IntPtr CPLHexToBinary(string jarg1, HandleRef jarg2);
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_MajorObject_GetMetadata_Dict")]
  public static extern IntPtr MajorObject_GetMetadata_Dict(HandleRef jarg1, string jarg2);

  [DllImport("gdal_wrap", EntryPoint="CSharp_MajorObject_GetMetadata_List")]
  ...
  public static extern IntPtr Driver_CreateCopy(HandleRef jarg1, string jarg2, HandleRef jarg3, int jarg4, IntPtr[] jarg5);
  ...
  public static extern IntPtr GCPsToGeoTransform(int jarg1, HandleRef jarg2, double[] jarg3, int jarg4);
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_Dataset_GetGCPs")]
  public static extern void Dataset_GetGCPs(HandleRef jarg1, HandleRef jarg2, HandleRef jarg3);

  [DllImport("gdal_wrap", EntryPoint="CSharp_Dataset_SetGCPs")]
  ...
  public static extern int Dataset_ReadRaster(HandleRef jarg1, int jarg2, int jarg3, int jarg4, int jarg5, HandleRef jarg8, HandleRef jarg9, HandleRef jarg10, int jarg11);
