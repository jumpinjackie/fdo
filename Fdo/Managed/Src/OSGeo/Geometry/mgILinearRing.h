...
public interface class ILinearRing : public NAMESPACE_OSGEO_GEOMETRY::IRingAbstract
{
public:
    /// \brief
...
public ref class LinearRingCollection sealed : public NAMESPACE_OSGEO_COMMON::CollectionBase
{
public:
    /// \brief
...
public:
    ...
    /// 
	System::Void CopyTo(array<NAMESPACE_OSGEO_GEOMETRY::ILinearRing^>^ pArray, System::Int32 index);
    ...
    /// 
    property NAMESPACE_OSGEO_GEOMETRY::ILinearRing^ Item[System::Int32]
    {
        NAMESPACE_OSGEO_GEOMETRY::ILinearRing^ get(System::Int32 index);
        System::Void set(System::Int32 index, NAMESPACE_OSGEO_GEOMETRY::ILinearRing^ value);
    }
};
