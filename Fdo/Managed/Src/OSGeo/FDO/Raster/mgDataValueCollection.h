...
public:
    ...
    /// 
    System::Void CopyTo(array<DataValue^>^ pArray, System::Int32 index);
    ...
    /// 
    property DataValue^ Item[System::Int32]
    {
        DataValue^ get(System::Int32 index);
        System::Void set(System::Int32 index, DataValue^ value);
    }
};
