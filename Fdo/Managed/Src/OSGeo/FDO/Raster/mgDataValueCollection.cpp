...
NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::DataValueCollection() : Disposable(System::IntPtr::Zero, false)
{
	EXCEPTION_HANDLER(Attach(FdoArgumentDefinitionCollection::Create(), true))
}

NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::DataValueCollection(System::IntPtr unmanaged, System::Boolean autoDelete) : Disposable(unmanaged, autoDelete)
{
...
System::Void NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::ICollection::CopyTo(System::Array* array, System::Int32 index) 
{
	if (NULL == array)
	{
...
System::Void NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::CopyTo(DataValue* array[], System::Int32 index)
{
	if (NULL == array)
	{
		throw new System::ArgumentNullException();
...
System::Boolean NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::ICollection::get_IsSynchronized()
{
	return false;
}

System::Boolean NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::get_IsFixedSize() 
{ 
	return false;
}

System::Boolean NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::get_IsReadOnly() 
{ 
	return false;
}

System::Object* NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::get_Item(System::Int32 index)
{
	return get_RealTypeItem( index );
}

System::Void NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::set_Item(System::Int32 index, System::Object* value)
{
	set_RealTypeItem(index,  __try_cast<NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue*>(value) );
}

System::Int32 NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::Add(System::Object* value)
{
	return Add(__try_cast<NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue*>(value));
}

System::Boolean NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::Contains(System::Object* value)
{
	return Contains(__try_cast<NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue*>(value));
}

System::Int32 NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::IndexOf(System::Object* value)
{
	return IndexOf(__try_cast<NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue*>(value));
}

System::Void NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::Insert(System::Int32 index, System::Object* value)
{
	Insert(index,__try_cast<NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue*>(value));
}

System::Void NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::IList::Remove(System::Object* value)
{
...
System::Collections::IEnumerator* NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::GetEnumerator()
{
	return new Enumerator(this);
}

System::Int32 NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::get_Count(System::Void)
{
	FdoInt32 length;
...
/*
Implementation for DataValueCollection::Enumerator
*/ 
System::Object* NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::Enumerator::get_Current()
{
...
System::Boolean NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::Enumerator::MoveNext()
{
	++m_nIdx;
	return m_nIdx < m_pCol->Count;
}

System::Void NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::Enumerator::Reset()
{
	m_nIdx = -1;
}

NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue* NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::get_RealTypeItem(System::Int32 index)
{
	FdoDataValue* upElement;
...
System::Void  NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::set_RealTypeItem(System::Int32 index, NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue* value)
{
	EXCEPTION_HANDLER(GetImpObj()->SetItem(index, (value == NULL ? NULL : value->GetImpObj())))
}

NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue* NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::get_Item(System::Int32 index)
{
	return get_RealTypeItem(index);
}

System::Void  NAMESPACE_OSGEO_FDO_RASTER::DataValueCollection::set_Item(System::Int32 index, NAMESPACE_OSGEO_FDO_EXPRESSION::DataValue* value)
{
