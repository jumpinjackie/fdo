...
class FdoValueExpressionCollection;
...
public ref class ValueExpressionCollection sealed : public NAMESPACE_OSGEO_COMMON::CollectionBase
{
/// \cond DOXYGEN-IGNORE
internal:
...
public:
    ...
    /// 
    System::Void CopyTo(array<NAMESPACE_OSGEO_FDO_EXPRESSION::ValueExpression^>^ pArray, System::Int32 index);
    ...
    /// 
    property NAMESPACE_OSGEO_FDO_EXPRESSION::ValueExpression^ Item[System::Int32]
    {
        NAMESPACE_OSGEO_FDO_EXPRESSION::ValueExpression^ get(System::Int32 index);
        System::Void set(System::Int32 index, NAMESPACE_OSGEO_FDO_EXPRESSION::ValueExpression^ value);
    }
};
