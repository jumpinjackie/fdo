...
/// existing one.
public interface class ICreateMeasureUnit : public NAMESPACE_OSGEO_FDO_COMMANDS::ICommand
{
public:
    /// \brief
    ...
    /// Returns nothing
    /// 
    property NAMESPACE_OSGEO_FDO_COMMANDS_UNITOFMEASURE::BaseUnit BaseUnit
    {
    ...
    /// Returns nothing
    /// 
    property System::Boolean UpdateExisting
    {
        System::Boolean get();
