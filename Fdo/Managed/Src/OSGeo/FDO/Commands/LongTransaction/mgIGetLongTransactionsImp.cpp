...
{
    return static_cast<FdoIGetLongTransactions*>(UnmanagedObject.ToPointer());
}

IntPtr NAMESPACE_OSGEO_FDO_COMMANDS_LONGTRANSACTION::IGetLongTransactionsImp::GetDisposableObject()
{
