...
class FdoLiteralValueCollection;
...
/// \brief
/// LiteralValueCollection is a collection of LiteralValue objects.
[System::Reflection::DefaultMemberAttribute("Item")]
public ref class LiteralValueCollection sealed : public NAMESPACE_OSGEO_COMMON::CollectionBase
{
/// \cond DOXYGEN-IGNORE
internal:
...
public:
    ...
    /// 
	System::Int32 Add(NAMESPACE_OSGEO_FDO_EXPRESSION::LiteralValue^ value);
    ...
    /// 
    System::Void CopyTo(array<NAMESPACE_OSGEO_FDO_EXPRESSION::LiteralValue^>^ pArray, System::Int32 index);
    ...
    /// 
    property NAMESPACE_OSGEO_FDO_EXPRESSION::LiteralValue^ Item[System::Int32]
    {
        NAMESPACE_OSGEO_FDO_EXPRESSION::LiteralValue^ get(System::Int32 index);
        System::Void set(System::Int32 index, NAMESPACE_OSGEO_FDO_EXPRESSION::LiteralValue^ value);
    }
};
