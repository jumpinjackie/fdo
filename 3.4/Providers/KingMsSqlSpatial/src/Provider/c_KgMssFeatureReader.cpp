...
//---------------------------------------------------------------------
//
//    c_KgMssFeatureReader
//
//---------------------------------------------------------------------

c_KgMssFeatureReader::c_KgMssFeatureReader(c_KgMssConnection * Connection
...
c_KgMssFeatureReader::~c_KgMssFeatureReader()
{
    Close();
...
void c_KgMssFeatureReader::Dispose()
{
    delete this;
}

FdoClassDefinition* c_KgMssFeatureReader::GetClassDefinition()
{     
    if( m_ClassDef )
    {
...
FdoInt32 c_KgMssFeatureReader::GetDepth()
{
    return 0;
}
...
FdoIFeatureReader* c_KgMssFeatureReader::GetFeatureObject(FdoString* propertyName)
{
    return NULL;
}
