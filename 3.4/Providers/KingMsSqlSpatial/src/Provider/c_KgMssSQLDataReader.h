...
public:
    ...
    /// 
    FDOKGMSS_API virtual FdoInt32 GetColumnCount();
    ...
    /// 
    FDOKGMSS_API virtual FdoDataType GetColumnType(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoPropertyType GetPropertyType(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual bool GetBoolean(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoByte GetByte(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoDateTime GetDateTime(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual double GetDouble(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoInt16 GetInt16(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoInt32 GetInt32(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoInt64 GetInt64(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual float GetSingle(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoString* GetString(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoLOBValue* GetLOB(FdoString* propertyName);
    ...
    /// 
    FDOKGMSS_API virtual bool IsNull(FdoString* ColumnName);
    ...
    /// 
    FDOKGMSS_API virtual FdoByteArray* GetGeometry(FdoString* ColumnName);
