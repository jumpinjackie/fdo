...
c_KgMssRasterCapabilities::c_KgMssRasterCapabilities ()
{
}
...
void c_KgMssRasterCapabilities::Dispose()
{
    delete this;
}
...
bool c_KgMssRasterCapabilities::SupportsRaster ()
{
    return (false);
}
...
bool c_KgMssRasterCapabilities::SupportsStitching ()
{
    return (false);
}
...
bool c_KgMssRasterCapabilities::SupportsSubsampling ()
{
    return (false);
}
...
bool c_KgMssRasterCapabilities::SupportsDataModel (FdoRasterDataModel* Model)
{
    return (false);
}
