...
#ifndef _c_KgMssRasterCapabilities_h
#define _c_KgMssRasterCapabilities_h


class c_KgMssRasterCapabilities : public FdoIRasterCapabilities
{
public:
    c_KgMssRasterCapabilities ();

protected:
    virtual ~c_KgMssRasterCapabilities ();
...
public:
   /// \brief
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsRaster ();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsStitching ();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsSubsampling ();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsDataModel (FdoRasterDataModel* Model);
};
