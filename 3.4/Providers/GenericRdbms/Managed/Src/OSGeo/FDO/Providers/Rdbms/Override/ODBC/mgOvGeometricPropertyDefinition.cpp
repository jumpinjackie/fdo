...
{
	EXCEPTION_HANDLER(Attach((FdoIDisposable*)FdoOdbcOvGeometricPropertyDefinition::Create(), true))
}
...
{
	EXCEPTION_HANDLER(Attach((FdoIDisposable*)FdoOdbcOvGeometricPropertyDefinition::Create(StringToUni(name)), true))
}
