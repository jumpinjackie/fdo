#ifndef FDOSMPHODBCDATABASE_H
#define FDOSMPHODBCDATABASE_H        1
/*
...
class FdoSmPhOdbcDatabase : public FdoSmPhDatabase
{
public:
...
typedef FdoPtr<FdoSmPhOdbcDatabase> FdoSmPhOdbcDatabaseP;
