...
#define RDBMS_SQLSERVER_PROVIDER_NAME L"OSGeo.SQLServerSpatial.3.4"
...
#define RDBMS_SQLSERVER_PROVIDER_VERSION L"3.4.0.0"
#define RDBMS_SQLSERVER_FDO_VERSION L"3.4.0.0"
