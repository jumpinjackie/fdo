...
FdoSmLpClass::FdoSmLpClass(FdoSmPhClassReaderP classReader, FdoSmLpSchemaElement* parent) : 
	FdoSmLpClassDefinition(classReader, parent),
	FdoSmLpClassBase(classReader, parent)
{
}

FdoSmLpClass::FdoSmLpClass(
...
FdoSmLpClass::FdoSmLpClass(
	...
	FdoSmLpClassDefinition(name, description, parent, pSrcClass, tableMapping, tableName, table, elementState),
...
FdoClassType FdoSmLpClass::GetClassType() const
{
