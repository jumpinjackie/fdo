...
if "%FDOCOREENABLE%"=="no" goto start_zip_shp
   ...
   popd
   if exist "fdo-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdo-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdo-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
...
if "%SHPENABLE%"=="no" goto start_zip_sdf
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoshp-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdoshp-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoshp-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_sdf
if "%SDFENABLE%"=="no" goto start_zip_wfs
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdosdf-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdosdf-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdosdf-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_wfs
if "%WFSENABLE%"=="no" goto start_zip_wms
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdowfs-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdowfs-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdowfs-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_wms
if "%WMSENABLE%"=="no" goto start_zip_arcsde
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdowms-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdowms-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdowms-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_arcsde
if "%ARCSDEENABLE%"=="no" goto start_zip_rdbms
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoarcsde-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdoarcsde-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoarcsde-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_rdbms
if "%RDBMSENABLE%"=="no" goto start_zip_gdal
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdordbms-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdordbms-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdordbms-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_gdal
if "%GDALENABLE%"=="no" goto start_zip_king_oracle
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdogdal-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdogdal-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdogdal-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
...
if "%KINGORACLEENABLE%"=="no" goto start_zip_ogr
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdokingoracle-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdokingoracle-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdokingoracle-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_ogr
if "%OGRENABLE%"=="no" goto start_zip_sqlite
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoogr-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdoogr-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoogr-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_sqlite
if "%SQLITEENABLE%"=="no" goto start_zip_testdata
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdosqlite-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f "fdosqlite-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdosqlite-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_testdata
if "%ZIPTESTDATA%"=="no" goto end
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoarcsde-testdata-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f fdoarcsde-testdata-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoarcsde-testdata-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdogdal-testdata-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f fdogdal-testdata-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdogdal-testdata-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdosdf-testdata-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f fdosdf-testdata-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdosdf-testdata-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoshp-testdata-4.0.0_%FDOBUILDNUMBER%.zip" del /q /f fdoshp-testdata-4.0.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoshp-testdata-4.0.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
