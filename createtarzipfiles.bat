...
if "%FDOCOREENABLE%"=="no" goto start_zip_shp
   ...
   popd
   if exist "fdo-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdo-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdo-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
...
if "%SHPENABLE%"=="no" goto start_zip_sdf
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoshp-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdoshp-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoshp-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_sdf
if "%SDFENABLE%"=="no" goto start_zip_wfs
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdosdf-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdosdf-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdosdf-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_wfs
if "%WFSENABLE%"=="no" goto start_zip_wms
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdowfs-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdowfs-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdowfs-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_wms
if "%WMSENABLE%"=="no" goto start_zip_arcsde
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdowms-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdowms-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdowms-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_arcsde
if "%ARCSDEENABLE%"=="no" goto start_zip_rdbms
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoarcsde-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdoarcsde-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoarcsde-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_rdbms
if "%RDBMSENABLE%"=="no" goto start_zip_gdal
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdordbms-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdordbms-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdordbms-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_gdal
if "%GDALENABLE%"=="no" goto start_zip_king_oracle
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdogdal-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdogdal-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdogdal-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
...
if "%KINGORACLEENABLE%"=="no" goto start_zip_ogr
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdokingoracle-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdokingoracle-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdokingoracle-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_ogr
if "%OGRENABLE%"=="no" goto start_zip_sqlite
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoogr-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdoogr-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoogr-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_sqlite
if "%SQLITEENABLE%"=="no" goto start_zip_testdata
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdosqlite-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f "fdosqlite-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdosqlite-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
:start_zip_testdata
if "%ZIPTESTDATA%"=="no" goto end
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoarcsde-testdata-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f fdoarcsde-testdata-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoarcsde-testdata-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdogdal-testdata-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f fdogdal-testdata-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdogdal-testdata-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdosdf-testdata-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f fdosdf-testdata-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdosdf-testdata-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
   ...
   if exist .svn del /q /f /s .svn
   popd
   if exist "fdoshp-testdata-3.9.0_%FDOBUILDNUMBER%.zip" del /q /f fdoshp-testdata-3.9.0_%FDOBUILDNUMBER%.zip"
   7z a -airy -bd -tzip "fdoshp-testdata-3.9.0_%FDOBUILDNUMBER%.zip" "%FDOTARZIPFOLDER%"
   deltree /Y "%FDOTARZIPFOLDER%"
