#ifndef FdoSmPhRdPostGisDBSCHEMAREADER_H
#define FdoSmPhRdPostGisDBSCHEMAREADER_H		1
/*
...
class FdoSmPhRdPostGisDbSchemaReader : public FdoSmPhReader
{
public:
    /// Create the reader
	//
    ...
    FdoSmPhRdPostGisDbSchemaReader(
        FdoSmPhOwnerP owner,
        FdoStringP schemaName = L""
    );

    /// Deactivates the reader
	~FdoSmPhRdPostGisDbSchemaReader(void);
...
typedef FdoPtr<FdoSmPhRdPostGisDbSchemaReader> FdoSmPhRdPostGisDbSchemaReaderP;
