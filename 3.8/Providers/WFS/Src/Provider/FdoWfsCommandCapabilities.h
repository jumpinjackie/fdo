...
#ifndef FDOWFSCOMMANDCAPABILITIES_H
#define FDOWFSCOMMANDCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class FdoWfsCommandCapabilities : public FdoICommandCapabilities
{
public:
    FdoWfsCommandCapabilities ();

protected:
    virtual ~FdoWfsCommandCapabilities ();
...
#endif // FDOWFSCOMMANDCAPABILITIES_H
