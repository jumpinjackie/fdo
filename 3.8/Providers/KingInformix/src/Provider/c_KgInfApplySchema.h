...
#ifndef _c_KgInfApplySchema_h
#define _c_KgInfApplySchema_h

class c_KgInfApplySchema : public c_KgInfFdoCommand<FdoIApplySchema>
{
public:
  c_KgInfApplySchema(c_KgInfConnection *Conn);
public:
  ~c_KgInfApplySchema(void);
...
public:  
    ...
    /// 
    FDOKGINF_API virtual FdoFeatureSchema* GetFeatureSchema();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void SetFeatureSchema(FdoFeatureSchema* value);
    ...
    /// 
    FDOKGINF_API virtual FdoPhysicalSchemaMapping* GetPhysicalMapping();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void SetPhysicalMapping(FdoPhysicalSchemaMapping* value);
    ...
    /// 
    ///  
    FDOKGINF_API virtual FdoBoolean GetIgnoreStates();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void SetIgnoreStates( FdoBoolean ignoreStates );
    ...
    // Helper functions
protected:
  void InsertSdoGeomMetadata(FdoStringP TableName,FdoGeometricPropertyDefinition* GeomProp);
