...
#ifndef _c_KgInfInsert_h
#define _c_KgInfInsert_h

class c_KgInfInsert : public c_KgInfFdoCommand<FdoIInsert>
{
public:
  c_KgInfInsert(c_KgInfConnection *Conn);
public:
  ~c_KgInfInsert(void);
...
public:  
  /// \brief
    ...
    /// 
    FDOKGINF_API virtual FdoIdentifier* GetFeatureClassName();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void SetFeatureClassName(FdoIdentifier* ClassId);
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void SetFeatureClassName(FdoString* ClassName);
    ...
    /// 
    FDOKGINF_API virtual FdoPropertyValueCollection* GetPropertyValues();
    ...
    /// 
    FDOKGINF_API virtual FdoBatchParameterValueCollection* GetBatchParameterValues();
    ...
    /// 
    FDOKGINF_API virtual FdoIFeatureReader* Execute();
};
