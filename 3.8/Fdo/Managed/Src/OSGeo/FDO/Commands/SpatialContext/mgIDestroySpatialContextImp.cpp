...
{
    return static_cast<FdoIDestroySpatialContext*>(UnmanagedObject.ToPointer());
}

IntPtr NAMESPACE_OSGEO_FDO_COMMANDS_SPATIALCONTEXT::IDestroySpatialContextImp::GetDisposableObject()
{
