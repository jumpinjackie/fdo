...
FdoWfsRasterCapabilities::FdoWfsRasterCapabilities ()
{
}
...
void FdoWfsRasterCapabilities::Dispose()
{
    delete this;
}
...
bool FdoWfsRasterCapabilities::SupportsRaster ()
{
    return (false);
}
...
bool FdoWfsRasterCapabilities::SupportsStitching ()
{
    return (false);
}
...
bool FdoWfsRasterCapabilities::SupportsSubsampling ()
{
    return (false);
}
...
bool FdoWfsRasterCapabilities::SupportsDataModel (FdoRasterDataModel* model)
{
    return (false);
}
