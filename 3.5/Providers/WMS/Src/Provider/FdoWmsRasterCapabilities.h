...
#ifndef FDOWMSRASTERCAPABILITIES_H
#define FDOWMSRASTERCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class FdoWmsRasterCapabilities : public FdoIRasterCapabilities
{
public:
    // <summary>Default Constructor.</summary>
    // <returns>Returns nothing</returns> 
    FdoWmsRasterCapabilities ();

protected:
    // <summary>Virtual Destructor.</summary>
    // <returns>Returns nothing</returns> 
    virtual ~FdoWmsRasterCapabilities ();
...
#endif // FDOWMSRASTERCAPABILITIES_H
