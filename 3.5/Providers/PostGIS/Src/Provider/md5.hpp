#ifndef FDOPOSTGIS_BOOST_MD5_HPP_INCLUDED
#define FDOPOSTGIS_BOOST_MD5_HPP_INCLUDED
...
//
// NOTE - mloskot: renamed from namespace boost
//
...
#endif // FDOPOSTGIS_BOOST_MD5_HPP_INCLUDED
