...
#ifndef FDORDBMSODBCSCHEMACAPABILITIES_H
#define FDORDBMSODBCSCHEMACAPABILITIES_H        1

#ifdef _WIN32
#pragma once
#endif

class FdoRdbmsOdbcSchemaCapabilities :    public FdoISchemaCapabilities
{
public:
    FdoRdbmsOdbcSchemaCapabilities(void);
...
#endif // FDORDBMSODBCSCHEMACAPABILITIES_H
