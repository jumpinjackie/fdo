...
FdoSmLpSqsSchemaCollection::FdoSmLpSqsSchemaCollection(FdoSmPhMgrP physicalSchema, FdoSmLpSpatialContextMgrP scMgr) :
...
FdoSmLpSchemaP FdoSmLpSqsSchemaCollection::NewSchema(
    FdoFeatureSchema* pFeatSchema,
    bool bIgnoreStates
)
{
    return new FdoSmLpSqsSchema(pFeatSchema, bIgnoreStates, GetPhysicalSchema(), this);
}
