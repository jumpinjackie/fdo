...
#ifndef _c_KgKmlConnectionInfo_h
#define _c_KgKmlConnectionInfo_h
...
class c_KgKmlConnectionInfo : public FdoIConnectionInfo
{
    

public:
    c_KgKmlConnectionInfo (c_KgKmlConnection * m_Connection); 
    c_KgKmlConnectionInfo (); 
    
    
protected:
    
    c_KgKmlConnection  * m_Connection;
...
public:
    ...
    FDOKGKML_API FdoString* GetFeatureDataObjectsVersion ();
    ...
    FDOKGKML_API FdoIConnectionPropertyDictionary* GetConnectionProperties ();
    ...
    /// 
    FDOKGKML_API virtual FdoProviderDatastoreType GetProviderDatastoreType();
    ...
    /// 
    FDOKGKML_API virtual FdoStringCollection* GetDependentFileNames();
    #endif
