...
c_KgKmlSchemaCapabilities::c_KgKmlSchemaCapabilities ()
{
}
...
void c_KgKmlSchemaCapabilities::Dispose ()
{
    delete this;
}
...
FdoClassType* c_KgKmlSchemaCapabilities::GetClassTypes (FdoInt32& Length)
{
    ...
    return (classes);
}//end of c_KgKmlSchemaCapabilities::GetClassTypes
...
FdoDataType* c_KgKmlSchemaCapabilities::GetDataTypes (FdoInt32& Length)
{
    ...
    return (types);
}//end of c_KgKmlSchemaCapabilities::GetDataTypes
...
bool c_KgKmlSchemaCapabilities::SupportsInheritance ()
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsMultipleSchemas ()
{
    return true;
}
...
bool c_KgKmlSchemaCapabilities::SupportsObjectProperties ()
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsSchemaOverrides ()
{
    return true;
}
...
bool c_KgKmlSchemaCapabilities::SupportsAssociationProperties (void)
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsNetworkModel (void)
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsAutoIdGeneration ()
{
    return true;
}
...
bool c_KgKmlSchemaCapabilities::SupportsDataStoreScopeUniqueIdGeneration ()
{
    return false;
}
...
/// <param name="length">Output the number of data types.</param> 
/// <returns>Returns the list of data types</returns> 
FdoDataType* c_KgKmlSchemaCapabilities::GetSupportedAutoGeneratedTypes (FdoInt32& Length)
{
...
bool c_KgKmlSchemaCapabilities::SupportsSchemaModification ()
{
    return true;
}
...
bool c_KgKmlSchemaCapabilities::SupportsInclusiveValueRangeConstraints()
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsExclusiveValueRangeConstraints()
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsValueConstraintsList()
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsNullValueConstraints()
{
    return true;
}
...
bool c_KgKmlSchemaCapabilities::SupportsUniqueValueConstraints()
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsCompositeUniqueValueConstraints()
{
    return false;
}
...
bool c_KgKmlSchemaCapabilities::SupportsCompositeId()
{
    return false;
}
...
///
FdoInt64 c_KgKmlSchemaCapabilities::GetMaximumDataValueLength(FdoDataType DataType)
{
   switch (DataType)
    {
...
/// Returns the maximum supported precision for a decimal data property.
///
FdoInt32 c_KgKmlSchemaCapabilities::GetMaximumDecimalPrecision()
{
  return -1;
}
...
/// Returns the maximum supported scale for a decimal data property.
///
FdoInt32 c_KgKmlSchemaCapabilities::GetMaximumDecimalScale()
{
  return -1;
}
...
///
FDOKGKML_API FdoInt32 c_KgKmlSchemaCapabilities::GetNameSizeLimit(FdoSchemaElementNameType NameType)
{
   switch (NameType)
    {
...
///
FDOKGKML_API FdoString* c_KgKmlSchemaCapabilities::GetReservedCharactersForName()
{
  return L"";
}
...
/// Returns a string with the reserved characters for the identified schema element.
///
FdoDataType* c_KgKmlSchemaCapabilities::GetSupportedIdentityPropertyTypes(FdoInt32& Length)
{
  Length = 0;
...
/// definition, FALSE otherwise.
///
bool c_KgKmlSchemaCapabilities::SupportsDefaultValue()
{
  return false;
}
