...
ShpSelectAggregatesCommand::ShpSelectAggregatesCommand (FdoIConnection *connection) :
...
ShpSelectAggregatesCommand::~ShpSelectAggregatesCommand (void)
{
}
...
FdoIdentifierCollection* ShpSelectAggregatesCommand::GetPropertyNames ()
{
...
FdoIDataReader* ShpSelectAggregatesCommand::Execute ()
{
...
void ShpSelectAggregatesCommand::SetDistinct( bool value )
{
    m_bDistinct = value;
}
...
bool ShpSelectAggregatesCommand::GetDistinct( )
{
    return m_bDistinct;
}
...
FdoIdentifierCollection* ShpSelectAggregatesCommand::GetGrouping()
{
...
/// <returns>Returns nothing</returns> 
void ShpSelectAggregatesCommand::SetGroupingFilter(FdoFilter* filter)
{
...
FdoFilter* ShpSelectAggregatesCommand::GetGroupingFilter(void)
{
...
/// <returns>Returns the list of group by property names.</returns> 
FdoIdentifierCollection* ShpSelectAggregatesCommand::GetOrdering(void)
{
...
/// <returns>Returns nothing</returns> 
void ShpSelectAggregatesCommand::SetOrderingOption(FdoOrderingOption option)
{
...
FdoOrderingOption ShpSelectAggregatesCommand::GetOrderingOption(void)
{
