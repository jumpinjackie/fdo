...
c_KgMssTopologyCapabilities::c_KgMssTopologyCapabilities ()
{
}
...
void c_KgMssTopologyCapabilities::Dispose()
{
    delete this;
}
...
bool c_KgMssTopologyCapabilities::SupportsTopology ()
{
    return (false);
}
...
// property will fail.
bool c_KgMssTopologyCapabilities::SupportsTopologicalHierarchy ()
{
    return (false);
}
...
bool c_KgMssTopologyCapabilities::BreaksCurveCrossingsAutomatically ()
{
    return (false);
}
...
bool c_KgMssTopologyCapabilities::ActivatesTopologyByArea ()
{
    return (false);
}
...
bool c_KgMssTopologyCapabilities::ConstrainsFeatureMovements ()
{
    return (false);
}
