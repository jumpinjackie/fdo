...
enum class SchemaElementNameType;
...
public interface class ISchemaCapabilities : public System::IDisposable
{
public:
    /// \brief
    ...
    /// 
    property array<NAMESPACE_OSGEO_FDO_SCHEMA::ClassType>^ ClassTypes
    {
    ...
    /// 
    property array<NAMESPACE_OSGEO_FDO_SCHEMA::DataType>^ DataTypes
    {
    ...
    ///
    property System::Int64 MaximumDataValueLength[NAMESPACE_OSGEO_FDO_SCHEMA::DataType]
    {
    ...
    /// Returns the maximum supported precision for a decimal data property.
    ///
    property System::Int32 MaximumDecimalPrecision
    {
        System::Int32 get();
    }
    ...
    /// Returns the maximum supported scale for a decimal data property.
    ///
    property System::Int32 MaximumDecimalScale
    {
        System::Int32 get();
    }
    ...
    ///
    property System::Int32 NameSizeLimit[NAMESPACE_OSGEO_FDO_CONNECTIONS_CAPABILITIES::SchemaElementNameType]
    {
    ...
    ///
    property System::String^ ReservedCharactersForName
    {
        System::String^ get();
    }
    ...
    /// Returns the list of data types
    /// 
    property array<NAMESPACE_OSGEO_FDO_SCHEMA::DataType>^ SupportedAutoGeneratedTypes
    {
        array<NAMESPACE_OSGEO_FDO_SCHEMA::DataType>^ get();
    }
    ...
    /// Returns a string with the reserved characters for the identified schema element.
    ///
    property array<NAMESPACE_OSGEO_FDO_SCHEMA::DataType>^ SupportedIdentityPropertyTypes
    {
        array<NAMESPACE_OSGEO_FDO_SCHEMA::DataType>^ get();
    }
    ...
    /// 
    property System::Boolean SupportsAssociationProperties
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsAutoIdGeneration
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsCompositeId
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsCompositeUniqueValueConstraints
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsDataStoreScopeUniqueIdGeneration
    {
        System::Boolean get();
    }
    ...
    /// definition, FALSE otherwise.
    ///
    property System::Boolean SupportsDefaultValue
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsExclusiveValueRangeConstraints
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsInclusiveValueRangeConstraints
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsInheritance
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsMultipleSchemas
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsNetworkModel
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsNullValueConstraints
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsObjectProperties
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsSchemaModification
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsSchemaOverrides
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsUniqueValueConstraints
    {
        System::Boolean get();
    }
    ...
    /// 
    property System::Boolean SupportsValueConstraintsList
    {
        System::Boolean get();
    }
};
