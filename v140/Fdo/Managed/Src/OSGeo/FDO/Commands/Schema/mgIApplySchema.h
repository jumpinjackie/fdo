...
/// storage.
public interface class IApplySchema : public NAMESPACE_OSGEO_FDO_COMMANDS::ICommand
{
public:
    /// \brief
    ...
    /// Returns nothing
    /// 
    property NAMESPACE_OSGEO_FDO_COMMANDS_SCHEMA::PhysicalSchemaMapping^ PhysicalMapping
    {
    ...
    /// Returns nothing
    /// 
    property System::Boolean IgnoreStates
    {
        System::Boolean get();
