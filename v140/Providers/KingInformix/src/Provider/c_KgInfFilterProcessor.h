...
#ifndef _c_KgInfFilterProcessor_h
#define _c_KgInfFilterProcessor_h
...
class c_KgInfFilterProcessor : public virtual FdoIFilterProcessor 
{
public:
  c_KgInfFilterProcessor(c_KgInfSchemaDesc *KgOraSchemaDesc,FdoIdentifier* ClassId,const c_KgInfSridDesc& OraSrid,int ParamSqlOffset=0);
public:
  ~c_KgInfFilterProcessor(void);
  virtual void Dispose() { delete this; }  

protected:
  FdoPtr<c_KgInfSchemaDesc> m_KgOraSchemaDesc;
  FdoPtr<FdoIdentifier> m_ClassId;  
  c_KgInfSridDesc m_OraSridDesc;
public:
    /// \brief
...
public:
  ...
  c_KgInfExpressionProcessor& GetExpressionProcessor() { return m_ExpressionProcessor; };   
    
protected:
    c_KgInfExpressionProcessor m_ExpressionProcessor;
    //c_KgInfExpressionProcessor m_ExpressionProcessorGeomFilter;
