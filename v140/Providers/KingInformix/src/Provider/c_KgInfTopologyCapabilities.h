...
class c_KgInfTopologyCapabilities : public FdoITopologyCapabilities
{
public:
    c_KgInfTopologyCapabilities ();

protected:
    virtual ~c_KgInfTopologyCapabilities ();
...
public:
    ...
    FDOKGINF_API virtual bool SupportsTopology();
    ...
    /// property will fail.
    FDOKGINF_API virtual bool SupportsTopologicalHierarchy();
    ...
    FDOKGINF_API virtual bool BreaksCurveCrossingsAutomatically();
    ...
    FDOKGINF_API virtual bool ActivatesTopologyByArea();
    ...
    FDOKGINF_API virtual bool ConstrainsFeatureMovements();
};
