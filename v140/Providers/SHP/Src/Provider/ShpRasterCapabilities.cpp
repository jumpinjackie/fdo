...
ShpRasterCapabilities::ShpRasterCapabilities ()
{
}
...
void ShpRasterCapabilities::Dispose()
{
    delete this;
}
...
bool ShpRasterCapabilities::SupportsRaster ()
{
    return (false);
}
...
bool ShpRasterCapabilities::SupportsStitching ()
{
    return (false);
}
...
bool ShpRasterCapabilities::SupportsSubsampling ()
{
    return (false);
}
...
bool ShpRasterCapabilities::SupportsDataModel (FdoRasterDataModel* model)
{
    return (false);
}
