...
FdoWfsTopologyCapabilities::FdoWfsTopologyCapabilities ()
{
}
...
void FdoWfsTopologyCapabilities::Dispose()
{
    delete this;
}
...
bool FdoWfsTopologyCapabilities::SupportsTopology ()
{
    return (false);
}
...
// property will fail.
bool FdoWfsTopologyCapabilities::SupportsTopologicalHierarchy ()
{
    return (false);
}
...
bool FdoWfsTopologyCapabilities::BreaksCurveCrossingsAutomatically ()
{
    return (false);
}
...
bool FdoWfsTopologyCapabilities::ActivatesTopologyByArea ()
{
    return (false);
}
...
bool FdoWfsTopologyCapabilities::ConstrainsFeatureMovements ()
{
    return (false);
}
