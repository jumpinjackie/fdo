...
#define RDBMS_SQLSERVER_PROVIDER_NAME L"OSGeo.SQLServerSpatial.4.0"
...
#define RDBMS_SQLSERVER_PROVIDER_VERSION L"4.0.0.0"
#define RDBMS_SQLSERVER_FDO_VERSION L"4.0.0.0"
