...
class c_KgInfDescribeSchemaCommand :    public FdoIDescribeSchema
{
    friend class c_KgInfConnection;
    friend class c_KgInfFeatureReader; // friends rather than make a SchemaUtilities class just for that
   

protected:
  FdoPtr<c_KgInfConnection> m_KgOraConnection;
  FdoStringP m_SchemaName;

private:
   
    // Constructs an instance of a DescribeSchema command using the given connection.
    c_KgInfDescribeSchemaCommand (c_KgInfConnection* Connection);
	FdoStringCollection* m_classNames;

protected:
    // Default destructor for DescribeSchema command.
    virtual ~c_KgInfDescribeSchemaCommand (void);
...
//---------------------------------------------------------------------------
    ...
    /// 
    FDOKGINF_API virtual FdoString* GetSchemaName();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void SetSchemaName(FdoString* SchemaName);
    ...
    FDOKGINF_API virtual FdoStringCollection* GetClassNames();
    ...
    // during command execution is provider dependent.  Providers that 
    // will not use the hint will describe the schema for all classes.
    FDOKGINF_API virtual void SetClassNames(FdoStringCollection* value);
    ...
    /// 
    FDOKGINF_API virtual FdoFeatureSchemaCollection* Execute();    
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------    
  /// \brief
    ...
    /// 
    FDOKGINF_API virtual FdoIConnection* GetConnection();
    ...
    /// 
    FDOKGINF_API virtual FdoITransaction* GetTransaction();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void SetTransaction(FdoITransaction* Transaction);
    ...
    /// 
    FDOKGINF_API virtual FdoInt32 GetCommandTimeout();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void SetCommandTimeout(FdoInt32 value);
    ...
    /// 
    FDOKGINF_API virtual FdoParameterValueCollection* GetParameterValues();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void Prepare();
    ...
    /// Returns nothing
    /// 
    FDOKGINF_API virtual void Cancel();
};
