...
#ifndef _c_KgInfConnectionInfo_h
#define _c_KgInfConnectionInfo_h
...
class c_KgInfConnectionInfo : public FdoIConnectionInfo
{
    

public:
    c_KgInfConnectionInfo (c_KgInfConnection * m_Connection); 
    c_KgInfConnectionInfo (); 
...
public:
    ...
    FDOKGINF_API FdoString* GetFeatureDataObjectsVersion ();
    ...
    FDOKGINF_API FdoIConnectionPropertyDictionary* GetConnectionProperties ();
    ...
    /// 
    FDOKGINF_API virtual FdoProviderDatastoreType GetProviderDatastoreType();
    ...
    /// 
    FDOKGINF_API virtual FdoStringCollection* GetDependentFileNames();
    #endif
