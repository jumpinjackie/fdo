...
c_KgInfUpdate::c_KgInfUpdate(c_KgInfConnection *Conn)
  : c_KgInfFdoFeatureCommand(Conn)
{
}

c_KgInfUpdate::~c_KgInfUpdate(void)
{
}
...
/// 
FdoPropertyValueCollection* c_KgInfUpdate::GetPropertyValues()
{
...
/// 
FdoInt32 c_KgInfUpdate::Execute()
{
  ...
  if( m_PropertyValues.p )
  {
    ...
    c_KgInfExpressionProcessor expproc(&strbuff,schemadesc,classid,orasrid);
    ...
    c_KgInfFilterProcessor fproc(schemadesc,classid,orasrid,expproc.GetSqlParametersCount());
  ...
  return 0;
}//end of c_KgInfUpdate::Execute

FdoILockConflictReader* c_KgInfUpdate::GetLockConflicts()
{
  return NULL;
}