...
c_KgInfCommandCapabilities::c_KgInfCommandCapabilities ()
{
}
...
void c_KgInfCommandCapabilities::Dispose()
{
    delete this;
}
...
/// 
FdoInt32* c_KgInfCommandCapabilities::GetCommands (FdoInt32& Size)
{
...
}//end of c_KgInfCommandCapabilities::GetCommands 
...
///
bool c_KgInfCommandCapabilities::SupportsParameters ()
{
    return (true);
}
...
/// 
bool c_KgInfCommandCapabilities::SupportsTimeout ()
{
    return (false);
}
...
///
bool c_KgInfCommandCapabilities::SupportsSelectExpressions()
{
    return (true);
}
...
/// 
bool c_KgInfCommandCapabilities::SupportsSelectFunctions()
{
    return (true);
}
...
/// 
bool c_KgInfCommandCapabilities::SupportsSelectDistinct()
{
    return (true);
}
...
/// 
bool c_KgInfCommandCapabilities::SupportsSelectOrdering()
{
    return (true);
}
...
/// (but not vice versa).
bool c_KgInfCommandCapabilities::SupportsSelectGrouping()
{
    return (true);
}
