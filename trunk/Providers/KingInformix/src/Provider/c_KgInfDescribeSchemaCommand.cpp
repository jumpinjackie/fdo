...
c_KgInfDescribeSchemaCommand::c_KgInfDescribeSchemaCommand (c_KgInfConnection* Connection) 
...
c_KgInfDescribeSchemaCommand::~c_KgInfDescribeSchemaCommand (void)
{
}
...
const wchar_t* c_KgInfDescribeSchemaCommand::GetSchemaName ()
{
    return (m_SchemaName);
}
...
void c_KgInfDescribeSchemaCommand::SetSchemaName (const wchar_t* SchemaName)
{
...
FdoStringCollection* c_KgInfDescribeSchemaCommand::GetClassNames()
{
    return m_classNames;
}
...
// during command execution is provider dependent.  Providers that 
// will not use the hint will describe the schema for all classes.
void c_KgInfDescribeSchemaCommand::SetClassNames(FdoStringCollection* value)
{
    // Do nothing.
...
FdoFeatureSchemaCollection* c_KgInfDescribeSchemaCommand::Execute ()
{
    ...
    FdoPtr<c_KgInfSchemaDesc> schemadesc = m_KgOraConnection->GetSchemaDesc();
...
FdoIConnection* c_KgInfDescribeSchemaCommand::GetConnection() 
{ 
  return FDO_SAFE_ADDREF(m_KgOraConnection.p); 
} 

FdoITransaction* c_KgInfDescribeSchemaCommand::GetTransaction()
{
  return NULL;
}

void c_KgInfDescribeSchemaCommand::SetTransaction(FdoITransaction* Transaction)
{
}
...
///
FdoInt32 c_KgInfDescribeSchemaCommand::GetCommandTimeout()
{ 
  #ifdef _FDO_3_1
...
/// Returns nothing
/// 
void c_KgInfDescribeSchemaCommand::SetCommandTimeout(FdoInt32 Timeout)
{
  #ifdef _FDO_3_1
    throw GisException::Create (GisException::NLSGetMessage (FDO_NLSID (FDO_100_COMMAND_TIMEOUT_NOT_SUPPORTED)));
  #else
...
/// 
FdoParameterValueCollection* c_KgInfDescribeSchemaCommand::GetParameterValues()
{
  #ifdef _FDO_3_1
...
/// Returns nothing
/// 
void c_KgInfDescribeSchemaCommand::Prepare()
{
}
...
/// Returns nothing
/// 
void c_KgInfDescribeSchemaCommand::Cancel()
{
}