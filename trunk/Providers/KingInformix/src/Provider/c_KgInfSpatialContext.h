...
#ifndef _c_KgInfSpatialContext_h
#define _c_KgInfSpatialContext_h


class c_KgInfSpatialContext : public FdoDisposable
{
private:
    FdoStringP m_Name;
...
public:
    c_KgInfSpatialContext (void);
    virtual ~c_KgInfSpatialContext ();
    ...
    virtual FdoBoolean CanSetName() { return true; }
	  ...
	  virtual const c_KgInfSridDesc& GetOraSridDesc();
	  virtual void SetOraSridDesc(const c_KgInfSridDesc& SRID);
};



class c_KgInfSpatialContextCollection : public FdoNamedCollection<c_KgInfSpatialContext, FdoException>
{
public:
    c_KgInfSpatialContextCollection(void) {}

    virtual ~c_KgInfSpatialContextCollection() {}
