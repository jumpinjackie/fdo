...
#ifndef _c_KgInfExpressionProcessor_h
#define _c_KgInfExpressionProcessor_h
...
/// syntax.
class c_KgInfExpressionProcessor : public virtual FdoIExpressionProcessor
{
public:
  c_KgInfExpressionProcessor(c_FilterStringBuffer* StringBuff,c_KgInfSchemaDesc *KgOraSchemaDesc,FdoIdentifier* ClassDef
                          ,const c_KgInfSridDesc& OraSrid,int ParamSqlOffset=0);
public:
  ~c_KgInfExpressionProcessor(void);
  virtual void Dispose() { delete this; }
  
protected:
  FdoPtr<c_KgInfSchemaDesc> m_KgOraSchemaDesc;
  ...
  c_KgInfSridDesc m_OraSridDesc; // when converting geomerty need to have this one
  
  bool m_DoAsParameters;
  
  //int m_ParamCount; 
  
  std::vector<c_KgInfSqlParamDesc*> m_ParamList; // how many parameters was created inside string ( geometry + parameters expressions)
...
public:
  //const std::vector<c_KgInfSqlParamDesc*> GetParamList() const { return m_ParamList; }
