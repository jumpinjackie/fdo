...
#ifndef _c_KgInfSpatialContextReader_h
#define _c_KgInfSpatialContextReader_h

#include "c_KgInfSpatialContext.h"

class c_KgInfSpatialContextReader :
...
public:
    c_KgInfSpatialContextReader (c_KgInfSpatialContextCollection*  spatialContextColl );
    virtual ~c_KgInfSpatialContextReader (void);

    virtual void Dispose ();
    
protected:
	FdoPtr<c_KgInfSpatialContextCollection>	m_SpatialContextColl;
  FdoPtr<c_KgInfSpatialContext>				m_Context; // the current read context
	int								m_CurrIndex;  
