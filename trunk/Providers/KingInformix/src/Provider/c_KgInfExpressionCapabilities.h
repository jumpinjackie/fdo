...
class c_KgInfExpressionCapabilities : public FdoIExpressionCapabilities
{
public:
    c_KgInfExpressionCapabilities ();

protected:
    virtual ~c_KgInfExpressionCapabilities ();
...
public:
    ...
    /// 
    FDOKGINF_API virtual FdoExpressionType* GetExpressionTypes(FdoInt32& length);
    ...
    /// 
    FDOKGINF_API virtual FdoFunctionDefinitionCollection* GetFunctions();
};
