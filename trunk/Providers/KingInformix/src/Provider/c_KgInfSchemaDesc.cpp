...
#include "c_KgInfSchemaDesc.h"
 ...
 void c_KgInfSchemaDesc::SetDesc( FdoFeatureSchemaCollection* FSchema,c_KgInfOverPhysicalSchemaMapping* PhSchemaMapping
  ...
  }//end of c_KgInfSchemaDesc::SetDesc

FdoClassDefinition* c_KgInfSchemaDesc::FindClassDefinition(FdoIdentifier* ClassId)
{
  ...
  return NULL;
}//end of c_KgInfSchemaDesc::FindClassDefinition

c_KgInfOverClassDefinition* c_KgInfSchemaDesc::FindClassMapping(FdoIdentifier* ClassId)
{
