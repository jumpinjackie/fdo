...
c_KgInfRasterCapabilities::c_KgInfRasterCapabilities ()
{
}
...
void c_KgInfRasterCapabilities::Dispose()
{
    delete this;
}
...
bool c_KgInfRasterCapabilities::SupportsRaster ()
{
    return (false);
}
...
bool c_KgInfRasterCapabilities::SupportsStitching ()
{
    return (false);
}
...
bool c_KgInfRasterCapabilities::SupportsSubsampling ()
{
    return (false);
}
...
bool c_KgInfRasterCapabilities::SupportsDataModel (FdoRasterDataModel* Model)
{
    return (false);
}
