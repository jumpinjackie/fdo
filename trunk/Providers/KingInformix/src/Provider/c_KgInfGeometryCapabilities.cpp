...
c_KgInfGeometryCapabilities::c_KgInfGeometryCapabilities ()
{
}
...
void c_KgInfGeometryCapabilities::Dispose()
{
    delete this;
}
...
FdoGeometryType* c_KgInfGeometryCapabilities::GetGeometryTypes (FdoInt32& Length)
{
...
}//end of c_KgInfGeometryCapabilities::GetGeometryTypes 
...
FdoGeometryComponentType* c_KgInfGeometryCapabilities::GetGeometryComponentTypes (FdoInt32& Length)
{
...
FdoInt32 c_KgInfGeometryCapabilities::GetDimensionalities ()
{
