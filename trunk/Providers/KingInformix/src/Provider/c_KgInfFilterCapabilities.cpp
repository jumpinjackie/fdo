...
c_KgInfFilterCapabilities::c_KgInfFilterCapabilities ()
{
}
...
void c_KgInfFilterCapabilities::Dispose ()
{
    delete this;
}
...
FdoConditionType* c_KgInfFilterCapabilities::GetConditionTypes (FdoInt32& Length)
{
    ...
    return (types);
}//end of c_KgInfFilterCapabilities::GetConditionTypes
...
FdoSpatialOperations* c_KgInfFilterCapabilities::GetSpatialOperations (FdoInt32& Length)
{
    ...
    return (operations);
}//end of c_KgInfFilterCapabilities::GetSpatialOperations
...
FdoDistanceOperations* c_KgInfFilterCapabilities::GetDistanceOperations (FdoInt32& Length)
{
    Length = 0;
...
bool c_KgInfFilterCapabilities::SupportsGeodesicDistance ()
{
    return false;
}
...
bool c_KgInfFilterCapabilities::SupportsNonLiteralGeometricOperations ()
{
    return false;
}
