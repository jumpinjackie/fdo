...
#ifndef POSTGIS_FDODATASTORETEST_H
#define POSTGIS_FDODATASTORETEST_H

#include "FdoDatastoreTest.h"

class PostGisFdoDatastoreTest : public FdoDatastoreTest
{
    CPPUNIT_TEST_SUB_SUITE (PostGisFdoDatastoreTest, FdoDatastoreTest);
