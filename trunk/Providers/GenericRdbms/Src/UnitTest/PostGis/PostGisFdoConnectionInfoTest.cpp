...
CPPUNIT_TEST_SUITE_REGISTRATION(PostGisFdoConnectionInfoTest);
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(PostGisFdoConnectionInfoTest, "FdoConnectionInfoTest");


void PostGisFdoConnectionInfoTest::set_provider()
{
    UnitTestUtil::SetProvider("PostGIS");

} // set_provider()

void PostGisFdoConnectionInfoTest::SetExpectedFileList()
{
    // NOT USED
...
void PostGisFdoConnectionInfoTest::TestProviderInfo()
{
    try
    {
        ...
        FdoStringP connString(UnitTestUtil::GetConnectionString(Connection_WithDatastore));
        mConnection->SetConnectionString(connString);
        mConnection->Open();
