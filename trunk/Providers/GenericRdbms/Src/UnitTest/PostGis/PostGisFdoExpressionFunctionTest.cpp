...
#include "Pch.h"
#include "PostGisFdoExpressionFunctionTest.h"
#include "UnitTestUtil.h"

CPPUNIT_TEST_SUITE_REGISTRATION(PostGisFdoExpressionFunctionTest);
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(PostGisFdoExpressionFunctionTest, "FdoExpressionFunctionTest");
...
void PostGisFdoExpressionFunctionTest::SetProvider ()
...
FdoInt32 PostGisFdoExpressionFunctionTest::GetDimensionality ()
...
FdoDouble PostGisFdoExpressionFunctionTest::GetExpectedValue (
...
void PostGisFdoExpressionFunctionTest::TestSpatialExtents ()
...
void PostGisFdoExpressionFunctionTest::TestToStringFunction ()
...
void PostGisFdoExpressionFunctionTest::TestMonthsBetweenFunction ()
...
void PostGisFdoExpressionFunctionTest::TestConcatFunction ()
...

{
    ...
    try {
      ...
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"false74false");
      printf(" >>> Test succeeded \n");
    ...
    try {
      ...
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"false3618.8890814558059");
      printf(" >>> Test succeeded \n");
...
FdoStringP PostGisFdoExpressionFunctionTest::GetExpectedErrorMessage (
                                                    FdoInt16 test_case_id)
...

{
    ...
    switch (test_case_id) {
      ...
      case EXTRACTTOINT_TEST_CASE_CODE_1:
        exp_err_message = L"RDBMS: [PGRES_FATAL_ERROR] ERROR:  function date_part(unknown, character varying) does not exist";
        break;

      default:
          exp_err_message = FdoExpressionFunctionTest::GetExpectedErrorMessage(test_case_id);
          break;
...
bool PostGisFdoExpressionFunctionTest::IsExpectedErrorMessage (
...

{
    ...
    switch (test_case_id) {
      ...
      case EXTRACTTODOUBLE_TEST_CASE_CODE_1:
      case EXTRACTTOINT_TEST_CASE_CODE_1:
        return (current_error_message.Contains(expected_error_message));
        break;

      default:
          return FdoExpressionFunctionTest::IsExpectedErrorMessage(expected_error_message, current_error_message, test_case_id);
        break;
...
void PostGisFdoExpressionFunctionTest::
                        CheckReaderStddev (
...
void PostGisFdoExpressionFunctionTest::CheckReaderGeometryAndCount (
                                        FdoIDataReader *data_reader,
