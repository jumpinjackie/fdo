...
#ifndef POSTGIS_INIT_H
#define POSTGIS_INIT_H
 ...
 * This function forwards execution to postgis_rdbi_init call.
 *
 ...
 */
POSTGISDR_CALL int init(void **contextp, rdbi_methods methods);

#endif /* POSTGIS_INIT_H */
