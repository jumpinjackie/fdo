#ifndef FDOSMPHSQSSCHEMA_H
#define FDOSMPHSQSSCHEMA_H		1
/*
...
class FdoSmPhRdSqsDbSchemaReader;
// This represents a Sql Server schema
class FdoSmPhSqsSchema : public FdoSmPhDbElement
{
public:
    ...
    FdoSmPhSqsSchema(
        ...
        FdoSmPhRdSqsDbSchemaReader* reader = NULL
    );
...
typedef FdoPtr<FdoSmPhSqsSchema> FdoSmPhSqsSchemaP;
