#ifndef _FDORDBMSSQLSERVERCONNECTIONINFO_H_
#define _FDORDBMSSQLSERVERCONNECTIONINFO_H_
#ifdef _WIN32
#pragma once
#endif
/*
...
class FdoRdbmsSqlServerConnectionInfo :  public FdoIConnectionInfo
{
public:
    FdoRdbmsSqlServerConnectionInfo(FdoRdbmsConnection *connection);
...
protected:
    ~FdoRdbmsSqlServerConnectionInfo(void);
