#ifndef FDOSMPHMYSQLVIEW_H
#define FDOSMPHMYSQLVIEW_H        1
/*
...
// MySql Provider implementation of a View.
class FdoSmPhMySqlView : public FdoSmPhGrdView, public FdoSmPhMySqlDbObject
{
public:
...
typedef FdoPtr<FdoSmPhMySqlView> FdoSmPhMySqlViewP;
