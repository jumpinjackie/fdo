#ifndef FDOSMPHMYSQLCOLUMNUNKNOWN_H
#define FDOSMPHMYSQLCOLUMNUNKNOWN_H       1
/*
...
// This class represents a type of column not known to the MySql
...
// handled by the MySql provider.
class FdoSmPhMySqlColumnUnknown :
    public FdoSmPhColumnUnknown, public FdoSmPhMySqlColumn
{
public:
    ...
    ~FdoSmPhMySqlColumnUnknown(void) {}
...
typedef FdoPtr<FdoSmPhMySqlColumnUnknown> FdoSmPhMySqlColumnUnknownP;
