#ifndef FDOSMPHODBCFKEY_H
#define FDOSMPHODBCFKEY_H        1
/*
...
// Odbc Provider implementation of a Foreign Key.
class FdoSmPhOdbcFkey : public FdoSmPhGrdFkey
{
public:
    ...
    ~FdoSmPhOdbcFkey(void);

};

typedef FdoPtr<FdoSmPhOdbcFkey> FdoSmPhOdbcFkeyP;
