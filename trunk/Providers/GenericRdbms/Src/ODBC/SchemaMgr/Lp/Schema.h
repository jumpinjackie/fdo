#ifndef FDOSMLPODBCSCHEMA_H
#define FDOSMLPODBCSCHEMA_H      1
/*
...
// Odbc Provider's LogicalPhysical schema definition
class FdoSmLpOdbcSchema : public FdoSmLpGrdSchema
{
public:
...
protected:
    virtual ~FdoSmLpOdbcSchema(void);
...
typedef FdoPtr<FdoSmLpOdbcSchema> FdoSmLpOdbcSchemaP;
