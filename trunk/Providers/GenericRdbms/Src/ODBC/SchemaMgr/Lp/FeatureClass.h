#ifndef FDOSMLPODBCFEATURECLASS_H
#define FDOSMLPODBCFEATURECLASS_H        1
/*
...
// Odbc Provider's LogicalPhysical FeatureClass definition

class FdoSmLpOdbcFeatureClass : public FdoSmLpFeatureClass, public FdoSmLpOdbcClassDefinition
{
public:
    // Construct from a class reader
    FdoSmLpOdbcFeatureClass(FdoSmPhClassReaderP classReader, FdoSmLpSchemaElement* parent);

	// Construct from an FDO feature class
    FdoSmLpOdbcFeatureClass(
...
protected:
    virtual ~FdoSmLpOdbcFeatureClass();
