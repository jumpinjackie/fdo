...
#ifndef FDORDBMSODBCCOMMANDCAPABILITIES_H
#define FDORDBMSODBCCOMMANDCAPABILITIES_H        1
...
class FdoRdbmsOdbcCommandCapabilities :    public FdoICommandCapabilities
{
public:
    // Constructor
    FdoRdbmsOdbcCommandCapabilities(void);
...
#endif // FDORDBMSODBCCOMMANDCAPABILITIES_H
