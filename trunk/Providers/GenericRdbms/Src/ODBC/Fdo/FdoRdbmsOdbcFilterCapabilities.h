...
#ifndef FDORDBMSODBCDFILTERCAPABILITIES_H_
#define FDORDBMSODBCDFILTERCAPABILITIES_H_     1
...
class FdoRdbmsOdbcFilterCapabilities :    public FdoIFilterCapabilities
{
public:
    FdoRdbmsOdbcFilterCapabilities(void);
...
#endif // FDORDBMSODBCDFILTERCAPABILITIES_H_
