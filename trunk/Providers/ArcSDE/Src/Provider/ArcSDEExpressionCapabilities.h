...
#ifndef ARCSDEEXPRESSIONCAPABILITIES_H
#define ARCSDEEXPRESSIONCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class ArcSDEExpressionCapabilities : public FdoIExpressionCapabilities
{
public:
    ArcSDEExpressionCapabilities ();

protected:
    virtual ~ArcSDEExpressionCapabilities ();
