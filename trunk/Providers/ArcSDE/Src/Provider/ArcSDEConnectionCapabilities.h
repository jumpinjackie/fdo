...
#ifndef ARCSDECONNECTIONCAPABILITIES_H
#define ARCSDECONNECTIONCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class ArcSDEConnectionCapabilities : public FdoIConnectionCapabilities
{
public:
    ArcSDEConnectionCapabilities ();

protected:
    virtual ~ArcSDEConnectionCapabilities ();
...
#endif // ARCSDECONNECTIONCAPABILITIES_H
