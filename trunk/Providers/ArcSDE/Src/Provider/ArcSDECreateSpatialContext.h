...
#ifndef ARCSDECREATESPATIALCONTEXT_H
#define ARCSDECREATESPATIALCONTEXT_H

class ArcSDECreateSpatialContext :
    public ArcSDECommand<FdoICreateSpatialContext>
{
public:
    ArcSDECreateSpatialContext(ArcSDEConnection *connection);
    virtual ~ArcSDECreateSpatialContext(void);
...
#endif // ARCSDECREATESPATIALCONTEXT_H
