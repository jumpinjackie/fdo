...
#ifndef ARCSDEFILTERCAPABILITIES_H
#define ARCSDEFILTERCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class ArcSDEFilterCapabilities : public FdoIFilterCapabilities
{
public:
    ArcSDEFilterCapabilities ();

protected:
    virtual ~ArcSDEFilterCapabilities ();
...
#endif // ARCSDEFILTERCAPABILITIES_H
