...
#ifndef ARCSDEBLOBSTREAMREADER_H
#define ARCSDEBLOBSTREAMREADER_H
...
class ArcSDEBLOBStreamReader :
    public FdoBLOBStreamReader
{
public:
    // Constructors & destructors:
    ArcSDEBLOBStreamReader(SE_BLOB_INFO *blobInfo);
    virtual ~ArcSDEBLOBStreamReader(void);
...
protected:
    SE_BLOB_INFO *m_BlobInfo;
    FdoInt32      m_BlobIndex;
};

#endif  //#ifndef ARCSDEBLOBSTREAMREADER_H
