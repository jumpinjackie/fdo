...
c_KgOraTopologyCapabilities::c_KgOraTopologyCapabilities ()
{
}
...
void c_KgOraTopologyCapabilities::Dispose()
{
    delete this;
}
...
bool c_KgOraTopologyCapabilities::SupportsTopology ()
{
    return (false);
}
...
// property will fail.
bool c_KgOraTopologyCapabilities::SupportsTopologicalHierarchy ()
{
    return (false);
}
...
bool c_KgOraTopologyCapabilities::BreaksCurveCrossingsAutomatically ()
{
    return (false);
}
...
bool c_KgOraTopologyCapabilities::ActivatesTopologyByArea ()
{
    return (false);
}
...
bool c_KgOraTopologyCapabilities::ConstrainsFeatureMovements ()
{
    return (false);
}
