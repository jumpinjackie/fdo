...
#ifndef _c_KgOraSpatialContextReader_h
#define _c_KgOraSpatialContextReader_h

#include "c_KgOraSpatialContext.h"

class c_KgOraSpatialContextReader :
...
public:
    c_KgOraSpatialContextReader (c_KgOraSpatialContextCollection*  spatialContextColl );
    virtual ~c_KgOraSpatialContextReader (void);

    virtual void Dispose ();
    
protected:
	FdoPtr<c_KgOraSpatialContextCollection>	m_SpatialContextColl;
  FdoPtr<c_KgOraSpatialContext>				m_Context; // the current read context
	int								m_CurrIndex;  
