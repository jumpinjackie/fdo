...
#ifndef _c_KgOraRasterCapabilities_h
#define _c_KgOraRasterCapabilities_h


class c_KgOraRasterCapabilities : public FdoIRasterCapabilities
{
public:
    c_KgOraRasterCapabilities ();

protected:
    virtual ~c_KgOraRasterCapabilities ();
...
public:
   /// \brief
    ...
    /// 
    FDOKGORA_API virtual bool SupportsRaster ();
    ...
    /// 
    FDOKGORA_API virtual bool SupportsStitching ();
    ...
    /// 
    FDOKGORA_API virtual bool SupportsSubsampling ();
    ...
    /// 
    FDOKGORA_API virtual bool SupportsDataModel (FdoRasterDataModel* Model);
};
