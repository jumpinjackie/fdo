...
#ifndef SHPCOMMANDCAPABILITIES_H
#define SHPCOMMANDCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class ShpCommandCapabilities : public FdoICommandCapabilities
{
public:
    ShpCommandCapabilities ();

protected:
    virtual ~ShpCommandCapabilities ();
...
#endif // SHPCOMMANDCAPABILITIES_H
