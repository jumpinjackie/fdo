...
ShpTopologyCapabilities::ShpTopologyCapabilities ()
{
}
...
void ShpTopologyCapabilities::Dispose()
{
    delete this;
}
...
bool ShpTopologyCapabilities::SupportsTopology ()
{
    return (false);
}
...
// property will fail.
bool ShpTopologyCapabilities::SupportsTopologicalHierarchy ()
{
    return (false);
}
...
bool ShpTopologyCapabilities::BreaksCurveCrossingsAutomatically ()
{
    return (false);
}
...
bool ShpTopologyCapabilities::ActivatesTopologyByArea ()
{
    return (false);
}
...
bool ShpTopologyCapabilities::ConstrainsFeatureMovements ()
{
    return (false);
}
