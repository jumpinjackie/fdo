...
#ifndef SHPCONNECTIONINFO_H
#define SHPCONNECTIONINFO_H
#ifdef _WIN32
#pragma once
#endif // _WIN32


class ShpConnectionInfo :
...
private:
     ...
     */
    ShpConnection* mConnection; // weak reference
...
public:
    ...
    ShpConnectionInfo (ShpConnection* connection);

protected:
    virtual ~ShpConnectionInfo (void);
