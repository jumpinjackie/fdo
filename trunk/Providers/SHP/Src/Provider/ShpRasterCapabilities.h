...
#ifndef SHPRASTERCAPABILITIES_H
#define SHPRASTERCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class ShpRasterCapabilities : public FdoIRasterCapabilities
{
public:
    ShpRasterCapabilities ();

protected:
    virtual ~ShpRasterCapabilities ();
