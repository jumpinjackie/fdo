...
#ifndef SHPSELECTCOMMAND_H
#define SHPSELECTCOMMAND_H

#ifdef _WIN32
#pragma once
#endif // _WIN32

class ShpSelectCommand :
    public FdoCommonFeatureCommand<FdoISelect, ShpConnection>
{
...
protected:
    ShpSelectCommand (ShpConnection* connection);
    virtual ~ShpSelectCommand (void);

public:
    //
    // Prevent the use of the Assignment Operation by defining it and not implementing it.
    // DO NOT IMPLEMENT
    ShpSelectCommand & operator= (const ShpSelectCommand &right);
