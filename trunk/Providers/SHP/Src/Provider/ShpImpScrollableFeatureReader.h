...
#ifndef _ShpImpScrollableFeatureReader_H_
...
public:
    // constructs an ShpImpScrollableFeatureReader using the specified
    // reader. the ownership of the rdr paramter is transfered to this class.
	ShpImpScrollableFeatureReader( T *rdr ) { m_Reader = rdr; }

protected:
    // default destructor
	virtual ~ShpImpScrollableFeatureReader() { m_Reader->Release(); }
