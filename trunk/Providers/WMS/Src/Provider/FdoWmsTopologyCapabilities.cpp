...
FdoWmsTopologyCapabilities::FdoWmsTopologyCapabilities ()
{
}
...
void FdoWmsTopologyCapabilities::Dispose()
{
    delete this;
}
...
bool FdoWmsTopologyCapabilities::SupportsTopology ()
{
    return (false);
}
...
// property will fail.
bool FdoWmsTopologyCapabilities::SupportsTopologicalHierarchy ()
{
    return (false);
}
...
bool FdoWmsTopologyCapabilities::BreaksCurveCrossingsAutomatically ()
{
    return (false);
}
...
bool FdoWmsTopologyCapabilities::ActivatesTopologyByArea ()
{
    return (false);
}
...
bool FdoWmsTopologyCapabilities::ConstrainsFeatureMovements ()
{
    return (false);
}
