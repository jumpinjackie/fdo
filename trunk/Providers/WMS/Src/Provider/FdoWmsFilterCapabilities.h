...
#ifndef FDOWMSFILTERCAPABILITIES_H
#define FDOWMSFILTERCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class FdoWmsFilterCapabilities : public FdoIFilterCapabilities
{
public:
    // <summary>Default Constructor.</summary>
    // <returns>Returns nothing</returns> 
    FdoWmsFilterCapabilities ();

protected:
    // <summary>Virtual Destructor.</summary>
    // <returns>Returns nothing</returns> 
    virtual ~FdoWmsFilterCapabilities ();
...
#endif // FDOWMSFILTERCAPABILITIES_H
