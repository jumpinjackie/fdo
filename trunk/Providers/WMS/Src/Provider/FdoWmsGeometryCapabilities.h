...
#ifndef FDOWMSGEOMETRYCAPABILITIES_H
#define FDOWMSGEOMETRYCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class FdoWmsGeometryCapabilities : public FdoIGeometryCapabilities
{
public:
    // <summary>Default Constructor.</summary>
    // <returns>Returns nothing</returns> 
    FdoWmsGeometryCapabilities ();

protected:
    // <summary>Virtual Destructor.</summary>
    // <returns>Returns nothing</returns> 
    virtual ~FdoWmsGeometryCapabilities ();
...
#endif // FDOWMSGEOMETRYCAPABILITIES_H
