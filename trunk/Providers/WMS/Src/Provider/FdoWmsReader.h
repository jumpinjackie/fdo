...
#ifndef FDOWMSREADER_H
#define FDOWMSREADER_H

#ifdef _WIN32
#pragma once
#endif // _WIN32

template <class FDO_READER> class FdoWmsReader : public FDO_READER
{
public:
    ...
    // DO NOT IMPLEMENT
    FdoWmsReader & operator= (const FdoWmsReader &right);
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Boolean"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Byte"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"DateTime"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Double"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Int16"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Int32"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Int64"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Single"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"String"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"LOB"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Geometry"));
    }
    ...
    {
        throw FdoException::Create (NlsMsgGet(FDOWMS_UNSUPPORTED_DATATYPE, "The '%1$ls' data type is not supported by FdoWms.", L"Raster"));
    }
...
protected:
    ...
    virtual ~FdoWmsReader (void)
    {
    }
};

#endif // FDOWMSREADER_H
