...
{
	return static_cast<FdoWmsOvStyleDefinition*>(UnmanagedObject.ToPointer());
}

IntPtr NAMESPACE_OSGEO_FDO_PROVIDERS_WMS_OVERRIDE::OvStyleDefinition::GetDisposableObject()
{
