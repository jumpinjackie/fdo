...
#ifndef _c_KgMssSpatialContextReader_h
#define _c_KgMssSpatialContextReader_h

#include "c_KgMssSpatialContext.h"

class c_KgMssSpatialContextReader :
...
public:
    c_KgMssSpatialContextReader (c_KgMssSpatialContextCollection*  spatialContextColl );
    virtual ~c_KgMssSpatialContextReader (void);

    virtual void Dispose ();
    
protected:
	FdoPtr<c_KgMssSpatialContextCollection>	m_SpatialContextColl;
  FdoPtr<c_KgMssSpatialContext>				m_Context; // the current read context
	int								m_CurrIndex;  
