...
class c_KgMssFilterCapabilities : public FdoIFilterCapabilities
{
public:
    c_KgMssFilterCapabilities ();

protected:
    virtual ~c_KgMssFilterCapabilities ();
...
public:
   /// \brief
    ...
    /// 
    FDOKGMSS_API virtual FdoConditionType* GetConditionTypes(FdoInt32& length);
    ...
    /// 
    FDOKGMSS_API virtual FdoSpatialOperations* GetSpatialOperations(FdoInt32& length);
    ...
    /// 
    FDOKGMSS_API virtual FdoDistanceOperations* GetDistanceOperations(FdoInt32& length);
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsGeodesicDistance();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsNonLiteralGeometricOperations();
};
