...
class c_KgMssTopologyCapabilities : public FdoITopologyCapabilities
{
public:
    c_KgMssTopologyCapabilities ();

protected:
    virtual ~c_KgMssTopologyCapabilities ();
...
public:
    ...
    FDOKGMSS_API virtual bool SupportsTopology();
    ...
    /// property will fail.
    FDOKGMSS_API virtual bool SupportsTopologicalHierarchy();
    ...
    FDOKGMSS_API virtual bool BreaksCurveCrossingsAutomatically();
    ...
    FDOKGMSS_API virtual bool ActivatesTopologyByArea();
    ...
    FDOKGMSS_API virtual bool ConstrainsFeatureMovements();
};
