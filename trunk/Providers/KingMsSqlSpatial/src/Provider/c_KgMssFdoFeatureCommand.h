...
#ifndef _c_KgMssFdoFeatureCommand_h
#define _c_KgMssFdoFeatureCommand_h


#include "c_KgMssFdoCommand.h"

template <class FDO_COMMAND> class c_KgMssFdoFeatureCommand : public c_KgMssFdoCommand<FDO_COMMAND>
{
...
protected:
    ...
    c_KgMssFdoFeatureCommand (c_KgMssConnection* Connection) :
        c_KgMssFdoCommand<FDO_COMMAND>(Connection)  
    {
    }

    /// Default destructor for a command.
    virtual ~c_KgMssFdoFeatureCommand() 
    { 
    }
...
FdoFilter* c_KgMssFdoFeatureCommand<FDO_COMMAND>::GetFilter ()
{
...
/// Returns nothing
template <class FDO_COMMAND> 
void c_KgMssFdoFeatureCommand<FDO_COMMAND>::SetFilter (FdoFilter* Filter)
{
...
/// Returns nothing
template <class FDO_COMMAND> 
void c_KgMssFdoFeatureCommand<FDO_COMMAND>::SetFilter (FdoString* value)
{
...
/// Returns the class identifier.
template <class FDO_COMMAND> 
FdoIdentifier* c_KgMssFdoFeatureCommand<FDO_COMMAND>::GetFeatureClassName ()
{
...
/// Returns nothing.
template <class FDO_COMMAND> 
void c_KgMssFdoFeatureCommand<FDO_COMMAND>::SetFeatureClassName (FdoIdentifier* ClassName)
{
...
/// Returns nothing
template <class FDO_COMMAND> 
void c_KgMssFdoFeatureCommand<FDO_COMMAND>::SetFeatureClassName (FdoString* ClassName)
{
