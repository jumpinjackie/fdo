...
class c_KgMssSchemaCapabilities : public FdoISchemaCapabilities
{
public:
    c_KgMssSchemaCapabilities ();

protected:
    virtual ~c_KgMssSchemaCapabilities ();
...
public:
    ...
    /// 
    FDOKGMSS_API virtual FdoClassType* GetClassTypes(FdoInt32& length);
    ...
    /// 
    FDOKGMSS_API virtual FdoDataType* GetDataTypes(FdoInt32& length);
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsInheritance();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsMultipleSchemas();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsObjectProperties();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsAssociationProperties();
    ...
    /// 
   	FDOKGMSS_API virtual bool SupportsSchemaOverrides();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsNetworkModel();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsAutoIdGeneration();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsDataStoreScopeUniqueIdGeneration();
    ...
    /// Returns the list of data types
    /// 
    FDOKGMSS_API virtual FdoDataType* GetSupportedAutoGeneratedTypes(FdoInt32& length);
    ...
    /// 
    FDOKGMSS_API virtual bool  SupportsSchemaModification();
    ...
    /// 
	FDOKGMSS_API virtual bool SupportsInclusiveValueRangeConstraints();
    ...
    /// 
	FDOKGMSS_API virtual bool SupportsExclusiveValueRangeConstraints();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsValueConstraintsList();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsNullValueConstraints();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsUniqueValueConstraints();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsCompositeUniqueValueConstraints();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsCompositeId();
    ...
    ///
    FDOKGMSS_API virtual FdoInt64 GetMaximumDataValueLength(FdoDataType dataType);
    ...
    /// Returns the maximum supported precision for a decimal data property.
    ///
    FDOKGMSS_API virtual FdoInt32 GetMaximumDecimalPrecision();
    ...
    /// Returns the maximum supported scale for a decimal data property.
    ///
    FDOKGMSS_API virtual FdoInt32 GetMaximumDecimalScale();
    ...
    ///
    FDOKGMSS_API virtual FdoInt32 GetNameSizeLimit(FdoSchemaElementNameType name);
    ...
    ///
    FDOKGMSS_API virtual FdoString* GetReservedCharactersForName();
    ...
    /// Returns a string with the reserved characters for the identified schema element.
    ///
    FDOKGMSS_API virtual FdoDataType* GetSupportedIdentityPropertyTypes(FdoInt32& length);
    ...
    /// definition, FALSE otherwise.
    ///
    FDOKGMSS_API virtual bool SupportsDefaultValue();
