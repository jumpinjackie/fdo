...
class c_KgMssDescribeSchemaCommand :    public FdoIDescribeSchema
{
    friend class c_KgMssConnection;
    friend class c_KgMssFeatureReader; // friends rather than make a SchemaUtilities class just for that
   

protected:
  FdoPtr<c_KgMssConnection> m_KgOraConnection;
...
private:
    ...
    c_KgMssDescribeSchemaCommand (c_KgMssConnection* Connection);

protected:
    // Default destructor for DescribeSchema command.
    virtual ~c_KgMssDescribeSchemaCommand (void);
...
//---------------------------------------------------------------------------
    ...
    /// 
    FDOKGMSS_API virtual FdoString* GetSchemaName();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetSchemaName(FdoString* SchemaName);
    ...
    ///
    FDOKGMSS_API virtual FdoStringCollection* GetClassNames();
    ...
    /// \Returns nothing
    ///
    FDOKGMSS_API virtual void SetClassNames(FdoStringCollection* value);
    ...
    /// 
    FDOKGMSS_API virtual FdoFeatureSchemaCollection* Execute();    
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------    
  /// \brief
    ...
    /// 
    FDOKGMSS_API virtual FdoIConnection* GetConnection();
    ...
    /// 
    FDOKGMSS_API virtual FdoITransaction* GetTransaction();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetTransaction(FdoITransaction* Transaction);
    ...
    /// 
    FDOKGMSS_API virtual FdoInt32 GetCommandTimeout();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetCommandTimeout(FdoInt32 value);
    ...
    /// 
    FDOKGMSS_API virtual FdoParameterValueCollection* GetParameterValues();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void Prepare();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void Cancel();
};
