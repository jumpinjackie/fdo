...
#ifndef FDOKGMSSPROVIDER_H
#define FDOKGMSSPROVIDER_H
...
#ifdef FDOKGMSS_EXPORTS
#define FDOKGMSS_API __declspec(dllexport)
#else
#define FDOKGMSS_API __declspec(dllimport)
#endif
...
#define D_KGMSS_PROVIDER_NAME					L"King.MsSqlSpatial.0.1.1"
#define D_KGMSS_PROVIDER_VERSION				L"0.1.1.0"
#ifdef _FDO_3_1
  #define D_KGMSS_FDO_VERSION						L"3.1.0.0"
#else
  #define D_KGMSS_FDO_VERSION						L"3.2.0.0"
#endif

#define D_KGMSS_PROVIDER_DEFAULT_DISPLAY_NAME	L"King FDO Provider for MS SQL Server"
#define D_KGMSS_PROVIDER_DEFAULT_DESCRIPTION	L"Read/write access to spatial and attribute data in an MS Sql Server."
