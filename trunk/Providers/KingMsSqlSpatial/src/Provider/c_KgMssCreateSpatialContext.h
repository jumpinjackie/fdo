...
#ifndef _c_KgMssCreateSpatialContext_h
#define _c_KgMssCreateSpatialContext_h

class c_KgMssCreateSpatialContext : public c_KgMssFdoCommand<FdoICreateSpatialContext>
{
public:
  c_KgMssCreateSpatialContext(c_KgMssConnection *Conn);
public:
  ~c_KgMssCreateSpatialContext(void);
...
public:  
    ...
    /// 
    FDOKGMSS_API virtual FdoString* GetName();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetName(FdoString* value);
    ...
    /// 
    FDOKGMSS_API virtual FdoString* GetDescription();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetDescription(FdoString* value);
    ...
    /// 
    FDOKGMSS_API virtual FdoString* GetCoordinateSystem();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetCoordinateSystem(FdoString* value);
    ...
    /// 
    FDOKGMSS_API virtual FdoString* GetCoordinateSystemWkt();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetCoordinateSystemWkt(FdoString* value);
    ...
    /// 
    FDOKGMSS_API virtual FdoSpatialContextExtentType GetExtentType();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetExtentType(FdoSpatialContextExtentType value);
    ...
    /// 
    FDOKGMSS_API virtual FdoByteArray* GetExtent();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetExtent(FdoByteArray* value);
    ...
    /// 
    FDOKGMSS_API virtual const double GetXYTolerance();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetXYTolerance(const double value);
    ...
    /// Returns the tolerance
    /// 
    FDOKGMSS_API virtual const double GetZTolerance();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetZTolerance(const double value);
    ...
    /// 
    FDOKGMSS_API virtual const bool GetUpdateExisting();
    ...
    /// Returns nothing
    /// 
    FDOKGMSS_API virtual void SetUpdateExisting(const bool value);
