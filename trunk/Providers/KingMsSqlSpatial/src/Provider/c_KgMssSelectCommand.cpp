...
c_KgMssSelectCommand::c_KgMssSelectCommand (c_KgMssConnection* Conn) 
    : c_KgMssFdoFeatureCommand<FdoISelect> (Conn)
{
...
c_KgMssSelectCommand::~c_KgMssSelectCommand (void)
{
}

// <summary>Dispose this object.</summary>
// <returns>Returns nothing.</returns> 
void c_KgMssSelectCommand::Dispose ()
{
    delete this;
}
...
FdoIdentifierCollection* c_KgMssSelectCommand::GetPropertyNames ()
{
...
FdoLockType c_KgMssSelectCommand::GetLockType ()
{
...
/// <returns>Returns nothing</returns> 
void c_KgMssSelectCommand::SetLockType (FdoLockType value)
{
...
FdoLockStrategy c_KgMssSelectCommand::GetLockStrategy ()
{
...
/// <returns>Returns nothing</returns> 
void c_KgMssSelectCommand::SetLockStrategy (FdoLockStrategy value)
{
...
FdoIFeatureReader* c_KgMssSelectCommand::Execute ()
{
    ...
    D_KGORA_ELOG_WRITE1("c_KgMssSelectCommand::Execute class_name = '%s'",(const char*)FdoStringP(class_name));
    
    FdoPtr<FdoFeatureSchemaCollection> fschemas = schemadesc->GetFeatureSchema();
    FdoPtr<c_KgMssOverPhysicalSchemaMapping> phschemamapping = schemadesc->GetPhysicalSchemaMapping();
    ...
    */  
      ...
      stream = m_Connection->OTL_CreateStream(200,sqlstr.c_str());
    ...
    return new c_KgMssFeatureReader(m_Connection,stream,streamreader,classdef,geom_sqlcol_index,sqlcols, m_PropertyNames);
    
}//end of c_KgMssSelectCommand::Execute 

/// <summary>Executes the select command and returns a reference to an
/// IFeatureReader.</summary> 
/// <returns>Returns the feature reader.</returns> 
FdoIFeatureReader* c_KgMssSelectCommand::ExecuteWithLock ()
{
...
FdoILockConflictReader* c_KgMssSelectCommand::GetLockConflicts ()
{
...
string c_KgMssSelectCommand::CreateSqlString(c_KgMssFilterProcessor& FilterProc,int& GeomSqlColumnIndex,FdoStringCollection* SqlColumns)
{
    FdoPtr<FdoIdentifier> classid = GetFeatureClassName ();
    FdoString* class_name = classid->GetText ();
    ...
    // Now fro MsSqlSpatial spatial condition is transferd to select from table function like
    // ST.FilterQuery ...
    //
    ...
    return sqlstr;
}//end of c_KgMssSelectCommand::CreateSqlString



// just check for spatial filter
// other filters ignored
void c_KgMssSelectCommand::CreateFilterSqlString(FdoFilter* Filter,string& WhereBuff)
{
...
}//end of c_KgMssSelectCommand::CreateFilterSqlString
...
FdoIdentifierCollection* c_KgMssSelectCommand::GetOrdering()
{ 
...
/// <returns>Returns nothing</returns> 
void c_KgMssSelectCommand::SetOrderingOption( FdoOrderingOption  Option ) 
{
...
FdoOrderingOption c_KgMssSelectCommand::GetOrderingOption( )
{ 
