...
class c_KgMssCommandCapabilities : public FdoICommandCapabilities
{
public:
    c_KgMssCommandCapabilities ();

protected:
    virtual ~c_KgMssCommandCapabilities ();
...
public:
    ...
    /// 
    FDOKGMSS_API virtual FdoInt32* GetCommands(FdoInt32& Size);
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsParameters();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsSelectExpressions();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsSelectFunctions();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsSelectDistinct();
    ...
    /// 
    FDOKGMSS_API virtual bool SupportsSelectOrdering();
    ...
    /// (but not vice versa).
    FDOKGMSS_API virtual bool SupportsSelectGrouping();
};
