...
c_KgMssConnectionCapabilities::c_KgMssConnectionCapabilities ()
{
}
...
void c_KgMssConnectionCapabilities::Dispose()
{
    delete this;
}
...
FdoThreadCapability c_KgMssConnectionCapabilities::GetThreadCapability ()
{
...
FdoSpatialContextExtentType* c_KgMssConnectionCapabilities::GetSpatialContextTypes (FdoInt32& Length)
{
...
bool c_KgMssConnectionCapabilities::SupportsLocking ()
{
    return (false);
}
...
FdoLockType* c_KgMssConnectionCapabilities::GetLockTypes(FdoInt32& Size)
{ 
...
bool c_KgMssConnectionCapabilities::SupportsTimeout ()
{
    return false;
}
...
bool c_KgMssConnectionCapabilities::SupportsTransactions ()
{
    return false;
}
...
bool c_KgMssConnectionCapabilities::SupportsSQL()
{
    return true;
}
...
bool c_KgMssConnectionCapabilities::SupportsConfiguration()
{
    return true;
}
...
bool c_KgMssConnectionCapabilities::SupportsMultipleSpatialContexts()
{
    return true;
}
...
bool c_KgMssConnectionCapabilities::SupportsCSysWKTFromCSysName()
{
    return false;
}
...
/// the provider or datastore level.
bool c_KgMssConnectionCapabilities::SupportsWrite()
{
  return true;
}
...
/// one time.
bool c_KgMssConnectionCapabilities::SupportsMultiUserWrite()
{
  return true;
}
...
///
bool c_KgMssConnectionCapabilities::SupportsFlush()
{
  return false;
}
#endif