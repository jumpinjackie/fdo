 ...
 *
 *  $HeadURL: http://svn.hobu.net/frank/GdalFile/src/Provider/FdoRfpSelectCommand.h $
 *   $Author: fwarmerdam $
...
#ifndef FDORFPSELECTCOMMAND_H
#define FDORFPSELECTCOMMAND_H
...
class FdoRfpSelectCommand : public FdoRfpFeatureCommand<FdoISelect>
{
...
protected:
    FdoRfpSelectCommand (FdoIConnection *connection);
    virtual ~FdoRfpSelectCommand (void);
