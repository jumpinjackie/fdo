 ...
 *
 *  $HeadURL: http://svn.hobu.net/frank/GdalFile/src/Provider/FdoRfpRasterPropertyDictionary.h $
 *   $Author: fwarmerdam $
 *     $Date: 2006-01-25 14:22:51 -0500 (Wed, 25 Jan 2006) $
 * $Revision: 23 $
 *
 */
#ifndef FDORFPRASTERPROPERTYDICTIONARY_H
#define FDORFPRASTERPROPERTYDICTIONARY_H
...
//
class FdoRfpRasterPropertyDictionay : public FdoIRasterPropertyDictionary
{
...
//
private:
	FdoPtr<FdoRfpBandRaster>	m_raster;

//
// Constructor(s), desctrucotr, factory function(s)
//
protected:
	FdoRfpRasterPropertyDictionay(FdoRfpBandRaster* raster);
	virtual ~FdoRfpRasterPropertyDictionay();
