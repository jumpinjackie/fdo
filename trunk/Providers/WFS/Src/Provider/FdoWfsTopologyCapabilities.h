...
#ifndef FDOWFSTOPOLOGYCAPABILITIES_H
#define FDOWFSTOPOLOGYCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class FdoWfsTopologyCapabilities : public FdoITopologyCapabilities
{
public:
    FdoWfsTopologyCapabilities ();

protected:
    virtual ~FdoWfsTopologyCapabilities ();
...
#endif // FDOWFSTOPOLOGYCAPABILITIES_H
