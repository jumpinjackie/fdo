...
#ifndef FDOWFSRASTERCAPABILITIES_H
#define FDOWFSRASTERCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class FdoWfsRasterCapabilities : public FdoIRasterCapabilities
{
public:
    FdoWfsRasterCapabilities ();

protected:
    virtual ~FdoWfsRasterCapabilities ();
...
#endif // FDOWFSRASTERCAPABILITIES_H
