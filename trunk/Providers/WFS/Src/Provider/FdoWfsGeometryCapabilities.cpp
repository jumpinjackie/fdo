...
FdoWfsGeometryCapabilities::FdoWfsGeometryCapabilities ()
{
}
...
void FdoWfsGeometryCapabilities::Dispose()
{
    delete this;
}
...
FdoGeometryType* FdoWfsGeometryCapabilities::GetGeometryTypes (FdoInt32& length)
{
...
FdoGeometryComponentType* FdoWfsGeometryCapabilities::GetGeometryComponentTypes (FdoInt32& length)
{
...
FdoInt32 FdoWfsGeometryCapabilities::GetDimensionalities ()
{
