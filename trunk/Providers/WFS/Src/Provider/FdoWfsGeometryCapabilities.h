...
#ifndef FDOWFSGEOMETRYCAPABILITIES_H
#define FDOWFSGEOMETRYCAPABILITIES_H
#ifdef _WIN32
#pragma once
#endif // _WIN32

class FdoWfsGeometryCapabilities : public FdoIGeometryCapabilities
{
public:
    FdoWfsGeometryCapabilities ();

protected:
    virtual ~FdoWfsGeometryCapabilities ();
...
#endif // FDOWFSGEOMETRYCAPABILITIES_H
