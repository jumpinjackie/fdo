...
#if !defined(XALANELEMELEMENTALLOCATOR_INCLUDE_GUARD_12455133)
#define XALANELEMELEMENTALLOCATOR_INCLUDE_GUARD_12455133
...
private:
    ...
    // Not implemented...
    XalanElemElementAllocator(const XalanElemElementAllocator&);

    XalanElemElementAllocator&
    operator=(const XalanElemElementAllocator&);
...
#endif  // XALANELEMELEMENTALLOCATOR_INCLUDE_GUARD_12455133
