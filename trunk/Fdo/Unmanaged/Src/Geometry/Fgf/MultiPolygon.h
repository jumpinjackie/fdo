#ifndef _FGFMULTIPOLYGON_H_
#define _FGFMULTIPOLYGON_H_
/*
...
class FdoFgfMultiPolygon : public FdoFgfGeometryImpl<FdoIMultiPolygon>
{
public:
	...
	// From FdoIMultiPolygon
	virtual FdoIPolygon* GetItem(FdoInt32 Index) const;
