...
public ref class PropertyValueCollection sealed : public NAMESPACE_OSGEO_COMMON::CollectionBase
{
/// \cond DOXYGEN-IGNORE
internal:
    PropertyValueCollection(System::IntPtr unmanaged, System::Boolean autoDelete) : NAMESPACE_OSGEO_COMMON::CollectionBase(unmanaged, autoDelete)
	{
...
public:
    ...
    /// 
	System::Void CopyTo(array<NAMESPACE_OSGEO_FDO_COMMANDS::PropertyValue^>^ pArray, System::Int32 index);
    ...
    /// 
    property NAMESPACE_OSGEO_FDO_COMMANDS::PropertyValue^ Item[System::Int32]
    {
        NAMESPACE_OSGEO_FDO_COMMANDS::PropertyValue^ get(System::Int32 index);
        System::Void set(System::Int32 index, NAMESPACE_OSGEO_FDO_COMMANDS::PropertyValue^ value);
    }
