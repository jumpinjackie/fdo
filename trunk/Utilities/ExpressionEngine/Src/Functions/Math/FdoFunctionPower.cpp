...
FdoFunctionPower::FdoFunctionPower ()
...
FdoFunctionPower *FdoFunctionPower::Create ()
...

{
    ...
    return new FdoFunctionPower();

}  //  Create ()

FdoFunctionPower *FdoFunctionPower::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionPower::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function POWER.
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionPower::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function POWER.
// +---------------------------------------------------------------------------
...
void FdoFunctionPower::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function POWER. The
// | function definition includes the list of supported signatures. The follow-
// | ing signatures are supported:
// |
// |    POWER ({byte, decimal, double, int16, int32, int64, single},
...

{
    ...
    FdoPtr<FdoArgumentDefinition>           byte_power_arg;
    FdoPtr<FdoArgumentDefinition>           dcl_power_arg;
    FdoPtr<FdoArgumentDefinition>           dbl_power_arg;
    FdoPtr<FdoArgumentDefinition>           int16_power_arg;
    FdoPtr<FdoArgumentDefinition>           int32_power_arg;
    FdoPtr<FdoArgumentDefinition>           int64_power_arg;
    FdoPtr<FdoArgumentDefinition>           sgl_power_arg;
    ...
    power_arg_literal =
            FdoException::NLSGetMessage(FUNCTION_BASE_ARG_LIT, "power");
...
FdoDouble FdoFunctionPower::GetParameterValue (
                                FdoLiteralValueCollection *literal_values,
