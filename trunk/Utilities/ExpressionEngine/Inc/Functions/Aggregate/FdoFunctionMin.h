...
// 
//
#ifndef FDOFUNCTIONMIN_H
#define FDOFUNCTIONMIN_H
...
// ============================================================================
// The class FdoFunctionMin implements the Expression Engine function MIN.
// ============================================================================

class FdoFunctionMin : public FdoExpressionEngineIAggregateFunction
{
    ...
    private:
        ...
        //  Expression Engine function MIN.
    ...
    public:
        ...
        static FdoFunctionMin *Create ();

        // CreateObject:
        //  Function to create an instance of this class.

        virtual FdoFunctionMin *CreateObject ();

        // GetFunctionDefinition:
        //  The function returns the function definition for the function MIN.
    ...
    private:
        ...
        // ProcessRequest:
        //  The function processes a call to the Expression Engine function MIN.
