...
// 
//
#ifndef FDOFUNCTIONRPAD_H
#define FDOFUNCTIONRPAD_H
...
// ============================================================================
// The class FdoFunctionRpad implements the Expression Engine function RPAD.
// ============================================================================
...
class FdoFunctionRpad : public FdoExpressionEngineINonAggregateFunction
{
    ...
    public:
        ...
        static FdoFunctionRpad *Create ();

        // CreateObject:
        //  Function to create an instance of this class.

        virtual FdoFunctionRpad *CreateObject ();

        // GetFunctionDefinition:
        //  The function returns the function definition for the function
        //  RPAD. The definition includes the list of supported signatures
        //  for the function.
    ...
    private:
        ...
        //  The routine creates the function definition for the function RPAD.
