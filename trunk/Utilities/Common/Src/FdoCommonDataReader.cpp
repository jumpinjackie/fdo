...
FdoCommonDataReader::FdoCommonDataReader(FdoIConnection* conn, FdoISelect *selectCmd, FdoClassDefinition* originalClassDef, FdoIdentifierCollection* selectedIds, bool bDistinct, FdoIdentifierCollection* orderingIds, FdoOrderingOption eOrderingOption)
{
    ...
    if ((aggrIdents != NULL) && (aggrIdents->GetCount() > 0))
    {
        ...
        RunAggregateQuery(selectCmd, originalClassDef, selectedIds, aggrClass, aggrIdents);
    }
    else
    {
        ...
        FdoPtr<FdoIdentifierCollection> ids = selectCmd->GetPropertyNames();
        ids->Clear();
...
FdoCommonDataReader::~FdoCommonDataReader()
{
    Close();
}

void FdoCommonDataReader::Dispose()
{
    delete this;
}

FdoInt32 FdoCommonDataReader::GetPropertyCount()
{
    return m_propIndex->GetNumProps();
}

FdoString* FdoCommonDataReader::GetPropertyName(FdoInt32 index)
{
...
FdoDataType FdoCommonDataReader::GetDataType(FdoString* propertyName)
{
...
FdoPropertyType FdoCommonDataReader::GetPropertyType(FdoString* propertyName)
{
...
FdoCommonBinaryReader* FdoCommonDataReader::perform_checks (
...
bool FdoCommonDataReader::GetBoolean (FdoString* propertyName)
{
...
FdoByte FdoCommonDataReader::GetByte (FdoString* propertyName)
{
...
FdoDateTime FdoCommonDataReader::GetDateTime (FdoString* propertyName)
{
...
double FdoCommonDataReader::GetDouble (FdoString* propertyName)
{
...
FdoInt16 FdoCommonDataReader::GetInt16 (FdoString* propertyName)
{
...
FdoInt32 FdoCommonDataReader::GetInt32 (FdoString* propertyName)
{
...
FdoInt64 FdoCommonDataReader::GetInt64 (FdoString* propertyName)
{
...
float FdoCommonDataReader::GetSingle (FdoString* propertyName)
{
...
FdoString* FdoCommonDataReader::GetString (FdoString* propertyName)
{
    int len;
...
FdoLOBValue* FdoCommonDataReader::GetLOB(FdoString* propertyName)
{
    (void)propertyName;  // to avoid compile-time warning of unreferenced parameter
...
FdoIStreamReader* FdoCommonDataReader::GetLOBStreamReader(const wchar_t* propertyName)
{
    (void)propertyName;  // to avoid compile-time warning of unreferenced parameter
...
bool FdoCommonDataReader::IsNull(FdoString* propertyName)
{
    FdoCommonPropertyStub* ps = m_propIndex->GetPropInfo(propertyName);
...
FdoByteArray* FdoCommonDataReader::GetGeometry(FdoString* propertyName)
{
    FdoCommonPropertyStub* ps = m_propIndex->GetPropInfo(propertyName);
...
FdoIRaster* FdoCommonDataReader::GetRaster(FdoString* propertyName)
{
    (void)propertyName;  // to avoid compile-time warning of unreferenced parameter
...
void FdoCommonDataReader::Close()
{
...
FdoCommonPropertyIndex* FdoCommonDataReader::GetPropertyIndex()
{
...
FdoArray<FdoFunction*>* FdoCommonDataReader::GetAggregateFunctions(FdoIdentifierCollection* selectedIds, FdoCommonExpressionType &exprType)
{
    ...
    for (FdoInt32 i=0; i<selectedIds->GetCount(); i++)
    {
        ...
        FdoArray<FdoFunction*>* aggregates = GetAggregateFunctions(selectedId, exprType);
...
FdoArray<FdoFunction*>* FdoCommonDataReader::GetAggregateFunctions(FdoExpression* expr, FdoCommonExpressionType &exprType)
{
    ...
    if (NULL != unaryExpr)
        return GetAggregateFunctions(FdoPtr<FdoExpression>(unaryExpr->GetExpression()), exprType);

    FdoBinaryExpression* binaryExpr = dynamic_cast<FdoBinaryExpression*>(expr);
    if (NULL != binaryExpr)
    {
        FdoCommonExpressionType leftExprType;
        FdoArray<FdoFunction*>* leftAggrs = GetAggregateFunctions(FdoPtr<FdoExpression>(binaryExpr->GetLeftExpression()), leftExprType);
        FdoCommonExpressionType rightExprType;
        FdoArray<FdoFunction*>* rightAggrs = GetAggregateFunctions(FdoPtr<FdoExpression>(binaryExpr->GetRightExpression()), rightExprType);
    ...
    if (NULL != computedId)
        return GetAggregateFunctions(FdoPtr<FdoExpression>(computedId->GetExpression()), exprType);
    ...
    if (NULL != function)
    {
        if (FdoCommonQueryAggregator::IsAggregateFunction(function->GetName()))
        {
            ...
            for (FdoInt32 i=0; i<funcArgs->GetCount(); i++)
            {
                ...
                FdoArray<FdoFunction*>* funcArgAggregates = GetAggregateFunctions(funcArg, funcArgExprType);
        ...
        else
        {
            ...
            for (FdoInt32 i=0; i<funcArgs->GetCount(); i++)
            {
                FdoPtr<FdoExpression> funcArg = funcArgs->GetItem(i);
                FdoCommonExpressionType funcArgExprType;
                FdoArray<FdoFunction*>* aggrIds = GetAggregateFunctions(funcArg, funcArgExprType);
...
FdoClassDefinition* FdoCommonDataReader::GetAggregateClassDef(FdoClassDefinition* originalClassDef, FdoIdentifierCollection* selectedIds)
{
...
void FdoCommonDataReader::PerformDistinct()
{
...
bool vector_sort(orderby_context rowcontext1, orderby_context rowcontext2)
{
    ...
    FdoCommonDataReader* parentReader = rowcontext1.parentReader;
...
FdoIdentifierCollection* FdoCommonDataReader::GetOrdering()
{
    return FDO_SAFE_ADDREF(m_orderbyIds.p);
}

FdoOrderingOption FdoCommonDataReader::GetOrderingOption()
{
    return m_orderbyOption;
}

FdoCommonBinaryReader* FdoCommonDataReader::GetOrderingBinReader1()
{
...
FdoCommonBinaryReader* FdoCommonDataReader::GetOrderingBinReader2()
{
...
void FdoCommonDataReader::PerformOrderBy()
{
...
bool FdoCommonDataReader::ReadNext()
{
    m_resultsIndex++;
...
FdoCommonBinaryReader* FdoCommonDataReader::GetBinaryReader()
{
