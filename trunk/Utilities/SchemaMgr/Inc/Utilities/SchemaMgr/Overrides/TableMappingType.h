#ifndef FDO_SMOVTABLEMAPPINGTYPE_H
#define FDO_SMOVTABLEMAPPINGTYPE_H
//
//
...
///<summary>FdoSmOvTableMappingType is an enumeration of the possible mapping types</summary>
/// <param name="FdoSmOvTableMappingType_Default"> Defaults to Concrete table. </param>
/// <param name="FdoSmOvTableMappingType_ClassTable"> only explicit properties are stored in the class
...
/// </param>
/// <param name="FdoSmOvTableMappingType_ConcreteTable"> all class properties ( explicit and inherited )
/// are stored in the class table. The class table can be the same or different from the class table for its
/// base class. </param>
/// <param name="FdoSmOvTableMappingType_BaseTable"> all explicit class properties are store in the table
...
enum FdoSmOvTableMappingType
{
    FdoSmOvTableMappingType_Default,
    FdoSmOvTableMappingType_ClassTable,
    FdoSmOvTableMappingType_ConcreteTable,
    FdoSmOvTableMappingType_BaseTable
};
