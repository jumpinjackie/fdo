#ifndef FDOSMPHCOLUMNDOUBLE_H
#define FDOSMPHCOLUMNDOUBLE_H		1
/*
...
// This class double precision type of column.
class FdoSmPhColumnDouble :
...
typedef FdoPtr<FdoSmPhColumnDouble> FdoSmPhColumnDoubleP;
