#ifndef FDOSMPHSPATIALCONTEXT_H
#define FDOSMPHSPATIALCONTEXT_H		1
/*
...
// This Physical class encapsulates a Spatial Context that was 
// reverse-engineered from the Physical Schema
class FdoSmPhSpatialContext : public FdoSmPhSchemaElement
{
public:
    ~FdoSmPhSpatialContext(void);
...
typedef FdoPtr<FdoSmPhSpatialContext> FdoSmPhSpatialContextP;
