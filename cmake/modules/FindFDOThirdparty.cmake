...
if( NOT INTERNAL_XERCESC )
	...
	set( XERCESC_LIBRARY_DIR  ${FDOTHIRDPARTY}/apache/xerces )
	set( XERCESC_INCLUDE_DIR  ${FDOTHIRDPARTY}/apache/xerces/src/xercesc/} )
...
if( NOT INTERNAL_XALANC )
	...
	set( XALANC_LIBRARY_DIR  ${FDOTHIRDPARTY}/apache/xalan )
	set( XALANC_INCLUDE_DIR  ${FDOTHIRDPARTY}/apache/xalan/src/xalanc/} )
