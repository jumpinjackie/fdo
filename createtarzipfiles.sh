...
if test "$FDOCOREENABLECHK" == yes; then
   ...
   rm -f fdo-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdo-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdo-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdo-3.8.0_"$FDOBUILDNUMBER".tar
...
if test "$SHPENABLECHK" == yes; then
   ...
   rm -f fdoshp-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdoshp-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdoshp-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdoshp-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$SDFENABLECHK" == yes; then
   ...
   rm -f fdosdf-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdosdf-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdosdf-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdosdf-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$WFSENABLECHK" == yes; then
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdowfs-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdowfs-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdowfs-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdowfs-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$WMSENABLECHK" == yes; then
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdowms-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdowms-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdowms-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdowms-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$ARCENABLECHK" == yes; then
   ...
   rm -f fdoarcsde-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdoarcsde-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdoarcsde-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdoarcsde-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$RDBMSENABLECHK" == yes; then
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdordbms-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdordbms-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdordbms-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdordbms-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$GDALENABLECHK" == yes; then
   ...
   rm -f fdogdal-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdogdal-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdogdal-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdogdal-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$KINGORACLEENABLECHK" == yes; then
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdokingoracle-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdokingoracle-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdokingoracle-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdokingoracle-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$OGRENABLECHK" == yes; then
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdoogr-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdoogr-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdoogr-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdoogr-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$SQLITEENABLECHK" == yes; then
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdosqlite-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdosqlite-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdosqlite-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdosqlite-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
if test "$TESTDATAENABLECHK" == yes; then
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdoarcsde-testdata-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdoarcsde-testdata-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdoarcsde-testdata-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdoarcsde-testdata-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdogdal-testdata-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdogdal-testdata-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdogdal-testdata-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdogdal-testdata-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdosdf-testdata-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdosdf-testdata-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdosdf-testdata-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdosdf-testdata-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
   ...
   find "$FDOTARZIPFOLDER" -name .svn | xargs rm -rf
   rm -f fdoshp-testdata-3.8.0_"$FDOBUILDNUMBER".tar
   tar -cf fdoshp-testdata-3.8.0_"$FDOBUILDNUMBER".tar "$FDOTARZIPFOLDER"
   rm -f fdoshp-testdata-3.8.0_"$FDOBUILDNUMBER".tar.gz
   gzip -9 fdoshp-testdata-3.8.0_"$FDOBUILDNUMBER".tar
   rm -rf "$FDOTARZIPFOLDER"
fi
