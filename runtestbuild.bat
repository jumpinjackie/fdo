...
:start_copy
   copy /Y "%FDOSOURCEZIP%\fdo-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdoshp-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdosdf-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdowfs-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdowms-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdoarcsde-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdordbms-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdogdal-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdoogr-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdokingoracle-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdosqlite-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   
:start_unzip
   echo *start unzip files
   pushd "%FDOTARGETFOLDER%"
   7z x -ry "fdo-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdoshp-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdosdf-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdowfs-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdowms-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdoarcsde-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdordbms-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdogdal-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdoogr-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdokingoracle-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdosqlite-3.8.1_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   
   7z x -ry "fdo-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdoshp-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdosdf-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdowfs-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdowms-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdoarcsde-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdordbms-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdogdal-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdoogr-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdokingoracle-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdosqlite-3.8.1_%FDOBUILDNUMBERRTB%.tar" >>nul
