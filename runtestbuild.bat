...
:start_copy
   copy /Y "%FDOSOURCEZIP%\fdo-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdoshp-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdosdf-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdowfs-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdowms-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
   copy /Y "%FDOSOURCEZIP%\fdoarcsde-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" "%FDOTARGETFOLDER%"
...
:start_unzip
   ...
   pushd "%FDOTARGETFOLDER%"
   7z x -ry "fdo-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdoshp-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdosdf-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdowfs-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdowms-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   7z x -ry "fdoarcsde-3.6.0_%FDOBUILDNUMBERRTB%.tar.gz" >>nul
   ...
   7z x -ry "fdo-3.6.0_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdoshp-3.6.0_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdosdf-3.6.0_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdowfs-3.6.0_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdowms-3.6.0_%FDOBUILDNUMBERRTB%.tar" >>nul
   7z x -ry "fdoarcsde-3.6.0_%FDOBUILDNUMBERRTB%.tar" >>nul
