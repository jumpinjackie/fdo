...
// 
//
#ifndef FDOFUNCTIONPOWER_H
#define FDOFUNCTIONPOWER_H
...
// ============================================================================
// The class FdoFunctionPower implements the Expression Engine function POWER.
// ============================================================================

class FdoFunctionPower : public FdoExpressionEngineINonAggregateFunction
{
    ...
    public:
        ...
        static FdoFunctionPower *Create ();

        // CreateObject:
        //  Function to create an instance of this class.

        virtual FdoFunctionPower *CreateObject ();

        // GetFunctionDefinition:
        //  The function returns the function definition for the function
        //  POWER. The definition includes the list of supported signatures
        //  for the function.
    ...
    private:
        ...
        //  The routine creates the function definition for the function POWER.
