...
// 
//
#ifndef FDOFUNCTIONLN_H
#define FDOFUNCTIONLN_H
...
// ============================================================================
// The class FdoFunctionLn implements the Expression Engine function LN.
// ============================================================================

class FdoFunctionLn : public FdoExpressionEngineINonAggregateFunction
{
    ...
    public:
        ...
        static FdoFunctionLn *Create ();

        // CreateObject:
        //  Function to create an instance of this class.

        virtual FdoFunctionLn *CreateObject ();

        // GetFunctionDefinition:
        //  The function returns the function definition for the function LN.
    ...
    private:
        ...
        //  The routine creates the function definition for the function LN.
