...
// 
//
#ifndef FDOFUNCTIONSQRT_H
#define FDOFUNCTIONSQRT_H
...
// ============================================================================
// The class FdoFunctionSqrt implements the Expression Engine function SQRT.
// ============================================================================

class FdoFunctionSqrt : public FdoExpressionEngineINonAggregateFunction
{
    ...
    public:
        ...
        static FdoFunctionSqrt *Create ();

        // CreateObject:
        //  Function to create an instance of this class.

        virtual FdoFunctionSqrt *CreateObject ();

        // GetFunctionDefinition:
        //  The function returns the function definition for the function SQRT.
    ...
    private:
        ...
        //  The routine creates the function definition for the function SQRT.
