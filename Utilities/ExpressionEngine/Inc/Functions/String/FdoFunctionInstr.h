...
// 
//
#ifndef FDOFUNCTIONINSTR_H
#define FDOFUNCTIONINSTR_H
...
// ============================================================================
// The class FdoFunctionInstr implements the Expression Engine function INSTR.
// ============================================================================

class FdoFunctionInstr : public FdoExpressionEngineINonAggregateFunction
{
    ...
    public:
        ...
        static FdoFunctionInstr *Create ();

        // CreateObject:
        //  Function to create an instance of this class.

        virtual FdoFunctionInstr *CreateObject ();

        // GetFunctionDefinition:
        //  The function returns the function definition for the function
        //  INSTR. The definition includes the list of supported signatures
        //  for the function.
    ...
    private:
        ...
        //  The routine creates the function definition for the function INSTR.
