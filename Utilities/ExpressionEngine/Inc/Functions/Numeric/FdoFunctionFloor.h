...
// 
//
#ifndef FDOFUNCTIONFLOOR_H
#define FDOFUNCTIONFLOOR_H
...
// ============================================================================
// The class FdoFunctionFloor implements the Expression Engine function FLOOR.
// ============================================================================

class FdoFunctionFloor : public FdoExpressionEngineINonAggregateFunction
{
    ...
    public:
        ...
        static FdoFunctionFloor *Create ();

        // CreateObject:
        //  Function to create an instance of this class.

        virtual FdoFunctionFloor *CreateObject ();

        // GetFunctionDefinition:
        //  The function returns the function definition for the function
        //  FLOOR. The definition includes the list of supported signatures
        //  for the function.
    ...
    private:
        ...
        //  The routine creates the function definition for the function FLOOR.
