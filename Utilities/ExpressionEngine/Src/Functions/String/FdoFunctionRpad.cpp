...
FdoFunctionRpad::FdoFunctionRpad ()
...
FdoFunctionRpad *FdoFunctionRpad::Create ()
...

{
    ...
    return new FdoFunctionRpad();

}  //  Create ()

FdoFunctionRpad *FdoFunctionRpad::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionRpad::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function RPAD.
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionRpad::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function RPAD.
// +---------------------------------------------------------------------------
...
void FdoFunctionRpad::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function RPAD. The
// | function definition includes the list of supported signatures. The follow-
// | ing signatures are supported:
// |
// |    RPAD (
// |        string, {decimal, double, int16, int32, int64, single} [, string] )
// |
...

{
    ...
    arg1_description =
                   FdoException::NLSGetMessage(FUNCTION_RPAD_STRING_ARG,
    ...
    signature = FdoSignatureDefinition::Create(FdoDataType_String, str_dcl_str_args);
    signatures->Add(signature);
    signature = FdoSignatureDefinition::Create(FdoDataType_String, str_dbl_str_args);
    signatures->Add(signature);
    signature = FdoSignatureDefinition::Create(FdoDataType_String, str_int16_str_args);
    signatures->Add(signature);
    signature = FdoSignatureDefinition::Create(FdoDataType_String, str_int32_str_args);
    signatures->Add(signature);
    signature = FdoSignatureDefinition::Create(FdoDataType_String, str_int64_str_args);
    signatures->Add(signature);
    signature = FdoSignatureDefinition::Create(FdoDataType_String, str_sgl_str_args);
    signatures->Add(signature);
...
FdoInt64 FdoFunctionRpad::GetPaddingLength (
                                FdoLiteralValueCollection *literal_values,
...
void FdoFunctionRpad::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. RPAD accepts either two or three para-
