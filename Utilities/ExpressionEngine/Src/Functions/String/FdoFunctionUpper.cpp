...
FdoFunctionUpper::FdoFunctionUpper ()
...
FdoFunctionUpper *FdoFunctionUpper::Create ()
...

{
    ...
    return new FdoFunctionUpper();

}  //  Create ()

FdoFunctionUpper *FdoFunctionUpper::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionUpper::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function UPPER.
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionUpper::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function UPPER.
// +---------------------------------------------------------------------------

{
    ...
    if (!string_value->IsNull()) {
        ...
        return_string_value->SetString(FdoCommonOSUtil::wcsupr(tmp_buffer));
    }  //  if (!string_value->IsNull()) ...
    else
...
void FdoFunctionUpper::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function UPPER. The
...
void FdoFunctionUpper::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. UPPER accepts exactly one parameter. If
