...
FdoFunctionCos *FdoFunctionCos::Create ()
...

{
    ...
    return new FdoFunctionCos();

}  //  Create ()

FdoFunctionCos *FdoFunctionCos::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionCos::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function COS.
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionCos::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function COS.
// +---------------------------------------------------------------------------
    ...
    switch (incoming_data_type) {
      ...
      case FdoDataType_Byte:
        ...
        if (!byte_value->IsNull())
            return_double_value->SetDouble(cos((double)byte_value->GetByte()));
        else
      ...
      case FdoDataType_Decimal:
        ...
        if (!decimal_value->IsNull())
            return_double_value->SetDouble(cos(decimal_value->GetDecimal()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Double:
        ...
        if (!double_value->IsNull())
            return_double_value->SetDouble(cos(double_value->GetDouble()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Int16:
        ...
        if (!int16_value->IsNull())
            return_double_value->SetDouble(cos((double)int16_value->GetInt16()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Int32:
        ...
        if (!int32_value->IsNull())
            return_double_value->SetDouble(cos((double)int32_value->GetInt32()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Int64:
        ...
        if (!int64_value->IsNull())
            return_double_value->SetDouble(cos((double)int64_value->GetInt64()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Single:
        ...
        if (!single_value->IsNull())
            return_double_value->SetDouble(cos(single_value->GetSingle()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
...
void FdoFunctionCos::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function COS. The
// | function definition includes the list of supported signatures. The follow-
// | ing signatures are supported:
// |
// |    COS ({byte, decimal, double, int16, int32, int64, single})
// |
...
void FdoFunctionCos::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. COS accepts one parameter only. If the
