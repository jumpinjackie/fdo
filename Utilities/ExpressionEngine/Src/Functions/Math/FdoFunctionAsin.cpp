...
FdoFunctionAsin::FdoFunctionAsin ()
...
FdoFunctionAsin *FdoFunctionAsin::Create ()
...

{
    ...
    return new FdoFunctionAsin();

}  //  Create ()

FdoFunctionAsin *FdoFunctionAsin::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionAsin::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function ASIN.
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionAsin::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function ASIN.
// +---------------------------------------------------------------------------
      ...
      case FdoDataType_Int16:
        ...
        if (!int16_value->IsNull()) {
            ...
            if ((int16_value->GetInt16() >= -1) &&
                ...
                return FdoDoubleValue::Create(
                                    asin((double)int16_value->GetInt16()));
      ...
      case FdoDataType_Int32:
        ...
        if (!int32_value->IsNull()) {
            ...
            if ((int32_value->GetInt32() >= -1) &&
                ...
                return FdoDoubleValue::Create(
                                    asin((double)int32_value->GetInt32()));
      ...
      case FdoDataType_Int64:
        ...
        if (!int64_value->IsNull()) {
            ...
            if ((int64_value->GetInt64() >= -1) &&
                ...
                return FdoDoubleValue::Create(
                                    asin((double)int64_value->GetInt64()));
...
void FdoFunctionAsin::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function ASIN. The
// | function definition includes the list of supported signatures. The follow-
// | ing signatures are supported:
// |
// |    ASIN ({decimal, double, int16, int32, int64, single})
// |
...
void FdoFunctionAsin::Validate (FdoLiteralValueCollection *literal_values)
