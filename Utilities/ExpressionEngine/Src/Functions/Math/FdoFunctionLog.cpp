...
// |
// |    LOG ({decimal, double, int16, int32, int64, single},
...

{
    ...
    *is_NULL_value = false;
    ...
    // Because of the validation of the request at the beginning of the call-
    // ing function, any use of an invalid data type as a parameter has already
