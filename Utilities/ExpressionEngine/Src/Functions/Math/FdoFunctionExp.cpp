...
FdoFunctionExp *FdoFunctionExp::Create ()
...

{
    ...
    return new FdoFunctionExp();

}  //  Create ()

FdoFunctionExp *FdoFunctionExp::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionExp::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function EXP.
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionExp::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function EXP.
// +---------------------------------------------------------------------------
    ...
    switch (incoming_data_type) {
      ...
      case FdoDataType_Byte:
        ...
        if (!byte_value->IsNull())
            return_double_value->SetDouble(exp((double)byte_value->GetByte()));
        else
      ...
      case FdoDataType_Decimal:
        ...
        if (!decimal_value->IsNull())
            return_double_value->SetDouble(exp(decimal_value->GetDecimal()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Double:
        ...
        if (!double_value->IsNull())
            return_double_value->SetDouble(exp(double_value->GetDouble()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Int16:
        ...
        if (!int16_value->IsNull())
            return_double_value->SetDouble(exp((double)int16_value->GetInt16()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Int32:
        ...
        if (!int32_value->IsNull())
            return_double_value->SetDouble(exp((double)int32_value->GetInt32()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Int64:
        ...
        if (!int64_value->IsNull())
            return_double_value->SetDouble(exp((double)int64_value->GetInt64()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
      ...
      case FdoDataType_Single:
        ...
        if (!single_value->IsNull())
            return_double_value->SetDouble(exp(single_value->GetSingle()));
        else
            return_double_value->SetNull();
        return FDO_SAFE_ADDREF(return_double_value.p);
        break;
...
void FdoFunctionExp::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function EXP. The
// | function definition includes the list of supported signatures. The follow-
// | ing signatures are supported:
// |
// |    EXP ({byte, decimal, double, int16, int32, int64, single})
// |
...
void FdoFunctionExp::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. EXP accepts one parameter only. If the
