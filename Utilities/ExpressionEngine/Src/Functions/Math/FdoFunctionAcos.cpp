...
FdoFunctionAcos::FdoFunctionAcos ()
...
FdoFunctionAcos *FdoFunctionAcos::Create ()
...

{
    ...
    return new FdoFunctionAcos();

}  //  Create ()

FdoFunctionAcos *FdoFunctionAcos::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionAcos::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function ACOS.
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionAcos::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function ACOS.
// +---------------------------------------------------------------------------
    ...
    switch (incoming_data_type) {
      ...
      case FdoDataType_Decimal:
        ...
        if (!decimal_value->IsNull()) {
            ...
            if ((decimal_value->GetDecimal() >= -1) &&
                (decimal_value->GetDecimal() <=  1)    )
                return FdoDoubleValue::Create(
                                        acos(decimal_value->GetDecimal()));
      ...
      case FdoDataType_Double:
        ...
        if (!double_value->IsNull()) {
            ...
            if ((double_value->GetDouble() >= -1) &&
                (double_value->GetDouble() <=  1)    )
                return FdoDoubleValue::Create(
                                        acos(double_value->GetDouble()));
      ...
      case FdoDataType_Int16:
        ...
        if (!int16_value->IsNull()) {
            ...
            if ((int16_value->GetInt16() >= -1) &&
                (int16_value->GetInt16() <=  1)    )
                return FdoDoubleValue::Create(
                                    acos((double)int16_value->GetInt16()));
      ...
      case FdoDataType_Int32:
        ...
        if (!int32_value->IsNull()) {
            ...
            if ((int32_value->GetInt32() >= -1) &&
                (int32_value->GetInt32() <=  1)    )
                return FdoDoubleValue::Create(
                                    acos((double)int32_value->GetInt32()));
      ...
      case FdoDataType_Int64:
        ...
        if (!int64_value->IsNull()) {
            ...
            if ((int64_value->GetInt64() >= -1) &&
                (int64_value->GetInt64() <=  1)    )
                return FdoDoubleValue::Create(
                                    acos((double)int64_value->GetInt64()));
      ...
      case FdoDataType_Single:
        ...
        if (!single_value->IsNull()) {
            ...
            if ((single_value->GetSingle() >= -1) &&
                (single_value->GetSingle() <=  1)    )
                return FdoDoubleValue::Create(
                                    acos(single_value->GetSingle()));
...
void FdoFunctionAcos::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function ACOS. The
// | function definition includes the list of supported signatures. The follow-
// | ing signatures are supported:
// |
// |    ACOS ({decimal, double, int16, int32, int64, single})
// |
...
void FdoFunctionAcos::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. ACOS accepts one parameter only. If the
