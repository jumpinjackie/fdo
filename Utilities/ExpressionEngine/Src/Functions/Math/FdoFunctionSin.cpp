    ...
    switch (incoming_data_type) {
      ...
      case FdoDataType_Byte:
        ...
        if (!byte_value->IsNull())
            return FdoDoubleValue::Create(sin((double)byte_value->GetByte()));
        else
      ...
      case FdoDataType_Decimal:
        ...
        if (!decimal_value->IsNull())
            return FdoDoubleValue::Create(sin(decimal_value->GetDecimal()));
        else
          return FdoDoubleValue::Create();
        break;
      ...
      case FdoDataType_Double:
        ...
        if (!double_value->IsNull())
            return FdoDoubleValue::Create(sin(double_value->GetDouble()));
        else
          return FdoDoubleValue::Create();
        break;
      ...
      case FdoDataType_Int16:
        ...
        if (!int16_value->IsNull())
            return FdoDoubleValue::Create(sin((double)int16_value->GetInt16()));
        else
          return FdoDoubleValue::Create();
        break;
      ...
      case FdoDataType_Int32:
        ...
        if (!int32_value->IsNull())
            return FdoDoubleValue::Create(sin((double)int32_value->GetInt32()));
        else
          return FdoDoubleValue::Create();
        break;
      ...
      case FdoDataType_Int64:
        ...
        if (!int64_value->IsNull())
            return FdoDoubleValue::Create(sin((double)int64_value->GetInt64()));
        else
          return FdoDoubleValue::Create();
        break;
      ...
      case FdoDataType_Single:
        ...
        if (!single_value->IsNull())
            return FdoDoubleValue::Create(sin(single_value->GetSingle()));
        else
          return FdoDoubleValue::Create();
        break;
