...
// |
// |    STDDEV ({decimal, double, int16, int32, int64, single})
// |
...
void FdoFunctionStddev::ProcessRequest (FdoDouble value)

// +---------------------------------------------------------------------------
// | The function processes a request to the Expression Engine function STDDEV
...
void FdoFunctionStddev::ProcessRequest (FdoInt16 value)
...

{
    ...
    // Check the number of arguments. STDDEV accepts a single numeric parameter.
