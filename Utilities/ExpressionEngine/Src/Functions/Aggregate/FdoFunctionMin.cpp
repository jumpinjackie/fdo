...
FdoFunctionMin *FdoFunctionMin::Create ()
...

{
    ...
    return new FdoFunctionMin();

}  //  Create ()

FdoFunctionMin *FdoFunctionMin::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionMin::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function MIN.
// +---------------------------------------------------------------------------
...
void FdoFunctionMin::Process (FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function MIN.
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionMin::GetResult ()

// +---------------------------------------------------------------------------
// | The function returns the result of a call to the function MIN.
// +---------------------------------------------------------------------------
...
void FdoFunctionMin::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function MIN. The
...

{
    ...
    desc = FdoException::NLSGetMessage(
                            FUNCTION_MIN,
                            "Determines the minimum value of an expression");
    function_definition =
...
void FdoFunctionMin::ProcessRequest (FdoByte value)

// +---------------------------------------------------------------------------
// | The function processes a request to the Expression Engine function MIN
...
void FdoFunctionMin::ProcessRequest (FdoDateTime value)
...
void FdoFunctionMin::ProcessRequest (FdoDouble value)
...
void FdoFunctionMin::ProcessRequest (FdoFloat value)
...
void FdoFunctionMin::ProcessRequest (FdoInt16 value)
...
void FdoFunctionMin::ProcessRequest (FdoInt32 value)
...
void FdoFunctionMin::ProcessRequest (FdoInt64 value)
...
void FdoFunctionMin::ProcessRequest (FdoString *value)
...
void FdoFunctionMin::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. MIN can accept either one or two para-
...
FdoFunctionMin::ResultCacheClass::ResultCacheClass ()
{
}
