...
FdoFunctionToFloat *FdoFunctionToFloat::Create ()
...

{
    ...
    return new FdoFunctionToFloat();

}  //  Create ()

FdoFunctionToFloat *FdoFunctionToFloat::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionToFloat::GetFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The function creates the supported signature list for the function TOFLOAT
// +---------------------------------------------------------------------------
...
FdoLiteralValue *FdoFunctionToFloat::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function TOFLOAT.
// +---------------------------------------------------------------------------
...
void FdoFunctionToFloat::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function TOFLOAT.
// | The function definition includes the list of supported signatures. The
// | following signatures are supported:
// |
// |    TOFLOAT ({byte, decimal, double, int16, int32, int64, single, string})
// |
// | The function always returns a SINGLE.
// +---------------------------------------------------------------------------

{
    ...
    signature = FdoSignatureDefinition::Create(FdoDataType_Single, byte_args);
    signatures->Add(signature);

    signature = FdoSignatureDefinition::Create(FdoDataType_Single, dcl_args);
    signatures->Add(signature);

    signature = FdoSignatureDefinition::Create(FdoDataType_Single, dbl_args);
    signatures->Add(signature);

    signature = FdoSignatureDefinition::Create(FdoDataType_Single, int16_args);
    signatures->Add(signature);

    signature = FdoSignatureDefinition::Create(FdoDataType_Single, int32_args);
    signatures->Add(signature);

    signature = FdoSignatureDefinition::Create(FdoDataType_Single, int64_args);
    signatures->Add(signature);

    signature = FdoSignatureDefinition::Create(FdoDataType_Single, sgl_args);
    signatures->Add(signature);

    signature = FdoSignatureDefinition::Create(FdoDataType_Single, str_args);
    signatures->Add(signature);

    // Create the function definition.

    desc =
        FdoException::NLSGetMessage(FUNCTION_TOFLOAT,
...
FdoStringP FdoFunctionToFloat::RemoveBlanks (FdoStringP value)
...
void FdoFunctionToFloat::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. TOFLOAT accepts one parameter only. If
