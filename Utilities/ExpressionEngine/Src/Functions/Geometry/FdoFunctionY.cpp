...
FdoFunctionY *FdoFunctionY::Create ()
...

{
    ...
    return new FdoFunctionY();

}  //  Create ()

FdoFunctionY *FdoFunctionY::CreateObject ()
...
FdoFunctionDefinition *FdoFunctionY::GetFunctionDefinition ()
...
FdoLiteralValue *FdoFunctionY::Evaluate (
                                    FdoLiteralValueCollection *literal_values)

// +---------------------------------------------------------------------------
// | The function processes a call to the function Y().
// +---------------------------------------------------------------------------

{
	...
	pos = p->GetPosition();
    return_double_value->SetDouble(pos->GetY());
    return FDO_SAFE_ADDREF(return_double_value.p);
...
void FdoFunctionY::CreateFunctionDefinition ()

// +---------------------------------------------------------------------------
// | The procedure creates the function definition for the function Y. The
...

{
    ...
    desc = FdoException::NLSGetMessage(
                                FUNCTION_Y,
                                "Determines the Y coordinate of a point geometry");
    function_definition =
...
void FdoFunctionY::Validate (FdoLiteralValueCollection *literal_values)
...

{
    ...
    // Check the number of arguments. Y() accepts one parameter only. If the
