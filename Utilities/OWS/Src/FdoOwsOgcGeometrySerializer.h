...
#ifndef FDOOWSOGCGEOMETRYSERIALIZER_H
#define FDOOWSOGCGEOMETRYSERIALIZER_H
...
/// <summary>
/// This static class serializes geometry objects to OGC formats.
/// </summary>
class FdoOwsOgcGeometrySerializer
{
public:
	...
	static void SerializeGeometry(FdoIGeometry* geometry, FdoXmlWriter* writer, FdoString* srsName, FdoBoolean invertAxis = false);
	...
	/// <returns>Returns nothing</returns>
	static void SerializePoint(FdoIPoint* point, FdoXmlWriter* writer, FdoBoolean invertAxis = false);
	...
	/// <returns>Returns nothing</returns>
	static void SerializeLineString(FdoILineString* lineString, FdoXmlWriter* writer, FdoBoolean invertAxis = false);
	...
	/// <returns>Returns nothing</returns>
	static void SerializeLinearRing(FdoILinearRing* linearRing, FdoXmlWriter* writer, FdoBoolean invertAxis = false);
	...
	/// <returns>Returns nothing</returns>
	static void SerializePolygon(FdoIPolygon* polygon, FdoXmlWriter* writer, FdoString* srsName, FdoBoolean invertAxis = false);
	...
	/// <returns>Returns nothing</returns>
	static void SerializeMultiPoint(FdoIMultiPoint* multiPoint, FdoXmlWriter* writer, FdoString* srsName, FdoBoolean invertAxis = false);
	...
	/// <returns>Returns nothing</returns>
	static void SerializeMultiLineString(FdoIMultiLineString* mlString, FdoXmlWriter* writer, FdoBoolean invertAxis = false);
	...
	/// <returns>Returns nothing</returns>
	static void SerializeMultiPolygon(FdoIMultiPolygon*, FdoXmlWriter* writer, FdoString* srsName, FdoBoolean invertAxis = false);
	...
	/// <returns>Returns nothing</returns>
	static void SerializeMultiGeometry(FdoIMultiGeometry*, FdoXmlWriter* writer, FdoString* srsName, FdoBoolean invertAxis = false);
...
private:
	...
	static FdoStringP GetDirectPositionCoordinates( FdoIDirectPosition* position, FdoBoolean invertAxis = false);

};

#endif//FDOOWSOGCGEOMETRYSERIALIZER_H
