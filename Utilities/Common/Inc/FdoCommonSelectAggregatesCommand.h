...
#ifndef FDOCOMMONSELECTAGGREGATESCOMMAND_H
#define FDOCOMMONSELECTAGGREGATESCOMMAND_H
...
class FdoCommonSelectAggregatesCommand :
...
protected:
    virtual ~FdoCommonSelectAggregatesCommand (void);

public:
    FdoCommonSelectAggregatesCommand (FdoIConnection *connection);

    //
    /// Prevent the use of the Assignment Operation by defining it and not implementing it.
    /// DO NOT IMPLEMENT
    FdoCommonSelectAggregatesCommand & operator= (const FdoCommonSelectAggregatesCommand &right);
...
#endif // FDOCOMMONSELECTAGGREGATESCOMMAND_H
