...

{
    ...
    // Executing the XYZ tests.
    printf("\n");
    printf("\n");
    printf(" >>> ... Testing X,Y and Z Functions \n");
    printf("\n");
    TestXYZFunction();
...

{
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Abs(ToInt32(i32_val)) as cmp_id)";
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Abs(ToInt32(i32_val)*-1) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReader32(data_reader, true, 9, exp_i32_val);
      printf(" >>> Test succeeded \n");
...

{
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Mod(dcl_val, ToInt32(i32_val)) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Mod(ToInt32(i32_val), dcl_val) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Mod(ToInt32(i32_val), ToInt32(i32_val)) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
...

{
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Power(ToInt32(i32_val), dcl_val) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
...

{
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Remainder(dcl_val, ToInt32(i32_val)) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReader(data_reader, true, 9, 12.84);
      printf(" >>> Test succeeded \n");
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Remainder(ToInt32(i32_val), dcl_val) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReader(data_reader, true, 9, 0.12);
      printf(" >>> Test succeeded \n");
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Remainder(ToInt32(i32_val), ToInt32(i32_val)) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReader32(data_reader, true, 9, 0);
      printf(" >>> Test succeeded \n");
...

{
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Ceil(ToInt32(i32_val)) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
...

{
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Floor(ToInt32(i32_val)) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
...

{
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Round(ToInt32(i32_val)) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReader32(data_reader, true, 9, 90);
      printf(" >>> Test succeeded \n");
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Round(ToInt32(i32_val), 1.223) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReader32(data_reader, true, 9, 90);
      printf(" >>> Test succeeded \n");
...

{
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Trunc(ToInt32(i32_val)) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReader32(data_reader, true, 9, 90);
      printf(" >>> Test succeeded \n");
    ...
    try {
      ...
      //ToInt32() to workaround OGR-ism
      func_call   = L"(Trunc(ToInt32(i32_val), 1.223) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReader32(data_reader, true, 9, 90);
      printf(" >>> Test succeeded \n");
...

{
    ...
    try {
      ...
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"999The Color is: 2118");
      printf(" >>> Test succeeded \n");
...

{
    ...
    try {
      ...
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"The Color is: 2118999");
      printf(" >>> Test succeeded \n");
...

{
    ...
    try {
      ...
      func_call   = L"(Rtrim(Lpad(str_val, 3, ' ')) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"  9");
      printf(" >>> Test succeeded \n");
...

{
    ...
    try {
      ...
      func_call   = L"(Trim(Lpad(str_val, 3, ' ')) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"9");
      printf(" >>> Test succeeded \n");
    ...
    try {
      ...
      func_call   = L"(Trim('BOTH', Lpad(str_val, 3, ' ')) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"9");
      printf(" >>> Test succeeded \n");
    ...
    try {
      ...
      func_call   = L"(Trim('LEADING', Lpad(str_val, 3, ' ')) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"9");
      printf(" >>> Test succeeded \n");
    ...
    try {
      ...
      func_call   = L"(Trim('TRAILING', Lpad(str_val, 3, ' ')) as cmp_id)";
      data_reader = ExecuteSelectCommand(L"exfct_c1", filter, true, func_call);
      CheckReaderString(data_reader, 9, L"  9");
      printf(" >>> Test succeeded \n");
...

{
    ...
    m_connection = UnitTestUtil::CreateOgrConnection(DATASTORE_EXTENSION, true);
...
void FdoExpressionFunctionTest::TestXYZFunction()
{
      ...
      TestXYZClass(XY_POINT_CLASS);
      TestXYZClass(XYZ_POINT_CLASS);

      //CloseConnection();
    
}
void FdoExpressionFunctionTest::TestXYZClass(
                   FdoString      *class_name
                   )
{
