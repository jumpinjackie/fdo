#ifndef FdoSmPhRdPostGisSCHEMAREADER_H
#define FdoSmPhRdPostGisSCHEMAREADER_H		1
/*
...
class FdoSmPhRdPostGisSchemaReader : public FdoSmPhRdSchemaReader
{
public:
	...
	~FdoSmPhRdPostGisSchemaReader(void);
...
typedef FdoPtr<FdoSmPhRdPostGisSchemaReader> FdoSmPhRdPostGisSchemaReaderP;
