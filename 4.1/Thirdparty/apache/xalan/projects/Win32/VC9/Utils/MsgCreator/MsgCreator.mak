...
!IF "$(CFG)" != "MsgCreator - Win32 Release" && "$(CFG)" != "MsgCreator - Win32 Debug" && "$(CFG)" != "MsgCreator - Win32 Release.symbols" && "$(CFG)" != "MsgCreator - Win64 Release" && "$(CFG)" != "MsgCreator - Win64 Debug"
...
CPP_PROJ=/nologo /MD /W4 /EHsc /O2 /I ".\\" /I $(XALANINCLUDE) /I $(XERCESCROOT)\src /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\MsgCreator.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MsgCreator.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib $(XERCESCROOT)\Build\Win32\VC9\Release\xerces-c_3.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\MsgCreator.pdb" /machine:I386 /out:"..\..\..\..\..\Build\Win32\VC9\$(RELEASE)\MsgCreator.exe" 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MDd /W4 /Gm /EHsc /ZI /Od /I ".\\" /I $(XALANINCLUDE) /I $(XERCESCROOT)\src /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fr"$(INTDIR)\\" /Fp"$(INTDIR)\MsgCreator.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /RTC1 /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MsgCreator.bsc" 
BSC32_SBRS= \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib $(XERCESCROOT)\Build\Win32\VC9\Debug\xerces-c_3D.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\MsgCreator.pdb" /debug /machine:I386 /out:"..\..\..\..\..\Build\Win32\VC9\Debug\MsgCreator.exe"
LINK32_OBJS= \
	"$(INTDIR)\ICUResHandler.obj" \
	"$(INTDIR)\InMemHandler.obj" \
	"$(INTDIR)\MsgCreator.obj" \
...
CPP_PROJ=/nologo /MDd /W4 /Gm /EHsc /ZI /Od /I ".\\" /I $(XALANINCLUDE) /I $(XERCESCROOT)\src /D "WIN32" /D "_WIN64" /D "_DEBUG" /D "_CRT_SECURE_NO_WARNINGS" /D "_CONSOLE" /D "_MBCS" /Fr"$(INTDIR)\\" /Fp"$(INTDIR)\MsgCreator.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /RTC1 /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MsgCreator.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\ICUResHandler.sbr" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib $(XERCESCROOT)\Build\Win64\VC9\Debug\xerces-c_3D.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\MsgCreator.pdb" /debug /machine:X64 /out:"..\..\..\..\..\Build\Win64\VC9\Debug\MsgCreator.exe" /pdbtype:sept /machine:X64
LINK32_OBJS= \
	"$(INTDIR)\ICUResHandler.obj" \
	"$(INTDIR)\InMemHandler.obj" \
	"$(INTDIR)\MsgCreator.obj" \
...
CPP_PROJ=/nologo /MD /W4 /EHsc /O2 /I ".\\" /I $(XALANINCLUDE) /I $(XERCESCROOT)\src /D "WIN32" /D "_WIN64" /D "_CRT_SECURE_NO_WARNINGS" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\MsgCreator.pch" /Fo"$(INTDIR)" /Fd"$(INTDIR)" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MsgCreator.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib $(XERCESCROOT)\Build\Win64\VC9\Release\xerces-c_3.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\MsgCreator.pdb" /machine:x64 /out:"..\..\..\..\..\Build\Win64\VC9\Release\MsgCreator.exe" /machine:X64
LINK32_OBJS= \
	"$(INTDIR)\ICUResHandler.obj" \
	"$(INTDIR)\InMemHandler.obj" \
	"$(INTDIR)\MsgCreator.obj" \
...
!IF  "$(CFG)" == "MsgCreator - Win32 $(RELEASE)" || "$(CFG)" == "MsgCreator - Win64 Release"
...
!ELSEIF  "$(CFG)" == "MsgCreator - Win32 Debug" || "$(CFG)" == "MsgCreator - Win64 Debug"
